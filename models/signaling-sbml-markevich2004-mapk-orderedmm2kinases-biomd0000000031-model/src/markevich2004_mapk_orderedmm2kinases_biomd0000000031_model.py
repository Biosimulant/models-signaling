...
"""Auto-generated SBML BioModule wrapper for Markevich2004_MAPK_orderedMM2kinases.

Source: biomodels_ebi:BIOMD0000000031
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000031
"""
...
class SbmlMarkevich2004MapkOrderedmm2kinases(biosim.BioModule):
    """BioModule wrapper for SBML model: Markevich2004_MAPK_orderedMM2kinases."""

    def __init__(self, model_path: str = "data/BIOMD0000000031.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Markevich2004MapkOrderedmm2kinasesBiomd0000000031Model = SbmlMarkevich2004MapkOrderedmm2kinases

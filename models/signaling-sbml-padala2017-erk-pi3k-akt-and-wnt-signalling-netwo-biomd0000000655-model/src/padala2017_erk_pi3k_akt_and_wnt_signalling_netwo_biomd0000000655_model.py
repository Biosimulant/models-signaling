...
"""Auto-generated SBML BioModule wrapper for Padala2017- ERK, PI3K/Akt and Wnt signalling network (PTEN mutation).

Source: biomodels_ebi:BIOMD0000000655
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000655
"""
...
class SbmlPadala2017ErkPi3kAktAndWntSignallingNetworkPten(biosim.BioModule):
    """BioModule wrapper for SBML model: Padala2017- ERK, PI3K/Akt and Wnt signalling network (PTEN mutation)."""

    def __init__(self, model_path: str = "data/BIOMD0000000655.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Padala2017ErkPi3kAktAndWntSignallingNetwoBiomd0000000655Model = SbmlPadala2017ErkPi3kAktAndWntSignallingNetworkPten

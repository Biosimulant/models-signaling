...
"""Auto-generated SBML BioModule wrapper for Phosphatase activities on PI(3,4,5)P3 and PI(3,4)P2.

Source: biomodels_ebi:MODEL1704190000
Original: https://www.ebi.ac.uk/biomodels/MODEL1704190000
"""
...
class SbmlPhosphataseActivitiesOnPi345P3AndPi34P2(biosim.BioModule):
    """BioModule wrapper for SBML model: Phosphatase activities on PI(3,4,5)P3 and PI(3,4)P2."""

    def __init__(self, model_path: str = "data/MODEL1704190000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
PhosphataseActivitiesOnPi345P3AndPi34Model1704190000Model = SbmlPhosphataseActivitiesOnPi345P3AndPi34P2

...
"""Auto-generated SBML BioModule wrapper for Bidkhori2012 - EGFR signalling in NSCLC.

Source: biomodels_ebi:BIOMD0000000453
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000453
"""
...
class SbmlBidkhori2012EgfrSignallingInNsclc(biosim.BioModule):
    """BioModule wrapper for SBML model: Bidkhori2012 - EGFR signalling in NSCLC."""

    def __init__(self, model_path: str = "data/BIOMD0000000453.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Bidkhori2012EgfrSignallingInNsclcBiomd0000000453Model = SbmlBidkhori2012EgfrSignallingInNsclc

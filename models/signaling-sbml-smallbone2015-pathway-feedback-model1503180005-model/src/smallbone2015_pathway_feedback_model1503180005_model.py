...
"""Auto-generated SBML BioModule wrapper for Smallbone2015 - pathway feedback.

Source: biomodels_ebi:MODEL1503180005
Original: https://www.ebi.ac.uk/biomodels/MODEL1503180005
"""
...
class SbmlSmallbone2015PathwayFeedback(biosim.BioModule):
    """BioModule wrapper for SBML model: Smallbone2015 - pathway feedback."""

    def __init__(self, model_path: str = "data/MODEL1503180005.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Smallbone2015PathwayFeedbackModel1503180005Model = SbmlSmallbone2015PathwayFeedback

...
"""Auto-generated SBML BioModule wrapper for Chan2004_TCell_receptor_activation.

Source: biomodels_ebi:BIOMD0000000120
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000120
"""
...
class SbmlChan2004TcellReceptorActivation(biosim.BioModule):
    """BioModule wrapper for SBML model: Chan2004_TCell_receptor_activation."""

    def __init__(self, model_path: str = "data/BIOMD0000000120.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Chan2004TcellReceptorActivationBiomd0000000120Model = SbmlChan2004TcellReceptorActivation

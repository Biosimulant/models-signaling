...
"""Auto-generated SBML BioModule wrapper for Schwarz2018-Cdk Activity Threshold Determines Passage through the Restriction Point.

Source: biomodels_ebi:BIOMD0000000918
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000918
"""
...
class SbmlSchwarz2018CdkActivityThresholdDeterminesPassage(biosim.BioModule):
    """BioModule wrapper for SBML model: Schwarz2018-Cdk Activity Threshold Determines Passage through the Restriction Point."""

    def __init__(self, model_path: str = "data/BIOMD0000000918.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Schwarz2018CdkActivityThresholdDeterminesPaBiomd0000000918Model = SbmlSchwarz2018CdkActivityThresholdDeterminesPassage

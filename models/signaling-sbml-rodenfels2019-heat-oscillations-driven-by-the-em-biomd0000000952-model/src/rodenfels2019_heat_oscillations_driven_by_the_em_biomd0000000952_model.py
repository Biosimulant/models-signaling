...
"""Auto-generated SBML BioModule wrapper for Rodenfels2019 - Heat Oscillations Driven by the Embryonic Cell Cycle Reveal the Energetic Costs of Signaling.

Source: biomodels_ebi:BIOMD0000000952
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000952
"""
...
class SbmlRodenfels2019HeatOscillationsDrivenByTheEmbryonic(biosim.BioModule):
    """BioModule wrapper for SBML model: Rodenfels2019 - Heat Oscillations Driven by the Embryonic Cell Cycle Reveal the Energetic Costs of Signaling."""

    def __init__(self, model_path: str = "data/BIOMD0000000952.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Rodenfels2019HeatOscillationsDrivenByTheEmBiomd0000000952Model = SbmlRodenfels2019HeatOscillationsDrivenByTheEmbryonic

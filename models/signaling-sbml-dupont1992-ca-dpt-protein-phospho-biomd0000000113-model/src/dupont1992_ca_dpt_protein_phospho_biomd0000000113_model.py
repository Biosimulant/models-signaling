...
"""Auto-generated SBML BioModule wrapper for Dupont1992_Ca_dpt_protein_phospho.

Source: biomodels_ebi:BIOMD0000000113
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000113
"""
...
class SbmlDupont1992CaDptProteinPhospho(biosim.BioModule):
    """BioModule wrapper for SBML model: Dupont1992_Ca_dpt_protein_phospho."""

    def __init__(self, model_path: str = "data/BIOMD0000000113.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Dupont1992CaDptProteinPhosphoBiomd0000000113Model = SbmlDupont1992CaDptProteinPhospho

...
"""Auto-generated SBML BioModule wrapper for Padala2017- ERK, PI3K/Akt and Wnt signalling network (PI3K mutated).

Source: biomodels_ebi:BIOMD0000000652
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000652
"""
...
class SbmlPadala2017ErkPi3kAktAndWntSignallingNetworkPi3k(biosim.BioModule):
    """BioModule wrapper for SBML model: Padala2017- ERK, PI3K/Akt and Wnt signalling network (PI3K mutated)."""

    def __init__(self, model_path: str = "data/BIOMD0000000652.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Padala2017ErkPi3kAktAndWntSignallingNetwoBiomd0000000652Model = SbmlPadala2017ErkPi3kAktAndWntSignallingNetworkPi3k

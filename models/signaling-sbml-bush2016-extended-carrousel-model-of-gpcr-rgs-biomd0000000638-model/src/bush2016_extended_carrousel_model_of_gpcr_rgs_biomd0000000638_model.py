...
"""Auto-generated SBML BioModule wrapper for Bush2016 - Extended Carrousel model of GPCR-RGS.

Source: biomodels_ebi:BIOMD0000000638
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000638
"""
...
class SbmlBush2016ExtendedCarrouselModelOfGpcrRgs(biosim.BioModule):
    """BioModule wrapper for SBML model: Bush2016 - Extended Carrousel model of GPCR-RGS."""

    def __init__(self, model_path: str = "data/BIOMD0000000638.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Bush2016ExtendedCarrouselModelOfGpcrRgsBiomd0000000638Model = SbmlBush2016ExtendedCarrouselModelOfGpcrRgs

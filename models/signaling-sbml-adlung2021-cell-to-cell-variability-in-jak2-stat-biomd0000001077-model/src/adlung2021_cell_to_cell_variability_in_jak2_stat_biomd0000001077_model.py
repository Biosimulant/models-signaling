...
"""Auto-generated SBML BioModule wrapper for Adlung2021 - Cell-to-cell variability in JAK2/STAT5 pathway.

Source: biomodels_ebi:BIOMD0000001077
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000001077
"""
...
class SbmlAdlung2021CellToCellVariabilityInJak2Stat5Pathway(biosim.BioModule):
    """BioModule wrapper for SBML model: Adlung2021 - Cell-to-cell variability in JAK2/STAT5 pathway."""

    def __init__(self, model_path: str = "data/BIOMD0000001077.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Adlung2021CellToCellVariabilityInJak2StatBiomd0000001077Model = SbmlAdlung2021CellToCellVariabilityInJak2Stat5Pathway

...
"""Auto-generated SBML BioModule wrapper for Strasen2018 - TGFb SMAD Signalling Class 1.

Source: biomodels_ebi:BIOMD0000000998
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000998
"""
...
class SbmlStrasen2018TgfbSmadSignallingClass1(biosim.BioModule):
    """BioModule wrapper for SBML model: Strasen2018 - TGFb SMAD Signalling Class 1."""

    def __init__(self, model_path: str = "data/BIOMD0000000998.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Strasen2018TgfbSmadSignallingClass1Biomd0000000998Model = SbmlStrasen2018TgfbSmadSignallingClass1

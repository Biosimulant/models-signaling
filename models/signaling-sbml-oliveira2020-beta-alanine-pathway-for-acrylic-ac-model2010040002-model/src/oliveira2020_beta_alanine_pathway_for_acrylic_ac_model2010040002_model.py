...
"""Auto-generated SBML BioModule wrapper for Oliveira2020 - Beta-Alanine pathway for Acrylic Acid production from glycerol.

Source: biomodels_ebi:MODEL2010040002
Original: https://www.ebi.ac.uk/biomodels/MODEL2010040002
"""
...
class SbmlOliveira2020BetaAlaninePathwayForAcrylicAcid2(biosim.BioModule):
    """BioModule wrapper for SBML model: Oliveira2020 - Beta-Alanine pathway for Acrylic Acid production from glycerol."""

    def __init__(self, model_path: str = "data/MODEL2010040002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Oliveira2020BetaAlaninePathwayForAcrylicAcModel2010040002Model = SbmlOliveira2020BetaAlaninePathwayForAcrylicAcid2

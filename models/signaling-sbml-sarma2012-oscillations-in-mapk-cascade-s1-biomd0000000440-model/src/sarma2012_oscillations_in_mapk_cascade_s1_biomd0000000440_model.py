...
"""Auto-generated SBML BioModule wrapper for Sarma2012 - Oscillations in MAPK cascade (S1).

Source: biomodels_ebi:BIOMD0000000440
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000440
"""
...
class SbmlSarma2012OscillationsInMapkCascadeS1(biosim.BioModule):
    """BioModule wrapper for SBML model: Sarma2012 - Oscillations in MAPK cascade (S1)."""

    def __init__(self, model_path: str = "data/BIOMD0000000440.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Sarma2012OscillationsInMapkCascadeS1Biomd0000000440Model = SbmlSarma2012OscillationsInMapkCascadeS1

...
"""Auto-generated SBML BioModule wrapper for Grigolon2018-Responses to auxin signals.

Source: biomodels_ebi:BIOMD0000000927
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000927
"""
...
class SbmlGrigolon2018ResponsesToAuxinSignals2(biosim.BioModule):
    """BioModule wrapper for SBML model: Grigolon2018-Responses to auxin signals."""

    def __init__(self, model_path: str = "data/BIOMD0000000927.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Grigolon2018ResponsesToAuxinSignalsBiomd0000000927Model = SbmlGrigolon2018ResponsesToAuxinSignals2

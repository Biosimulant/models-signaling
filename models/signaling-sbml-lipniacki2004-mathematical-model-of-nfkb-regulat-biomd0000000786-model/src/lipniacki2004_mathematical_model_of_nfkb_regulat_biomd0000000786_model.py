...
"""Auto-generated SBML BioModule wrapper for Lipniacki2004 - Mathematical model of NFKB regulatory module.

Source: biomodels_ebi:BIOMD0000000786
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000786
"""
...
class SbmlLipniacki2004MathematicalModelOfNfkbRegulatoryModule(biosim.BioModule):
    """BioModule wrapper for SBML model: Lipniacki2004 - Mathematical model of NFKB regulatory module."""

    def __init__(self, model_path: str = "data/BIOMD0000000786.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Lipniacki2004MathematicalModelOfNfkbRegulatBiomd0000000786Model = SbmlLipniacki2004MathematicalModelOfNfkbRegulatoryModule

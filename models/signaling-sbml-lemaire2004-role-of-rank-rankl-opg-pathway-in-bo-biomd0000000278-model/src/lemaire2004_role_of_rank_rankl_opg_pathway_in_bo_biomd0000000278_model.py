...
"""Auto-generated SBML BioModule wrapper for Lemaire2004 - Role of RANK/RANKL/OPG pathway in bone remodelling process.

Source: biomodels_ebi:BIOMD0000000278
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000278
"""
...
class SbmlLemaire2004RoleOfRankRanklOpgPathwayInBone(biosim.BioModule):
    """BioModule wrapper for SBML model: Lemaire2004 - Role of RANK/RANKL/OPG pathway in bone remodelling process."""

    def __init__(self, model_path: str = "data/BIOMD0000000278.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Lemaire2004RoleOfRankRanklOpgPathwayInBoBiomd0000000278Model = SbmlLemaire2004RoleOfRankRanklOpgPathwayInBone

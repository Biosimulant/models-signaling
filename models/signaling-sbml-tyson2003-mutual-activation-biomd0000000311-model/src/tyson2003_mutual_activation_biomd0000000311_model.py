...
"""Auto-generated SBML BioModule wrapper for Tyson2003_Mutual_Activation.

Source: biomodels_ebi:BIOMD0000000311
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000311
"""
...
class SbmlTyson2003MutualActivation(biosim.BioModule):
    """BioModule wrapper for SBML model: Tyson2003_Mutual_Activation."""

    def __init__(self, model_path: str = "data/BIOMD0000000311.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Tyson2003MutualActivationBiomd0000000311Model = SbmlTyson2003MutualActivation

...
"""Auto-generated SBML BioModule wrapper for Wang2009 - PI3K Ras Crosstalk.

Source: biomodels_ebi:BIOMD0000000288
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000288
"""
...
class SbmlWang2009Pi3kRasCrosstalk(biosim.BioModule):
    """BioModule wrapper for SBML model: Wang2009 - PI3K Ras Crosstalk."""

    def __init__(self, model_path: str = "data/BIOMD0000000288.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Wang2009Pi3kRasCrosstalkBiomd0000000288Model = SbmlWang2009Pi3kRasCrosstalk

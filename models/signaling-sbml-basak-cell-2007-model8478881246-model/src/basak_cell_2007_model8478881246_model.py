...
"""Auto-generated SBML BioModule wrapper for Basak_Cell_2007.

Source: biomodels_ebi:MODEL8478881246
Original: https://www.ebi.ac.uk/biomodels/MODEL8478881246
"""
...
class SbmlBasakCell2007(biosim.BioModule):
    """BioModule wrapper for SBML model: Basak_Cell_2007."""

    def __init__(self, model_path: str = "data/MODEL8478881246.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
BasakCell2007Model8478881246Model = SbmlBasakCell2007

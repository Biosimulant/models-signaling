...
"""Tellurium-backed SBML wrapper for HeberleRazquinNavas2019 - The PI3K and MAPK/p38 pathways control stress granuleassembly in a hierarchical manner model 2."""
...
class Heberlerazquinnavas2019ThePi3kAndMapkP38PaModel2001030002Model(TelluriumSBMLBioModule):
    """Faithful Tellurium execution of the bundled SBML source model."""

    _SBML_ID = 'MODEL2001030002'
    _TITLE = 'HeberleRazquinNavas2019 - The PI3K and MAPK/p38 pathways control stress granuleassembly in a hierarchical manner model 2'
    ...
    def __init__(self, model_path: str = 'data/MODEL2001030002.xml', integration_step: float = 0.01) -> None:
        super().__init__(model_path=model_path, integration_step=integration_step)


Heberlerazquinnavas2019ThePi3kAndMapkP38PaModel2001030002Model = Heberlerazquinnavas2019ThePi3kAndMapkP38PaModel2001030002Model

...
"""Auto-generated SBML BioModule wrapper for Abell2011_CalciumSignaling_WithAdaptation.

Source: biomodels_ebi:BIOMD0000000355
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000355
"""
...
class SbmlAbell2011CalciumsignalingWithadaptation(biosim.BioModule):
    """BioModule wrapper for SBML model: Abell2011_CalciumSignaling_WithAdaptation."""

    def __init__(self, model_path: str = "data/BIOMD0000000355.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Abell2011CalciumsignalingWithadaptationBiomd0000000355Model = SbmlAbell2011CalciumsignalingWithadaptation

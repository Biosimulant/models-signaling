...
"""Auto-generated SBML BioModule wrapper for Bhalla2004_PKA_2003.

Source: biomodels_ebi:MODEL9079740062
Original: https://www.ebi.ac.uk/biomodels/MODEL9079740062
"""
...
class SbmlBhalla2004Pka2003(biosim.BioModule):
    """BioModule wrapper for SBML model: Bhalla2004_PKA_2003."""

    def __init__(self, model_path: str = "data/MODEL9079740062.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Bhalla2004Pka2003Model9079740062Model = SbmlBhalla2004Pka2003

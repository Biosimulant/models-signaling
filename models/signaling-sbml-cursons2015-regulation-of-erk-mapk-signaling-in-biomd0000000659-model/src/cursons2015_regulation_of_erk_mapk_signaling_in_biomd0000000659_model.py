...
"""Auto-generated SBML BioModule wrapper for Cursons2015 - Regulation of ERK-MAPK signaling in human epidermis.

Source: biomodels_ebi:BIOMD0000000659
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000659
"""
...
class SbmlCursons2015RegulationOfErkMapkSignalingInHuman(biosim.BioModule):
    """BioModule wrapper for SBML model: Cursons2015 - Regulation of ERK-MAPK signaling in human epidermis."""

    def __init__(self, model_path: str = "data/BIOMD0000000659.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Cursons2015RegulationOfErkMapkSignalingInBiomd0000000659Model = SbmlCursons2015RegulationOfErkMapkSignalingInHuman

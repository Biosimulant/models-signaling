...
"""Auto-generated SBML BioModule wrapper for EDN signalling models.

Source: biomodels_ebi:MODEL1904170001
Original: https://www.ebi.ac.uk/biomodels/MODEL1904170001
"""
...
class SbmlEdnSignallingModels(biosim.BioModule):
    """BioModule wrapper for SBML model: EDN signalling models."""

    def __init__(self, model_path: str = "data/MODEL1904170001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
EdnSignallingModelsModel1904170001Model = SbmlEdnSignallingModels

...
"""Auto-generated SBML BioModule wrapper for McClean2007_CrossTalk.

Source: biomodels_ebi:BIOMD0000000116
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000116
"""
...
class SbmlMcclean2007Crosstalk(biosim.BioModule):
    """BioModule wrapper for SBML model: McClean2007_CrossTalk."""

    def __init__(self, model_path: str = "data/BIOMD0000000116.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Mcclean2007CrosstalkBiomd0000000116Model = SbmlMcclean2007Crosstalk

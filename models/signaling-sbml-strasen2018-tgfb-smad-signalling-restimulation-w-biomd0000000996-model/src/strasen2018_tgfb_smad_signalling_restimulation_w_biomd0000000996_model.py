...
"""Auto-generated SBML BioModule wrapper for Strasen2018 - TGFb SMAD Signalling - Restimulation with 100pM TGFb at 6hr.

Source: biomodels_ebi:BIOMD0000000996
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000996
"""
...
class SbmlStrasen2018TgfbSmadSignallingRestimulationWith100pm(biosim.BioModule):
    """BioModule wrapper for SBML model: Strasen2018 - TGFb SMAD Signalling - Restimulation with 100pM TGFb at 6hr."""

    def __init__(self, model_path: str = "data/BIOMD0000000996.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Strasen2018TgfbSmadSignallingRestimulationWBiomd0000000996Model = SbmlStrasen2018TgfbSmadSignallingRestimulationWith100pm

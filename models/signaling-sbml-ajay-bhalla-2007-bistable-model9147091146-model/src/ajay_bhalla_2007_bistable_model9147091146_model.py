...
"""Auto-generated SBML BioModule wrapper for Ajay_Bhalla_2007_Bistable.

Source: biomodels_ebi:MODEL9147091146
Original: https://www.ebi.ac.uk/biomodels/MODEL9147091146
"""
...
class SbmlAjayBhalla2007Bistable(biosim.BioModule):
    """BioModule wrapper for SBML model: Ajay_Bhalla_2007_Bistable."""

    def __init__(self, model_path: str = "data/MODEL9147091146.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
AjayBhalla2007BistableModel9147091146Model = SbmlAjayBhalla2007Bistable

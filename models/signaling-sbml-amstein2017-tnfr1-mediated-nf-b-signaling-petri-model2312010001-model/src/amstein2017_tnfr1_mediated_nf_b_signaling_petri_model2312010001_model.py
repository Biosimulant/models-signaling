...
"""Auto-generated SBML BioModule wrapper for Amstein2017 - TNFR1-mediated Nf-κB signaling, Petri Net.

Source: biomodels_ebi:MODEL2312010001
Original: https://www.ebi.ac.uk/biomodels/MODEL2312010001
"""
...
class SbmlAmstein2017Tnfr1MediatedNfBSignalingPetriNet(biosim.BioModule):
    """BioModule wrapper for SBML model: Amstein2017 - TNFR1-mediated Nf-κB signaling, Petri Net."""

    def __init__(self, model_path: str = "data/MODEL2312010001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Amstein2017Tnfr1MediatedNfBSignalingPetriModel2312010001Model = SbmlAmstein2017Tnfr1MediatedNfBSignalingPetriNet

...
"""Auto-generated SBML BioModule wrapper for Kholodenko1999 - EGFR signaling.

Source: biomodels_ebi:BIOMD0000000048
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000048
"""
...
class SbmlKholodenko1999EgfrSignaling(biosim.BioModule):
    """BioModule wrapper for SBML model: Kholodenko1999 - EGFR signaling."""

    def __init__(self, model_path: str = "data/BIOMD0000000048.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Kholodenko1999EgfrSignalingBiomd0000000048Model = SbmlKholodenko1999EgfrSignaling

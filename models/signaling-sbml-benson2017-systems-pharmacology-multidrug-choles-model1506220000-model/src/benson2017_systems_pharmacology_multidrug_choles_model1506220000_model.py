...
"""Auto-generated SBML BioModule wrapper for Benson2017 - Systems Pharmacology Multidrug (cholesterol biosynthesis pathway).

Source: biomodels_ebi:MODEL1506220000
Original: https://www.ebi.ac.uk/biomodels/MODEL1506220000
"""
...
class SbmlBenson2017SystemsPharmacologyMultidrugCholesterol(biosim.BioModule):
    """BioModule wrapper for SBML model: Benson2017 - Systems Pharmacology Multidrug (cholesterol biosynthesis pathway)."""

    def __init__(self, model_path: str = "data/MODEL1506220000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Benson2017SystemsPharmacologyMultidrugCholesModel1506220000Model = SbmlBenson2017SystemsPharmacologyMultidrugCholesterol

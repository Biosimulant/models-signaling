...
"""Auto-generated SBML BioModule wrapper for Smith2010 - Response of FOXO Transcription Factors to Post-Translational Modifications Made by Ageing-Related Signalling Pathways.

Source: biomodels_ebi:BIOMD0000000705
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000705
"""
...
class SbmlSmith2010ResponseOfFoxoTranscriptionFactorsToPost(biosim.BioModule):
    """BioModule wrapper for SBML model: Smith2010 - Response of FOXO Transcription Factors to Post-Translational Modifications Made by Ageing-Related Signalling Pathways."""

    def __init__(self, model_path: str = "data/BIOMD0000000705.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Smith2010ResponseOfFoxoTranscriptionFactorsBiomd0000000705Model = SbmlSmith2010ResponseOfFoxoTranscriptionFactorsToPost

...
"""Auto-generated SBML BioModule wrapper for Middleton2012_GibberellinSignalling.

Source: biomodels_ebi:BIOMD0000000422
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000422
"""
...
class SbmlMiddleton2012Gibberellinsignalling(biosim.BioModule):
    """BioModule wrapper for SBML model: Middleton2012_GibberellinSignalling."""

    def __init__(self, model_path: str = "data/BIOMD0000000422.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Middleton2012GibberellinsignallingBiomd0000000422Model = SbmlMiddleton2012Gibberellinsignalling

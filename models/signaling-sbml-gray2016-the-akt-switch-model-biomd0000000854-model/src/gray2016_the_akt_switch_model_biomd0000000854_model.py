...
"""Auto-generated SBML BioModule wrapper for Gray2016 - The Akt switch model.

Source: biomodels_ebi:BIOMD0000000854
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000854
"""
...
class SbmlGray2016TheAktSwitchModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Gray2016 - The Akt switch model."""

    def __init__(self, model_path: str = "data/BIOMD0000000854.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Gray2016TheAktSwitchModelBiomd0000000854Model = SbmlGray2016TheAktSwitchModel

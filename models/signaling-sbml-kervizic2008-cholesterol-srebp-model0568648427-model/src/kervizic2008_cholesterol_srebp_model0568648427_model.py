...
"""Auto-generated SBML BioModule wrapper for Kervizic2008_Cholesterol_SREBP.

Source: biomodels_ebi:MODEL0568648427
Original: https://www.ebi.ac.uk/biomodels/MODEL0568648427
"""
...
class SbmlKervizic2008CholesterolSrebp(biosim.BioModule):
    """BioModule wrapper for SBML model: Kervizic2008_Cholesterol_SREBP."""

    def __init__(self, model_path: str = "data/MODEL0568648427.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Kervizic2008CholesterolSrebpModel0568648427Model = SbmlKervizic2008CholesterolSrebp

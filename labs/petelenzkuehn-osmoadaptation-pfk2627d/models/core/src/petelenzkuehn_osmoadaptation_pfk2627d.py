...
"""Tellurium-backed SBML wrapper for PetelenzKuehn_osmoadaptation_pfk2627D."""
...
class PetelenzkuehnOsmoadaptationPfk2627dModel(TelluriumSBMLBioModule):
    """Faithful Tellurium execution of the bundled SBML source model."""

    _SBML_ID = 'BIOMD0000000604'
    _TITLE = 'PetelenzKuehn_osmoadaptation_pfk2627D'
    ...
    def __init__(self, model_path: str = 'data/BIOMD0000000604.xml', integration_step: float = 0.01) -> None:
        super().__init__(model_path=model_path, integration_step=integration_step)


PetelenzkuehnOsmoadaptationPfk2627dBiomd0000000604Model = PetelenzkuehnOsmoadaptationPfk2627dModel

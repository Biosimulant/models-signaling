...
"""Auto-generated SBML BioModule wrapper for Sharp2013 - Lipopolysaccharide induced NFkB activation.

Source: biomodels_ebi:BIOMD0000000489
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000489
"""
...
class SbmlSharp2013LipopolysaccharideInducedNfkbActivation(biosim.BioModule):
    """BioModule wrapper for SBML model: Sharp2013 - Lipopolysaccharide induced NFkB activation."""

    def __init__(self, model_path: str = "data/BIOMD0000000489.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Sharp2013LipopolysaccharideInducedNfkbActivaBiomd0000000489Model = SbmlSharp2013LipopolysaccharideInducedNfkbActivation

...
"""Auto-generated SBML BioModule wrapper for Platelet PAR1 with SOCE.

Source: biomodels_ebi:MODEL1807190001
Original: https://www.ebi.ac.uk/biomodels/MODEL1807190001
"""
...
class SbmlPlateletPar1WithSoce(biosim.BioModule):
    """BioModule wrapper for SBML model: Platelet PAR1 with SOCE."""

    def __init__(self, model_path: str = "data/MODEL1807190001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
PlateletPar1WithSoceModel1807190001Model = SbmlPlateletPar1WithSoce

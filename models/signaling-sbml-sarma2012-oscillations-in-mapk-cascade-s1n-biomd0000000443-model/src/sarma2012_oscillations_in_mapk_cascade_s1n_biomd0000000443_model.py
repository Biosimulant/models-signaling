...
"""Auto-generated SBML BioModule wrapper for Sarma2012 - Oscillations in MAPK cascade (S1n).

Source: biomodels_ebi:BIOMD0000000443
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000443
"""
...
class SbmlSarma2012OscillationsInMapkCascadeS1n(biosim.BioModule):
    """BioModule wrapper for SBML model: Sarma2012 - Oscillations in MAPK cascade (S1n)."""

    def __init__(self, model_path: str = "data/BIOMD0000000443.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Sarma2012OscillationsInMapkCascadeS1nBiomd0000000443Model = SbmlSarma2012OscillationsInMapkCascadeS1n

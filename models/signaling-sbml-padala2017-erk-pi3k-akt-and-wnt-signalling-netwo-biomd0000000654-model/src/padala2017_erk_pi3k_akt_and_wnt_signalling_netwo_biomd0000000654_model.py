...
"""Auto-generated SBML BioModule wrapper for Padala2017- ERK, PI3K/Akt and Wnt signalling network (Ras mutated).

Source: biomodels_ebi:BIOMD0000000654
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000654
"""
...
class SbmlPadala2017ErkPi3kAktAndWntSignallingNetworkRas(biosim.BioModule):
    """BioModule wrapper for SBML model: Padala2017- ERK, PI3K/Akt and Wnt signalling network (Ras mutated)."""

    def __init__(self, model_path: str = "data/BIOMD0000000654.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Padala2017ErkPi3kAktAndWntSignallingNetwoBiomd0000000654Model = SbmlPadala2017ErkPi3kAktAndWntSignallingNetworkRas

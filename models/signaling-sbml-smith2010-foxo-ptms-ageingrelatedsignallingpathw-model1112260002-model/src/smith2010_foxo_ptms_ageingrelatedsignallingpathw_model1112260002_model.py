...
"""Auto-generated SBML BioModule wrapper for Smith2010_Foxo_PTMs_AgeingRelatedSignallingPathway_C.

Source: biomodels_ebi:MODEL1112260002
Original: https://www.ebi.ac.uk/biomodels/MODEL1112260002
"""
...
class SbmlSmith2010FoxoPtmsAgeingrelatedsignallingpathwayC(biosim.BioModule):
    """BioModule wrapper for SBML model: Smith2010_Foxo_PTMs_AgeingRelatedSignallingPathway_C."""

    def __init__(self, model_path: str = "data/MODEL1112260002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Smith2010FoxoPtmsAgeingrelatedsignallingpathwModel1112260002Model = SbmlSmith2010FoxoPtmsAgeingrelatedsignallingpathwayC

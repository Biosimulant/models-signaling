...
**Source**: [biomodels_ebi](https://www.ebi.ac.uk/biomodels/BIOMD0000000786)
**Standard**: sbml
...
models:
  - path: ../../models/signaling-sbml-lipniacki2004-mathematical-model-of-nfkb-regulat-biomd0000000786-model
    alias: model
```

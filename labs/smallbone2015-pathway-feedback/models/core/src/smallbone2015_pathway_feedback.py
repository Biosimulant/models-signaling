...
"""Tellurium-backed SBML wrapper for Smallbone2015 - pathway feedback."""
...
class Smallbone2015PathwayFeedbackModel(TelluriumSBMLBioModule):
    """Faithful Tellurium execution of the bundled SBML source model."""

    _SBML_ID = 'MODEL1503180005'
    _TITLE = 'Smallbone2015 - pathway feedback'
    ...
    def __init__(self, model_path: str = 'data/MODEL1503180005.xml', integration_step: float = 0.01) -> None:
        super().__init__(model_path=model_path, integration_step=integration_step)


Smallbone2015PathwayFeedbackModel1503180005Model = Smallbone2015PathwayFeedbackModel

...
"""Auto-generated SBML BioModule wrapper for Sobotta2017 - IL-6-induced JAK1-STAT3-signaling.

Source: biomodels_ebi:MODEL2307050001
Original: https://www.ebi.ac.uk/biomodels/MODEL2307050001
"""
...
class SbmlSobotta2017Il6InducedJak1Stat3Signaling(biosim.BioModule):
    """BioModule wrapper for SBML model: Sobotta2017 - IL-6-induced JAK1-STAT3-signaling."""

    def __init__(self, model_path: str = "data/MODEL2307050001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Sobotta2017Il6InducedJak1Stat3SignalingModel2307050001Model = SbmlSobotta2017Il6InducedJak1Stat3Signaling

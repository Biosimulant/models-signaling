...
"""Auto-generated SBML BioModule wrapper for Lee2008 - ERK and PI3K signal integration by Myc.

Source: biomodels_ebi:BIOMD0000000818
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000818
"""
...
class SbmlLee2008ErkAndPi3kSignalIntegrationByMyc(biosim.BioModule):
    """BioModule wrapper for SBML model: Lee2008 - ERK and PI3K signal integration by Myc."""

    def __init__(self, model_path: str = "data/BIOMD0000000818.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Lee2008ErkAndPi3kSignalIntegrationByMycBiomd0000000818Model = SbmlLee2008ErkAndPi3kSignalIntegrationByMyc

...
"""Tellurium-backed SBML wrapper for Padala2017- ERK, PI3K/Akt and Wnt signalling network (EGFR overexpression)."""
...
class Padala2017ErkPi3kAktAndWntSignallingNetwoBiomd0000000656Model(TelluriumSBMLBioModule):
    """Faithful Tellurium execution of the bundled SBML source model."""

    _SBML_ID = 'BIOMD0000000656'
    _TITLE = 'Padala2017- ERK, PI3K/Akt and Wnt signalling network (EGFR overexpression)'
    ...
    def __init__(self, model_path: str = 'data/BIOMD0000000656.xml', integration_step: float = 0.01) -> None:
        super().__init__(model_path=model_path, integration_step=integration_step)


Padala2017ErkPi3kAktAndWntSignallingNetwoBiomd0000000656Model = Padala2017ErkPi3kAktAndWntSignallingNetwoBiomd0000000656Model

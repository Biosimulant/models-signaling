...
"""Auto-generated tests for Schaber2006PheromoneStarvationCrosstalkBiomd0000000237Model.
...
from src.schaber2006_pheromone_starvation_crosstalk_biomd0000000237_model import Schaber2006PheromoneStarvationCrosstalkBiomd0000000237Model  # noqa: E402
from biosim.signals import BioSignal  # noqa: E402


def test_instantiation() -> None:
    module = Schaber2006PheromoneStarvationCrosstalkBiomd0000000237Model()
...
def test_advance_produces_outputs() -> None:
    module = Schaber2006PheromoneStarvationCrosstalkBiomd0000000237Model(min_dt=0.1)

...
"""Auto-generated SBML BioModule wrapper for Huang2014 - Systematic modeling for the insulin signaling network mediated by IRS1 and IRS2.

Source: biomodels_ebi:MODEL1912090001
Original: https://www.ebi.ac.uk/biomodels/MODEL1912090001
"""
...
class SbmlHuang2014SystematicModelingForTheInsulinSignaling(biosim.BioModule):
    """BioModule wrapper for SBML model: Huang2014 - Systematic modeling for the insulin signaling network mediated by IRS1 and IRS2."""

    def __init__(self, model_path: str = "data/MODEL1912090001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Huang2014SystematicModelingForTheInsulinSiModel1912090001Model = SbmlHuang2014SystematicModelingForTheInsulinSignaling

...
"""Auto-generated SBML BioModule wrapper for Ray2013 - Meiotic initiation in S. cerevisiae.

Source: biomodels_ebi:BIOMD0000000626
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000626
"""
...
class SbmlRay2013MeioticInitiationInSCerevisiae(biosim.BioModule):
    """BioModule wrapper for SBML model: Ray2013 - Meiotic initiation in S. cerevisiae."""

    def __init__(self, model_path: str = "data/BIOMD0000000626.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Ray2013MeioticInitiationInSCerevisiaeBiomd0000000626Model = SbmlRay2013MeioticInitiationInSCerevisiae

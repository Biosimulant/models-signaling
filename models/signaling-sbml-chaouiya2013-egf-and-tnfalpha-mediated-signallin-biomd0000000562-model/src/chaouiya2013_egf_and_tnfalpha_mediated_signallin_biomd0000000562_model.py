...
"""Auto-generated SBML BioModule wrapper for Chaouiya2013 - EGF and TNFalpha mediated signalling pathway.

Source: biomodels_ebi:BIOMD0000000562
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000562
"""
...
class SbmlChaouiya2013EgfAndTnfalphaMediatedSignallingPathway(biosim.BioModule):
    """BioModule wrapper for SBML model: Chaouiya2013 - EGF and TNFalpha mediated signalling pathway."""

    def __init__(self, model_path: str = "data/BIOMD0000000562.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Chaouiya2013EgfAndTnfalphaMediatedSignallinBiomd0000000562Model = SbmlChaouiya2013EgfAndTnfalphaMediatedSignallingPathway

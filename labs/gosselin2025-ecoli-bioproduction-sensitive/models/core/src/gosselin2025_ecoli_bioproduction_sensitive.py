...
"""Tellurium-backed SBML wrapper for Gosselin2025 - Ecoli_bioproduction_sensitive."""
...
class Gosselin2025EcoliBioproductionSensitiveModel(TelluriumSBMLBioModule):
    """Faithful Tellurium execution of the bundled SBML source model."""

    _SBML_ID = 'MODEL2506160002'
    _TITLE = 'Gosselin2025 - Ecoli_bioproduction_sensitive'
    ...
    def __init__(self, model_path: str = 'data/MODEL2506160002.xml', integration_step: float = 0.01) -> None:
        super().__init__(model_path=model_path, integration_step=integration_step)


Gosselin2025EcoliBioproductionSensitiveModel2506160002Model = Gosselin2025EcoliBioproductionSensitiveModel

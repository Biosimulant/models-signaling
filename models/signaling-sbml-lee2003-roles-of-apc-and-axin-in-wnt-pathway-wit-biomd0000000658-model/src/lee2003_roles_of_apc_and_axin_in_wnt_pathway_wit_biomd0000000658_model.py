...
"""Auto-generated SBML BioModule wrapper for Lee2003 - Roles of APC and Axin in Wnt Pathway (without regulatory loop).

Source: biomodels_ebi:BIOMD0000000658
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000658
"""
...
class SbmlLee2003RolesOfApcAndAxinInWntPathwayWithout(biosim.BioModule):
    """BioModule wrapper for SBML model: Lee2003 - Roles of APC and Axin in Wnt Pathway (without regulatory loop)."""

    def __init__(self, model_path: str = "data/BIOMD0000000658.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Lee2003RolesOfApcAndAxinInWntPathwayWitBiomd0000000658Model = SbmlLee2003RolesOfApcAndAxinInWntPathwayWithout

...
"""Tellurium-backed SBML wrapper for Bakshi2020 - Truncated minimal model of alternative pathway of complement system."""
...
class Bakshi2020TruncatedMinimalModelOfAlternativModel(TelluriumSBMLBioModule):
    """Faithful Tellurium execution of the bundled SBML source model."""

    _SBML_ID = 'BIOMD0000001016'
    _TITLE = 'Bakshi2020 - Truncated minimal model of alternative pathway of complement system'
    ...
    def __init__(self, model_path: str = 'data/BIOMD0000001016.xml', integration_step: float = 0.01) -> None:
        super().__init__(model_path=model_path, integration_step=integration_step)


Bakshi2020TruncatedMinimalModelOfAlternativBiomd0000001016Model = Bakshi2020TruncatedMinimalModelOfAlternativModel

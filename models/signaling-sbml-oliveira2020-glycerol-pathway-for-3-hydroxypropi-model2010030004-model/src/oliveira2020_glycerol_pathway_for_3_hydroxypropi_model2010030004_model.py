...
"""Auto-generated SBML BioModule wrapper for Oliveira2020 - Glycerol pathway for 3-hydroxypropionate production from glucose.

Source: biomodels_ebi:MODEL2010030004
Original: https://www.ebi.ac.uk/biomodels/MODEL2010030004
"""
...
class SbmlOliveira2020GlycerolPathwayFor3Hydroxypropionate2(biosim.BioModule):
    """BioModule wrapper for SBML model: Oliveira2020 - Glycerol pathway for 3-hydroxypropionate production from glucose."""

    def __init__(self, model_path: str = "data/MODEL2010030004.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Oliveira2020GlycerolPathwayFor3HydroxypropiModel2010030004Model = SbmlOliveira2020GlycerolPathwayFor3Hydroxypropionate2

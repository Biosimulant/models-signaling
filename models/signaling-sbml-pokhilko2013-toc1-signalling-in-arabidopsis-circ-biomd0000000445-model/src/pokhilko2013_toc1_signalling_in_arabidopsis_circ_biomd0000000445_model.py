...
"""Auto-generated SBML BioModule wrapper for Pokhilko2013 - TOC1 signalling in Arabidopsis circadian clock.

Source: biomodels_ebi:BIOMD0000000445
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000445
"""
...
class SbmlPokhilko2013Toc1SignallingInArabidopsisCircadianClock(biosim.BioModule):
    """BioModule wrapper for SBML model: Pokhilko2013 - TOC1 signalling in Arabidopsis circadian clock."""

    def __init__(self, model_path: str = "data/BIOMD0000000445.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Pokhilko2013Toc1SignallingInArabidopsisCircBiomd0000000445Model = SbmlPokhilko2013Toc1SignallingInArabidopsisCircadianClock

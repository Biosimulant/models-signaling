...
"""Auto-generated SBML BioModule wrapper for Maeda2006_MyosinPhosphorylation.

Source: biomodels_ebi:BIOMD0000000088
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000088
"""
...
class SbmlMaeda2006Myosinphosphorylation(biosim.BioModule):
    """BioModule wrapper for SBML model: Maeda2006_MyosinPhosphorylation."""

    def __init__(self, model_path: str = "data/BIOMD0000000088.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Maeda2006MyosinphosphorylationBiomd0000000088Model = SbmlMaeda2006Myosinphosphorylation

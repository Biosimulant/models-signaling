...
"""Auto-generated SBML BioModule wrapper for Ajay_Bhalla_2007_PKM.

Source: biomodels_ebi:MODEL9147232940
Original: https://www.ebi.ac.uk/biomodels/MODEL9147232940
"""
...
class SbmlAjayBhalla2007Pkm(biosim.BioModule):
    """BioModule wrapper for SBML model: Ajay_Bhalla_2007_PKM."""

    def __init__(self, model_path: str = "data/MODEL9147232940.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
AjayBhalla2007PkmModel9147232940Model = SbmlAjayBhalla2007Pkm

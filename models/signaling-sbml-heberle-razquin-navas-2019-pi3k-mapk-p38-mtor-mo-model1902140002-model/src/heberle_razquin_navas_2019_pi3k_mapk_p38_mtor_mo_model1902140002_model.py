...
"""Auto-generated SBML BioModule wrapper for Heberle-Razquin Navas-2019 - PI3K-MAPK/p38-mTOR Model V.

Source: biomodels_ebi:MODEL1902140002
Original: https://www.ebi.ac.uk/biomodels/MODEL1902140002
"""
...
class SbmlHeberleRazquinNavas2019Pi3kMapkP38MtorModelV(biosim.BioModule):
    """BioModule wrapper for SBML model: Heberle-Razquin Navas-2019 - PI3K-MAPK/p38-mTOR Model V."""

    def __init__(self, model_path: str = "data/MODEL1902140002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
HeberleRazquinNavas2019Pi3kMapkP38MtorMoModel1902140002Model = SbmlHeberleRazquinNavas2019Pi3kMapkP38MtorModelV

...
"""Auto-generated SBML BioModule wrapper for Sarma2012 - Interaction topologies of MAPK cascade (M2_K2_QSS_USEQ).

Source: biomodels_ebi:MODEL1204280034
Original: https://www.ebi.ac.uk/biomodels/MODEL1204280034
"""
...
class SbmlSarma2012InteractionTopologiesOfMapkCascadeM2K2Qss(biosim.BioModule):
    """BioModule wrapper for SBML model: Sarma2012 - Interaction topologies of MAPK cascade (M2_K2_QSS_USEQ)."""

    def __init__(self, model_path: str = "data/MODEL1204280034.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Sarma2012InteractionTopologiesOfMapkCascadeModel1204280034Model = SbmlSarma2012InteractionTopologiesOfMapkCascadeM2K2Qss

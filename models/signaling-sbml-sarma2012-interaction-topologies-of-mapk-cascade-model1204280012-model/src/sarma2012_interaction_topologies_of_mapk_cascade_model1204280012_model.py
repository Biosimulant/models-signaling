...
"""Auto-generated SBML BioModule wrapper for Sarma2012 - Interaction topologies of MAPK cascade (M4_K1_USEQ_short_duration_signal).

Source: biomodels_ebi:MODEL1204280012
Original: https://www.ebi.ac.uk/biomodels/MODEL1204280012
"""
...
class SbmlSarma2012InteractionTopologiesOfMapkCascadeM4K1Useq2(biosim.BioModule):
    """BioModule wrapper for SBML model: Sarma2012 - Interaction topologies of MAPK cascade (M4_K1_USEQ_short_duration_signal)."""

    def __init__(self, model_path: str = "data/MODEL1204280012.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Sarma2012InteractionTopologiesOfMapkCascadeModel1204280012Model = SbmlSarma2012InteractionTopologiesOfMapkCascadeM4K1Useq2

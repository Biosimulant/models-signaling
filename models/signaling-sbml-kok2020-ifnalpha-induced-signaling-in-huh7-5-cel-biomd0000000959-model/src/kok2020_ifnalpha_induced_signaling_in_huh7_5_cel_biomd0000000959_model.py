...
"""Auto-generated SBML BioModule wrapper for Kok2020 - IFNalpha-induced signaling in Huh7.5 cells.

Source: biomodels_ebi:BIOMD0000000959
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000959
"""
...
class SbmlKok2020IfnalphaInducedSignalingInHuh75Cells(biosim.BioModule):
    """BioModule wrapper for SBML model: Kok2020 - IFNalpha-induced signaling in Huh7.5 cells."""

    def __init__(self, model_path: str = "data/BIOMD0000000959.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Kok2020IfnalphaInducedSignalingInHuh75CelBiomd0000000959Model = SbmlKok2020IfnalphaInducedSignalingInHuh75Cells

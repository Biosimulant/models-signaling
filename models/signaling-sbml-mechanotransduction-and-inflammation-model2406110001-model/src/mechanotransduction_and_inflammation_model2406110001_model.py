...
"""Auto-generated SBML BioModule wrapper for Mechanotransduction & Inflammation.

Source: biomodels_ebi:MODEL2406110001
Original: https://www.ebi.ac.uk/biomodels/MODEL2406110001
"""
...
class SbmlMechanotransductionInflammation(biosim.BioModule):
    """BioModule wrapper for SBML model: Mechanotransduction & Inflammation."""

    def __init__(self, model_path: str = "data/MODEL2406110001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
MechanotransductionAndInflammationModel2406110001Model = SbmlMechanotransductionInflammation

...
"""Auto-generated SBML BioModule wrapper for Almeida2019 - Transcription-based circadian mechanism controls the duration of molecular clock states in response to signaling inputs.

Source: biomodels_ebi:BIOMD0000000839
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000839
"""
...
class SbmlAlmeida2019TranscriptionBasedCircadianMechanism(biosim.BioModule):
    """BioModule wrapper for SBML model: Almeida2019 - Transcription-based circadian mechanism controls the duration of molecular clock states in response to signaling inputs."""

    def __init__(self, model_path: str = "data/BIOMD0000000839.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Almeida2019TranscriptionBasedCircadianMechanBiomd0000000839Model = SbmlAlmeida2019TranscriptionBasedCircadianMechanism

...
"""Tellurium-backed SBML wrapper for Bush2016 - Simplified Carrousel model of GPCR."""
...
class Bush2016SimplifiedCarrouselModelOfGpcrModel(TelluriumSBMLBioModule):
    """Faithful Tellurium execution of the bundled SBML source model."""

    _SBML_ID = 'BIOMD0000000637'
    _TITLE = 'Bush2016 - Simplified Carrousel model of GPCR'
    ...
    def __init__(self, model_path: str = 'data/BIOMD0000000637.xml', integration_step: float = 0.01) -> None:
        super().__init__(model_path=model_path, integration_step=integration_step)


Bush2016SimplifiedCarrouselModelOfGpcrBiomd0000000637Model = Bush2016SimplifiedCarrouselModelOfGpcrModel

...
class MartinezGuimera2017GenericRedoxSignallingMoModel1710260001Model(TelluriumSBMLBioModule):
    """Faithful Tellurium execution of the bundled SBML source model."""

    _SBML_ID = 'MODEL1710260001'
    ...
    def __init__(self, model_path: str = 'data/MODEL1710260001.xml', integration_step: float = 0.01) -> None:
        super().__init__(model_path=model_path, integration_step=integration_step)


MartinezGuimera2017GenericRedoxSignallingMoModel1710260001Model = MartinezGuimera2017GenericRedoxSignallingMoModel1710260001Model

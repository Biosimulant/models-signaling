...
"""Auto-generated SBML BioModule wrapper for Radulescu2008_NFkB_hierarchy_M_8_12_19.

Source: biomodels_ebi:MODEL7743358405
Original: https://www.ebi.ac.uk/biomodels/MODEL7743358405
"""
...
class SbmlRadulescu2008NfkbHierarchyM81219(biosim.BioModule):
    """BioModule wrapper for SBML model: Radulescu2008_NFkB_hierarchy_M_8_12_19."""

    def __init__(self, model_path: str = "data/MODEL7743358405.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Radulescu2008NfkbHierarchyM81219Model7743358405Model = SbmlRadulescu2008NfkbHierarchyM81219

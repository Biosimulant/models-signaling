...
"""Auto-generated SBML BioModule wrapper for Nakakuki2010_CellFateDecision_Core.

Source: biomodels_ebi:BIOMD0000000251
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000251
"""
...
class SbmlNakakuki2010CellfatedecisionCore(biosim.BioModule):
    """BioModule wrapper for SBML model: Nakakuki2010_CellFateDecision_Core."""

    def __init__(self, model_path: str = "data/BIOMD0000000251.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Nakakuki2010CellfatedecisionCoreBiomd0000000251Model = SbmlNakakuki2010CellfatedecisionCore

...
"""Auto-generated SBML BioModule wrapper for Hodgson2018 - TGFbeta signalling and inflammatory response.

Source: biomodels_ebi:MODEL1805080001
Original: https://www.ebi.ac.uk/biomodels/MODEL1805080001
"""
...
class SbmlHodgson2018TgfbetaSignallingAndInflammatoryResponse(biosim.BioModule):
    """BioModule wrapper for SBML model: Hodgson2018 - TGFbeta signalling and inflammatory response."""

    def __init__(self, model_path: str = "data/MODEL1805080001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Hodgson2018TgfbetaSignallingAndInflammatoryModel1805080001Model = SbmlHodgson2018TgfbetaSignallingAndInflammatoryResponse

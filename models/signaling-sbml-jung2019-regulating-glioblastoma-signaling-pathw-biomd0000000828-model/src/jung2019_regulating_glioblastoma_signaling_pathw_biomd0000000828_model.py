...
"""Auto-generated SBML BioModule wrapper for Jung2019 - Regulating glioblastoma signaling pathways and anti-invasion therapy - core control model.

Source: biomodels_ebi:BIOMD0000000828
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000828
"""
...
class SbmlJung2019RegulatingGlioblastomaSignalingPathwaysAnd(biosim.BioModule):
    """BioModule wrapper for SBML model: Jung2019 - Regulating glioblastoma signaling pathways and anti-invasion therapy - core control model."""

    def __init__(self, model_path: str = "data/BIOMD0000000828.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Jung2019RegulatingGlioblastomaSignalingPathwBiomd0000000828Model = SbmlJung2019RegulatingGlioblastomaSignalingPathwaysAnd

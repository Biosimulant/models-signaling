...
"""Auto-generated SBML BioModule wrapper for PetelenzKuehn_osmoadaptation_pfk2627D.

Source: biomodels_ebi:BIOMD0000000604
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000604
"""
...
class SbmlPetelenzkuehnOsmoadaptationPfk2627d(biosim.BioModule):
    """BioModule wrapper for SBML model: PetelenzKuehn_osmoadaptation_pfk2627D."""

    def __init__(self, model_path: str = "data/BIOMD0000000604.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
PetelenzkuehnOsmoadaptationPfk2627dBiomd0000000604Model = SbmlPetelenzkuehnOsmoadaptationPfk2627d

...
"""Auto-generated SBML BioModule wrapper for Ito2019 - gefitnib resistance of lung adenocarcinoma caused by MET amplification.

Source: biomodels_ebi:BIOMD0000000827
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000827
"""
...
class SbmlIto2019GefitnibResistanceOfLungAdenocarcinomaCaused(biosim.BioModule):
    """BioModule wrapper for SBML model: Ito2019 - gefitnib resistance of lung adenocarcinoma caused by MET amplification."""

    def __init__(self, model_path: str = "data/BIOMD0000000827.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Ito2019GefitnibResistanceOfLungAdenocarcinoBiomd0000000827Model = SbmlIto2019GefitnibResistanceOfLungAdenocarcinomaCaused

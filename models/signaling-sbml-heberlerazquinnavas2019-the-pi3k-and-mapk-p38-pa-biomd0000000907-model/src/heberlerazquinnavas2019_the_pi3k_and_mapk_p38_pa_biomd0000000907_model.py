...
"""Auto-generated SBML BioModule wrapper for HeberleRazquinNavas2019 - The PI3K and MAPK/p38 pathways control stress granuleassembly in a hierarchical manner model 3.

Source: biomodels_ebi:BIOMD0000000907
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000907
"""
...
class SbmlHeberlerazquinnavas2019ThePi3kAndMapkP38Pathways(biosim.BioModule):
    """BioModule wrapper for SBML model: HeberleRazquinNavas2019 - The PI3K and MAPK/p38 pathways control stress granuleassembly in a hierarchical manner model 3."""

    def __init__(self, model_path: str = "data/BIOMD0000000907.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Heberlerazquinnavas2019ThePi3kAndMapkP38PaBiomd0000000907Model = SbmlHeberlerazquinnavas2019ThePi3kAndMapkP38Pathways

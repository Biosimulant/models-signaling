...
"""Auto-generated SBML BioModule wrapper for Koo2013 - Shear stress induced AKT and eNOS phosphorylation - Model 2.

Source: biomodels_ebi:BIOMD0000000465
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000465
"""
...
class SbmlKoo2013ShearStressInducedAktAndEnosPhosphorylation(biosim.BioModule):
    """BioModule wrapper for SBML model: Koo2013 - Shear stress induced AKT and eNOS phosphorylation - Model 2."""

    def __init__(self, model_path: str = "data/BIOMD0000000465.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Koo2013ShearStressInducedAktAndEnosPhosphBiomd0000000465Model = SbmlKoo2013ShearStressInducedAktAndEnosPhosphorylation

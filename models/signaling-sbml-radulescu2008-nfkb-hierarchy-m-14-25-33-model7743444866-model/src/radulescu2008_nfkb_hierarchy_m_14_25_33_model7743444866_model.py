...
"""Auto-generated SBML BioModule wrapper for Radulescu2008_NFkB_hierarchy_M_14_25_33.

Source: biomodels_ebi:MODEL7743444866
Original: https://www.ebi.ac.uk/biomodels/MODEL7743444866
"""
...
class SbmlRadulescu2008NfkbHierarchyM142533(biosim.BioModule):
    """BioModule wrapper for SBML model: Radulescu2008_NFkB_hierarchy_M_14_25_33."""

    def __init__(self, model_path: str = "data/MODEL7743444866.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Radulescu2008NfkbHierarchyM142533Model7743444866Model = SbmlRadulescu2008NfkbHierarchyM142533

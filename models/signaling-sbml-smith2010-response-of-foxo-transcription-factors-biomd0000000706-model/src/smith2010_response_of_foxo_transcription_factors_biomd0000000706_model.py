...
"""Auto-generated SBML BioModule wrapper for Smith2010 - Response of FOXO Transcription Factors to Post-Translational Modifications (with acetylation pathway).

Source: biomodels_ebi:BIOMD0000000706
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000706
"""
...
class SbmlSmith2010ResponseOfFoxoTranscriptionFactorsToPost2(biosim.BioModule):
    """BioModule wrapper for SBML model: Smith2010 - Response of FOXO Transcription Factors to Post-Translational Modifications (with acetylation pathway)."""

    def __init__(self, model_path: str = "data/BIOMD0000000706.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Smith2010ResponseOfFoxoTranscriptionFactorsBiomd0000000706Model = SbmlSmith2010ResponseOfFoxoTranscriptionFactorsToPost2

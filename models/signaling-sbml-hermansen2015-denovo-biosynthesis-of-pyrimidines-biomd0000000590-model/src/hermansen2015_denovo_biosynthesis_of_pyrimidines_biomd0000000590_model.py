...
"""Auto-generated SBML BioModule wrapper for Hermansen2015 - denovo biosynthesis of pyrimidines in yeast.

Source: biomodels_ebi:BIOMD0000000590
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000590
"""
...
class SbmlHermansen2015DenovoBiosynthesisOfPyrimidinesInYeast(biosim.BioModule):
    """BioModule wrapper for SBML model: Hermansen2015 - denovo biosynthesis of pyrimidines in yeast."""

    def __init__(self, model_path: str = "data/BIOMD0000000590.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Hermansen2015DenovoBiosynthesisOfPyrimidinesBiomd0000000590Model = SbmlHermansen2015DenovoBiosynthesisOfPyrimidinesInYeast

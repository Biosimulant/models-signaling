...
"""Tellurium-backed SBML wrapper for Nair2015 - Interaction between neuromodulators via GPCRs - Effect on cAMP/PKA signaling (D2 Neuron)."""
...
class Nair2015InteractionBetweenNeuromodulatorsViaBiomd0000000636Model(TelluriumSBMLBioModule):
    """Faithful Tellurium execution of the bundled SBML source model."""

    _SBML_ID = 'BIOMD0000000636'
    _TITLE = 'Nair2015 - Interaction between neuromodulators via GPCRs - Effect on cAMP/PKA signaling (D2 Neuron)'
    ...
    _HEADLINE_OUTPUTS = {'golf_g_protein': ('mw351f6cee_3e64_4b8e_8e60_24b1aca99a92',
     ...
     'source_defined_ac5_state': ('mw724f1afe_8032_40ae_96ca_808ab7b8b943',
                                  ...
                                  'SBML units.')}
    _INITIAL_CONDITION_INPUTS = {'initial_adenosine': ('mwbe974953_e869_4622_b4a8_745555c8d7fd',
                           150.0,
                           'native SBML value',
                           'Initial level of adenosine. Maps to SBML symbol '
                           '`mwbe974953_e869_4622_b4a8_745555c8d7fd`; exposed as a traceable '
    ...
    _SPECIES_LABELS = {'mwa2c44a01_28c9_4dbd_b034_364f9b5b6cc3': 'Gai GTP',
     ...
     'mw0b46978f_b522_4cde_97f0_574cd7dbbae7': 'A2argolf',
     ...
     'mwbe974953_e869_4622_b4a8_745555c8d7fd': 'adenosine',
     ...
     'mwf82770b9_766a_4c4e_851a_d76da19e8517': 'D2R',
     'mw9d5c5c9d_301d_4e43_ba7b_7d21ccbdc2c2': 'D2RDA',
     'mwd86ce0dc_7329_4b27_9de0_ee6bffee3083': 'D2rgi',
     'mwd8ea533a_c66e_4de4_8c5c_0d4201d8c8a2': 'source-defined GI state',
     'mwe4e36b8e_18b8_4c76_bd46_13614b71da5c': 'D2rdagi',
     'mwb80e4fa1_4849_4ed5_b3b0_3e3025c61ad8': 'source-defined GBGI state',
     'mw9bcba6bc_9788_4f7f_afb5_1c8f3b33c3d1': 'Gai GDP',
     'mw3e1a2fbf_37b1_490c_9528_6cb6bbf11b21': 'source-defined DA state',
    ...
    _STATE_OUTPUT_ALIASES = {'mwa2c44a01_28c9_4dbd_b034_364f9b5b6cc3': 'gai_gtp',
     ...
     'mw3e1a2fbf_37b1_490c_9528_6cb6bbf11b21': 'source_defined_da_state',
     'mw1041345b_f015_436c_9eff_98211008aa1c': 'pde10c',
     'mw3d9e6efb_8e12_49c9_a87f_e067914b951d': 'pde10',
    ...
    def __init__(self, model_path: str = 'data/BIOMD0000000636.xml', integration_step: float = 0.01) -> None:
        super().__init__(model_path=model_path, integration_step=integration_step)


Nair2015InteractionBetweenNeuromodulatorsViaBiomd0000000636Model = Nair2015InteractionBetweenNeuromodulatorsViaBiomd0000000636Model

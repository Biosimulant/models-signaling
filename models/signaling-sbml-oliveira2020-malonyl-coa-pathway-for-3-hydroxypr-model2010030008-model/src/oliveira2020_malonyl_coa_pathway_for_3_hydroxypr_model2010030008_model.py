...
"""Auto-generated SBML BioModule wrapper for Oliveira2020 - Malonyl-CoA pathway for 3-hydroxypropionate production from glycerol.

Source: biomodels_ebi:MODEL2010030008
Original: https://www.ebi.ac.uk/biomodels/MODEL2010030008
"""
...
class SbmlOliveira2020MalonylCoaPathwayFor3Hydroxypropionate2(biosim.BioModule):
    """BioModule wrapper for SBML model: Oliveira2020 - Malonyl-CoA pathway for 3-hydroxypropionate production from glycerol."""

    def __init__(self, model_path: str = "data/MODEL2010030008.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Oliveira2020MalonylCoaPathwayFor3HydroxyprModel2010030008Model = SbmlOliveira2020MalonylCoaPathwayFor3Hydroxypropionate2

...
"""Auto-generated SBML BioModule wrapper for Levchenko2000_MAPK_Scaffold.

Source: biomodels_ebi:BIOMD0000000014
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000014
"""
...
class SbmlLevchenko2000MapkScaffold(biosim.BioModule):
    """BioModule wrapper for SBML model: Levchenko2000_MAPK_Scaffold."""

    def __init__(self, model_path: str = "data/BIOMD0000000014.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Levchenko2000MapkScaffoldBiomd0000000014Model = SbmlLevchenko2000MapkScaffold

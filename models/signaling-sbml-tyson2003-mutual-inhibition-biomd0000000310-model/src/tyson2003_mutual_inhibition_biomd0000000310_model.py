...
"""Auto-generated SBML BioModule wrapper for Tyson2003_Mutual_Inhibition.

Source: biomodels_ebi:BIOMD0000000310
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000310
"""
...
class SbmlTyson2003MutualInhibition(biosim.BioModule):
    """BioModule wrapper for SBML model: Tyson2003_Mutual_Inhibition."""

    def __init__(self, model_path: str = "data/BIOMD0000000310.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Tyson2003MutualInhibitionBiomd0000000310Model = SbmlTyson2003MutualInhibition

...
"""Auto-generated SBML BioModule wrapper for Sivakumar2011 - Notch Signaling Pathway.

Source: biomodels_ebi:BIOMD0000000396
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000396
"""
...
class SbmlSivakumar2011NotchSignalingPathway(biosim.BioModule):
    """BioModule wrapper for SBML model: Sivakumar2011 - Notch Signaling Pathway."""

    def __init__(self, model_path: str = "data/BIOMD0000000396.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Sivakumar2011NotchSignalingPathwayBiomd0000000396Model = SbmlSivakumar2011NotchSignalingPathway

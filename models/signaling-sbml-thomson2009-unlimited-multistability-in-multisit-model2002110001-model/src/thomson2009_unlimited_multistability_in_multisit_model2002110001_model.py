...
"""Auto-generated SBML BioModule wrapper for Thomson2009 – Unlimited multistability in multisite phosphorylation systems.

Source: biomodels_ebi:MODEL2002110001
Original: https://www.ebi.ac.uk/biomodels/MODEL2002110001
"""
...
class SbmlThomson2009UnlimitedMultistabilityInMultisite(biosim.BioModule):
    """BioModule wrapper for SBML model: Thomson2009 – Unlimited multistability in multisite phosphorylation systems."""

    def __init__(self, model_path: str = "data/MODEL2002110001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Thomson2009UnlimitedMultistabilityInMultisitModel2002110001Model = SbmlThomson2009UnlimitedMultistabilityInMultisite

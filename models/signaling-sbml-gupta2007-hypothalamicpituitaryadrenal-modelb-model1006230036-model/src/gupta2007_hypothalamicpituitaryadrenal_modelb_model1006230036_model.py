...
"""Auto-generated SBML BioModule wrapper for Gupta2007_HypothalamicPituitaryAdrenal_ModelB.

Source: biomodels_ebi:MODEL1006230036
Original: https://www.ebi.ac.uk/biomodels/MODEL1006230036
"""
...
class SbmlGupta2007HypothalamicpituitaryadrenalModelb(biosim.BioModule):
    """BioModule wrapper for SBML model: Gupta2007_HypothalamicPituitaryAdrenal_ModelB."""

    def __init__(self, model_path: str = "data/MODEL1006230036.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Gupta2007HypothalamicpituitaryadrenalModelbModel1006230036Model = SbmlGupta2007HypothalamicpituitaryadrenalModelb

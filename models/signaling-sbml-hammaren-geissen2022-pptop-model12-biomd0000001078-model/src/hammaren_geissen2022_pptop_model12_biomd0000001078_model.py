...
"""Auto-generated SBML BioModule wrapper for Hammaren-Geissen2022_PPToP_Model12.

Source: biomodels_ebi:BIOMD0000001078
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000001078
"""
...
class SbmlHammarenGeissen2022PptopModel12(biosim.BioModule):
    """BioModule wrapper for SBML model: Hammaren-Geissen2022_PPToP_Model12."""

    def __init__(self, model_path: str = "data/BIOMD0000001078.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
HammarenGeissen2022PptopModel12Biomd0000001078Model = SbmlHammarenGeissen2022PptopModel12

...
"""Auto-generated SBML BioModule wrapper for Mukhopadhyay2013 - T cell receptor proximal signaling reveals emergent ultrasensitivity.

Source: biomodels_ebi:MODEL1604100000
Original: https://www.ebi.ac.uk/biomodels/MODEL1604100000
"""
...
class SbmlMukhopadhyay2013TCellReceptorProximalSignalingReveals(biosim.BioModule):
    """BioModule wrapper for SBML model: Mukhopadhyay2013 - T cell receptor proximal signaling reveals emergent ultrasensitivity."""

    def __init__(self, model_path: str = "data/MODEL1604100000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Mukhopadhyay2013TCellReceptorProximalSignalModel1604100000Model = SbmlMukhopadhyay2013TCellReceptorProximalSignalingReveals

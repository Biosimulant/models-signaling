...
"""Tellurium-backed SBML wrapper for Gupta2007_HypothalamicPituitaryAdrenal_ModelA."""
...
class Gupta2007HypothalamicpituitaryadrenalModelaModel(TelluriumSBMLBioModule):
    """Faithful Tellurium execution of the bundled SBML source model."""

    _SBML_ID = 'MODEL1006230111'
    _TITLE = 'Gupta2007_HypothalamicPituitaryAdrenal_ModelA'
    ...
    def __init__(self, model_path: str = 'data/MODEL1006230111.xml', integration_step: float = 0.01) -> None:
        super().__init__(model_path=model_path, integration_step=integration_step)


Gupta2007HypothalamicpituitaryadrenalModelaModel1006230111Model = Gupta2007HypothalamicpituitaryadrenalModelaModel

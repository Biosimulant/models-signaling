...
"""Auto-generated SBML BioModule wrapper for Trares2022 - Crosstalk between the canonical and non-canonical NF-kB pathways, Petri net.

Source: biomodels_ebi:MODEL2207210003
Original: https://www.ebi.ac.uk/biomodels/MODEL2207210003
"""
...
class SbmlTrares2022CrosstalkBetweenTheCanonicalAndNon(biosim.BioModule):
    """BioModule wrapper for SBML model: Trares2022 - Crosstalk between the canonical and non-canonical NF-kB pathways, Petri net."""

    def __init__(self, model_path: str = "data/MODEL2207210003.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Trares2022CrosstalkBetweenTheCanonicalAndNModel2207210003Model = SbmlTrares2022CrosstalkBetweenTheCanonicalAndNon

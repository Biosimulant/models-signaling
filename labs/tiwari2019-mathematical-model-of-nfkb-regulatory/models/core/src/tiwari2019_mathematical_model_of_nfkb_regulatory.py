...
"""Tellurium-backed SBML wrapper for Tiwari2019 - Mathematical model of NFKB regulatory module with TNF and ROS."""
...
class Tiwari2019MathematicalModelOfNfkbRegulatoryModel(TelluriumSBMLBioModule):
    """Faithful Tellurium execution of the bundled SBML source model."""

    _SBML_ID = 'MODEL1911140002'
    _TITLE = 'Tiwari2019 - Mathematical model of NFKB regulatory module with TNF and ROS'
    ...
    def __init__(self, model_path: str = 'data/MODEL1911140002.xml', integration_step: float = 0.01) -> None:
        super().__init__(model_path=model_path, integration_step=integration_step)


Tiwari2019MathematicalModelOfNfkbRegulatoryModel1911140002Model = Tiwari2019MathematicalModelOfNfkbRegulatoryModel

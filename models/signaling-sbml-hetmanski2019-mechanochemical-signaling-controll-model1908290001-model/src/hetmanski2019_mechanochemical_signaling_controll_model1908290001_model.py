...
"""Auto-generated SBML BioModule wrapper for Hetmanski2019 - Mechanochemical signaling controlled rear retraction of migrating cell.

Source: biomodels_ebi:MODEL1908290001
Original: https://www.ebi.ac.uk/biomodels/MODEL1908290001
"""
...
class SbmlHetmanski2019MechanochemicalSignalingControlledRear(biosim.BioModule):
    """BioModule wrapper for SBML model: Hetmanski2019 - Mechanochemical signaling controlled rear retraction of migrating cell."""

    def __init__(self, model_path: str = "data/MODEL1908290001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Hetmanski2019MechanochemicalSignalingControllModel1908290001Model = SbmlHetmanski2019MechanochemicalSignalingControlledRear

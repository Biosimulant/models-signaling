...
"""Auto-generated SBML BioModule wrapper for Markevich2004 - MAPK double phosphorylation,  ordered Michaelis-Menton.

Source: biomodels_ebi:BIOMD0000000027
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000027
"""
...
class SbmlMarkevich2004MapkDoublePhosphorylationOrderedMichaelis(biosim.BioModule):
    """BioModule wrapper for SBML model: Markevich2004 - MAPK double phosphorylation,  ordered Michaelis-Menton."""

    def __init__(self, model_path: str = "data/BIOMD0000000027.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Markevich2004MapkDoublePhosphorylationOrdereBiomd0000000027Model = SbmlMarkevich2004MapkDoublePhosphorylationOrderedMichaelis

...
"""Auto-generated SBML BioModule wrapper for Neiburga2022 - Arabidopsis thaliana wild-type MEP pathway kinetic model.

Source: biomodels_ebi:MODEL2206090001
Original: https://www.ebi.ac.uk/biomodels/MODEL2206090001
"""
...
class SbmlNeiburga2022ArabidopsisThalianaWildTypeMepPathway(biosim.BioModule):
    """BioModule wrapper for SBML model: Neiburga2022 - Arabidopsis thaliana wild-type MEP pathway kinetic model."""

    def __init__(self, model_path: str = "data/MODEL2206090001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Neiburga2022ArabidopsisThalianaWildTypeMepModel2206090001Model = SbmlNeiburga2022ArabidopsisThalianaWildTypeMepPathway

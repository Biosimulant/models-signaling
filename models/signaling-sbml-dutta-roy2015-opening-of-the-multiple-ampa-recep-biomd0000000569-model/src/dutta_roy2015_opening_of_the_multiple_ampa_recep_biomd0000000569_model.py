...
"""Auto-generated SBML BioModule wrapper for Dutta-Roy2015 - Opening of the multiple AMPA receptor conductance states.

Source: biomodels_ebi:BIOMD0000000569
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000569
"""
...
class SbmlDuttaRoy2015OpeningOfTheMultipleAmpaReceptor(biosim.BioModule):
    """BioModule wrapper for SBML model: Dutta-Roy2015 - Opening of the multiple AMPA receptor conductance states."""

    def __init__(self, model_path: str = "data/BIOMD0000000569.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
DuttaRoy2015OpeningOfTheMultipleAmpaRecepBiomd0000000569Model = SbmlDuttaRoy2015OpeningOfTheMultipleAmpaReceptor

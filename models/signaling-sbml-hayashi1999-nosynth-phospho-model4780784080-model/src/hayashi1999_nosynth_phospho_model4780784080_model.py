...
"""Auto-generated SBML BioModule wrapper for Hayashi1999_NOSynth_Phospho.

Source: biomodels_ebi:MODEL4780784080
Original: https://www.ebi.ac.uk/biomodels/MODEL4780784080
"""
...
class SbmlHayashi1999NosynthPhospho(biosim.BioModule):
    """BioModule wrapper for SBML model: Hayashi1999_NOSynth_Phospho."""

    def __init__(self, model_path: str = "data/MODEL4780784080.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Hayashi1999NosynthPhosphoModel4780784080Model = SbmlHayashi1999NosynthPhospho

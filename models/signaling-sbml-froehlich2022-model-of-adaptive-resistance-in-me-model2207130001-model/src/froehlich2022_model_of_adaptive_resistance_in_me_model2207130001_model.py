...
"""Auto-generated SBML BioModule wrapper for Froehlich2022 - Model of Adaptive Resistance in Melanoma.

Source: biomodels_ebi:MODEL2207130001
Original: https://www.ebi.ac.uk/biomodels/MODEL2207130001
"""
...
class SbmlFroehlich2022ModelOfAdaptiveResistanceInMelanoma(biosim.BioModule):
    """BioModule wrapper for SBML model: Froehlich2022 - Model of Adaptive Resistance in Melanoma."""

    def __init__(self, model_path: str = "data/MODEL2207130001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Froehlich2022ModelOfAdaptiveResistanceInMeModel2207130001Model = SbmlFroehlich2022ModelOfAdaptiveResistanceInMelanoma

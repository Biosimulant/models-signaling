...
"""Tellurium-backed SBML wrapper for Sarma2012 - Oscillations in MAPK cascade (S1n)."""
...
class Sarma2012OscillationsInMapkCascadeS1nModel(TelluriumSBMLBioModule):
    """Faithful Tellurium execution of the bundled SBML source model."""

    _SBML_ID = 'BIOMD0000000443'
    _TITLE = 'Sarma2012 - Oscillations in MAPK cascade (S1n)'
    ...
    def __init__(self, model_path: str = 'data/BIOMD0000000443.xml', integration_step: float = 0.01) -> None:
        super().__init__(model_path=model_path, integration_step=integration_step)


Sarma2012OscillationsInMapkCascadeS1nBiomd0000000443Model = Sarma2012OscillationsInMapkCascadeS1nModel

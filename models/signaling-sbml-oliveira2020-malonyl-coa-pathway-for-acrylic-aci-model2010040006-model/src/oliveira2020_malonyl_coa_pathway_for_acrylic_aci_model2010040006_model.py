...
"""Auto-generated SBML BioModule wrapper for Oliveira2020 - Malonyl-CoA pathway for Acrylic Acid production from glucose.

Source: biomodels_ebi:MODEL2010040006
Original: https://www.ebi.ac.uk/biomodels/MODEL2010040006
"""
...
class SbmlOliveira2020MalonylCoaPathwayForAcrylicAcid(biosim.BioModule):
    """BioModule wrapper for SBML model: Oliveira2020 - Malonyl-CoA pathway for Acrylic Acid production from glucose."""

    def __init__(self, model_path: str = "data/MODEL2010040006.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Oliveira2020MalonylCoaPathwayForAcrylicAciModel2010040006Model = SbmlOliveira2020MalonylCoaPathwayForAcrylicAcid

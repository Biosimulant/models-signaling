...
"""Auto-generated SBML BioModule wrapper for Abell2011_CalciumSignaling_WithoutAdaptation.

Source: biomodels_ebi:BIOMD0000000354
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000354
"""
...
class SbmlAbell2011CalciumsignalingWithoutadaptation(biosim.BioModule):
    """BioModule wrapper for SBML model: Abell2011_CalciumSignaling_WithoutAdaptation."""

    def __init__(self, model_path: str = "data/BIOMD0000000354.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Abell2011CalciumsignalingWithoutadaptationBiomd0000000354Model = SbmlAbell2011CalciumsignalingWithoutadaptation

...
"""Auto-generated SBML BioModule wrapper for Komarova2005_TheoreticalFramework_BasicArchitecture.

Source: biomodels_ebi:BIOMD0000000125
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000125
"""
...
class SbmlKomarova2005TheoreticalframeworkBasicarchitecture(biosim.BioModule):
    """BioModule wrapper for SBML model: Komarova2005_TheoreticalFramework_BasicArchitecture."""

    def __init__(self, model_path: str = "data/BIOMD0000000125.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Komarova2005TheoreticalframeworkBasicarchitectBiomd0000000125Model = SbmlKomarova2005TheoreticalframeworkBasicarchitecture

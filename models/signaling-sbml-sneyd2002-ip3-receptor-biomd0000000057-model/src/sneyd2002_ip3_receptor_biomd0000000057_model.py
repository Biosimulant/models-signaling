...
"""Auto-generated SBML BioModule wrapper for Sneyd2002_IP3_Receptor.

Source: biomodels_ebi:BIOMD0000000057
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000057
"""
...
class SbmlSneyd2002Ip3Receptor(biosim.BioModule):
    """BioModule wrapper for SBML model: Sneyd2002_IP3_Receptor."""

    def __init__(self, model_path: str = "data/BIOMD0000000057.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Sneyd2002Ip3ReceptorBiomd0000000057Model = SbmlSneyd2002Ip3Receptor

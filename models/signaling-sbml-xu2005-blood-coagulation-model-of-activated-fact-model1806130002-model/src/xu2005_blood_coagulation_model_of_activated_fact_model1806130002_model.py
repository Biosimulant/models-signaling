...
"""Auto-generated SBML BioModule wrapper for Xu2005 - Blood Coagulation Model of Activated Factors of Extrinsic Pathway and TFPI.

Source: biomodels_ebi:MODEL1806130002
Original: https://www.ebi.ac.uk/biomodels/MODEL1806130002
"""
...
class SbmlXu2005BloodCoagulationModelOfActivatedFactorsOf(biosim.BioModule):
    """BioModule wrapper for SBML model: Xu2005 - Blood Coagulation Model of Activated Factors of Extrinsic Pathway and TFPI."""

    def __init__(self, model_path: str = "data/MODEL1806130002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Xu2005BloodCoagulationModelOfActivatedFactModel1806130002Model = SbmlXu2005BloodCoagulationModelOfActivatedFactorsOf

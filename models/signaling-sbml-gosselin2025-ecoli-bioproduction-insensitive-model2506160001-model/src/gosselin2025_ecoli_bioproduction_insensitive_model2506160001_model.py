...
"""Auto-generated SBML BioModule wrapper for Gosselin2025 - Ecoli_bioproduction_insensitive.

Source: biomodels_ebi:MODEL2506160001
Original: https://www.ebi.ac.uk/biomodels/MODEL2506160001
"""
...
class SbmlGosselin2025EcoliBioproductionInsensitive(biosim.BioModule):
    """BioModule wrapper for SBML model: Gosselin2025 - Ecoli_bioproduction_insensitive."""

    def __init__(self, model_path: str = "data/MODEL2506160001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Gosselin2025EcoliBioproductionInsensitiveModel2506160001Model = SbmlGosselin2025EcoliBioproductionInsensitive

...
"""Auto-generated SBML BioModule wrapper for Panteleev2002_TFPImechanism_schmema1.

Source: biomodels_ebi:BIOMD0000000361
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000361
"""
...
class SbmlPanteleev2002TfpimechanismSchmema1(biosim.BioModule):
    """BioModule wrapper for SBML model: Panteleev2002_TFPImechanism_schmema1."""

    def __init__(self, model_path: str = "data/BIOMD0000000361.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Panteleev2002TfpimechanismSchmema1Biomd0000000361Model = SbmlPanteleev2002TfpimechanismSchmema1

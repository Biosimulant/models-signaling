...
"""Tellurium-backed SBML wrapper for Strasen2018 - TGFb SMAD Signalling Class 3."""
...
class Strasen2018TgfbSmadSignallingClass3Model(TelluriumSBMLBioModule):
    """Faithful Tellurium execution of the bundled SBML source model."""

    _SBML_ID = 'BIOMD0000001000'
    _TITLE = 'Strasen2018 - TGFb SMAD Signalling Class 3'
    ...
    _HEADLINE_OUTPUTS = {'active_tgfr2': ('Active_R2',
     ...
     'active_rec': ('Active_Rec',
                    'native SBML value',
                    'active Rec. Maps to SBML symbol `Active_Rec` and is emitted in native SBML '
                    'units.'),
     'active_rec_endo': ('Active_Rec_endo',
                         'native SBML value',
                         'active Rec Endo. Maps to SBML symbol `Active_Rec_endo` and is emitted in '
                         'native SBML units.')}
    ...
    _SPECIES_LABELS = {'TGFb_R1_surface': 'TGF-beta TGFR1 Surface',
     ...
     'Active_Rec': 'active Rec',
     'Active_Rec_endo': 'active Rec Endo',
     'Inactive_Rec': 'Inactive Rec',
     'pS2_c': 'P SMAD2 C',
     'S2_c': 'SMAD2 C',
     'S4_c': 'SMAD4 C',
    ...
    def __init__(self, model_path: str = 'data/BIOMD0000001000.xml', integration_step: float = 0.01) -> None:
        super().__init__(model_path=model_path, integration_step=integration_step)


Strasen2018TgfbSmadSignallingClass3Biomd0000001000Model = Strasen2018TgfbSmadSignallingClass3Model

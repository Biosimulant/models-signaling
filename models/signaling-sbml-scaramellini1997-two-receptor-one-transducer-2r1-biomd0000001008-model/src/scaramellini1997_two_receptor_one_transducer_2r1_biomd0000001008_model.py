...
"""Auto-generated SBML BioModule wrapper for Scaramellini1997 - Two-receptor:One-transducer (2R1T) model for analysis of interactions between agonists.

Source: biomodels_ebi:BIOMD0000001008
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000001008
"""
...
class SbmlScaramellini1997TwoReceptorOneTransducer2r1tModelFor(biosim.BioModule):
    """BioModule wrapper for SBML model: Scaramellini1997 - Two-receptor:One-transducer (2R1T) model for analysis of interactions between agonists."""

    def __init__(self, model_path: str = "data/BIOMD0000001008.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Scaramellini1997TwoReceptorOneTransducer2r1Biomd0000001008Model = SbmlScaramellini1997TwoReceptorOneTransducer2r1tModelFor

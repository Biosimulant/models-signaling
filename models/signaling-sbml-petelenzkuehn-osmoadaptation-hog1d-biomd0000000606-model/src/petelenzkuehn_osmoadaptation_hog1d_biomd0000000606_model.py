...
"""Auto-generated SBML BioModule wrapper for PetelenzKuehn_osmoadaptation_hog1D.

Source: biomodels_ebi:BIOMD0000000606
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000606
"""
...
class SbmlPetelenzkuehnOsmoadaptationHog1d(biosim.BioModule):
    """BioModule wrapper for SBML model: PetelenzKuehn_osmoadaptation_hog1D."""

    def __init__(self, model_path: str = "data/BIOMD0000000606.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
PetelenzkuehnOsmoadaptationHog1dBiomd0000000606Model = SbmlPetelenzkuehnOsmoadaptationHog1d

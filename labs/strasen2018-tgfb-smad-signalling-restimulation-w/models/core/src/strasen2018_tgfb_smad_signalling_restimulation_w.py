...
"""Tellurium-backed SBML wrapper for Strasen2018 - TGFb SMAD Signalling - Restimulation with 5pM TGFb at 3hr."""
...
class Strasen2018TgfbSmadSignallingRestimulationWModel(TelluriumSBMLBioModule):
    """Faithful Tellurium execution of the bundled SBML source model."""

    _SBML_ID = 'BIOMD0000000994'
    _TITLE = 'Strasen2018 - TGFb SMAD Signalling - Restimulation with 5pM TGFb at 3hr'
    ...
    def __init__(self, model_path: str = 'data/BIOMD0000000994.xml', integration_step: float = 0.01) -> None:
        super().__init__(model_path=model_path, integration_step=integration_step)


Strasen2018TgfbSmadSignallingRestimulationWBiomd0000000994Model = Strasen2018TgfbSmadSignallingRestimulationWModel

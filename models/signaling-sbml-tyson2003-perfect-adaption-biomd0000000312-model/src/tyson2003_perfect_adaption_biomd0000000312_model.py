...
"""Auto-generated SBML BioModule wrapper for Tyson2003_Perfect_Adaption.

Source: biomodels_ebi:BIOMD0000000312
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000312
"""
...
class SbmlTyson2003PerfectAdaption(biosim.BioModule):
    """BioModule wrapper for SBML model: Tyson2003_Perfect_Adaption."""

    def __init__(self, model_path: str = "data/BIOMD0000000312.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Tyson2003PerfectAdaptionBiomd0000000312Model = SbmlTyson2003PerfectAdaption

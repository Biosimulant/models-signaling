...
"""Auto-generated SBML BioModule wrapper for Nair2015 - Interaction between neuromodulators via GPCRs - Effect on cAMP/PKA signaling (D1 Neuron).

Source: biomodels_ebi:BIOMD0000000635
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000635
"""
...
class SbmlNair2015InteractionBetweenNeuromodulatorsViaGpcrs(biosim.BioModule):
    """BioModule wrapper for SBML model: Nair2015 - Interaction between neuromodulators via GPCRs - Effect on cAMP/PKA signaling (D1 Neuron)."""

    def __init__(self, model_path: str = "data/BIOMD0000000635.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Nair2015InteractionBetweenNeuromodulatorsViaBiomd0000000635Model = SbmlNair2015InteractionBetweenNeuromodulatorsViaGpcrs

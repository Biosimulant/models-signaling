...
"""Auto-generated SBML BioModule wrapper for Sarma2012 - Interaction topologies of MAPK cascade (M3_K2_USEQ).

Source: biomodels_ebi:MODEL1204280019
Original: https://www.ebi.ac.uk/biomodels/MODEL1204280019
"""
...
class SbmlSarma2012InteractionTopologiesOfMapkCascadeM3K2Useq2(biosim.BioModule):
    """BioModule wrapper for SBML model: Sarma2012 - Interaction topologies of MAPK cascade (M3_K2_USEQ)."""

    def __init__(self, model_path: str = "data/MODEL1204280019.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Sarma2012InteractionTopologiesOfMapkCascadeModel1204280019Model = SbmlSarma2012InteractionTopologiesOfMapkCascadeM3K2Useq2

...
"""Auto-generated SBML BioModule wrapper for Bray1993_chemotaxis.

Source: biomodels_ebi:BIOMD0000000404
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000404
"""
...
class SbmlBray1993Chemotaxis(biosim.BioModule):
    """BioModule wrapper for SBML model: Bray1993_chemotaxis."""

    def __init__(self, model_path: str = "data/BIOMD0000000404.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Bray1993ChemotaxisBiomd0000000404Model = SbmlBray1993Chemotaxis

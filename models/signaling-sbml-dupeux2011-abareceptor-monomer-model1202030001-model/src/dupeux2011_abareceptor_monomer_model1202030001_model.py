...
"""Auto-generated SBML BioModule wrapper for Dupeux2011_ABAreceptor_Monomer.

Source: biomodels_ebi:MODEL1202030001
Original: https://www.ebi.ac.uk/biomodels/MODEL1202030001
"""
...
class SbmlDupeux2011AbareceptorMonomer(biosim.BioModule):
    """BioModule wrapper for SBML model: Dupeux2011_ABAreceptor_Monomer."""

    def __init__(self, model_path: str = "data/MODEL1202030001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Dupeux2011AbareceptorMonomerModel1202030001Model = SbmlDupeux2011AbareceptorMonomer

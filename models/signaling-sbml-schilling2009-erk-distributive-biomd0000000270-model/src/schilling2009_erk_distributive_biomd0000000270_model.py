...
"""Auto-generated SBML BioModule wrapper for Schilling2009 - ERK distributive.

Source: biomodels_ebi:BIOMD0000000270
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000270
"""
...
class SbmlSchilling2009ErkDistributive(biosim.BioModule):
    """BioModule wrapper for SBML model: Schilling2009 - ERK distributive."""

    def __init__(self, model_path: str = "data/BIOMD0000000270.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Schilling2009ErkDistributiveBiomd0000000270Model = SbmlSchilling2009ErkDistributive

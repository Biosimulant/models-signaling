...
"""Auto-generated SBML BioModule wrapper for Kessler2025 - IL-6 and IL-22 pathway in human hepatocytes.

Source: biomodels_ebi:MODEL2509100001
Original: https://www.ebi.ac.uk/biomodels/MODEL2509100001
"""
...
class SbmlKessler2025Il6AndIl22PathwayInHumanHepatocytes(biosim.BioModule):
    """BioModule wrapper for SBML model: Kessler2025 - IL-6 and IL-22 pathway in human hepatocytes."""

    def __init__(self, model_path: str = "data/MODEL2509100001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Kessler2025Il6AndIl22PathwayInHumanHepaModel2509100001Model = SbmlKessler2025Il6AndIl22PathwayInHumanHepatocytes

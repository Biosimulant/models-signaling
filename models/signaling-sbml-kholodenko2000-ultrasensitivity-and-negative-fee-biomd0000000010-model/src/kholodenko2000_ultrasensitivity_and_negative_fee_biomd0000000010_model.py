...
"""Auto-generated SBML BioModule wrapper for Kholodenko2000 - Ultrasensitivity and negative feedback bring oscillations in MAPK cascade.

Source: biomodels_ebi:BIOMD0000000010
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000010
"""
...
class SbmlKholodenko2000UltrasensitivityAndNegativeFeedbackBring(biosim.BioModule):
    """BioModule wrapper for SBML model: Kholodenko2000 - Ultrasensitivity and negative feedback bring oscillations in MAPK cascade."""

    def __init__(self, model_path: str = "data/BIOMD0000000010.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Kholodenko2000UltrasensitivityAndNegativeFeeBiomd0000000010Model = SbmlKholodenko2000UltrasensitivityAndNegativeFeedbackBring

...
"""Auto-generated SBML BioModule wrapper for Panteleev2002_TFPImechanism_schmema2.

Source: biomodels_ebi:BIOMD0000000360
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000360
"""
...
class SbmlPanteleev2002TfpimechanismSchmema2(biosim.BioModule):
    """BioModule wrapper for SBML model: Panteleev2002_TFPImechanism_schmema2."""

    def __init__(self, model_path: str = "data/BIOMD0000000360.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Panteleev2002TfpimechanismSchmema2Biomd0000000360Model = SbmlPanteleev2002TfpimechanismSchmema2

...
"""Auto-generated SBML BioModule wrapper for Yapo2017 - A2AR/cAMP/PKA signalling in D2 dopamine receptor expressing medium-spiny neurons.

Source: biomodels_ebi:MODEL1701170001
Original: https://www.ebi.ac.uk/biomodels/MODEL1701170001
"""
...
class SbmlYapo2017A2arCampPkaSignallingInD2DopamineReceptor(biosim.BioModule):
    """BioModule wrapper for SBML model: Yapo2017 - A2AR/cAMP/PKA signalling in D2 dopamine receptor expressing medium-spiny neurons."""

    def __init__(self, model_path: str = "data/MODEL1701170001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Yapo2017A2arCampPkaSignallingInD2DopamineModel1701170001Model = SbmlYapo2017A2arCampPkaSignallingInD2DopamineReceptor

...
"""Tellurium-backed SBML wrapper for Strasen2018 - TGFb SMAD Signalling - Degradation of 25pM ligand (TGFb)."""
...
class Strasen2018TgfbSmadSignallingDegradationOfModel(TelluriumSBMLBioModule):
    """Faithful Tellurium execution of the bundled SBML source model."""

    _SBML_ID = 'BIOMD0000000990'
    _TITLE = 'Strasen2018 - TGFb SMAD Signalling - Degradation of 25pM ligand (TGFb)'
    ...
    def __init__(self, model_path: str = 'data/BIOMD0000000990.xml', integration_step: float = 0.01) -> None:
        super().__init__(model_path=model_path, integration_step=integration_step)


Strasen2018TgfbSmadSignallingDegradationOfBiomd0000000990Model = Strasen2018TgfbSmadSignallingDegradationOfModel

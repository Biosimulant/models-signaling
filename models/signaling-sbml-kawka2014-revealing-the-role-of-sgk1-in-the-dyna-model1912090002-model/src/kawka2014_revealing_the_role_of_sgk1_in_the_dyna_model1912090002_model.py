...
"""Auto-generated SBML BioModule wrapper for Kawka2014 - Revealing the role of SGK1 in the dynamics of medulloblastoma using a mathematical model.

Source: biomodels_ebi:MODEL1912090002
Original: https://www.ebi.ac.uk/biomodels/MODEL1912090002
"""
...
class SbmlKawka2014RevealingTheRoleOfSgk1InTheDynamicsOf(biosim.BioModule):
    """BioModule wrapper for SBML model: Kawka2014 - Revealing the role of SGK1 in the dynamics of medulloblastoma using a mathematical model."""

    def __init__(self, model_path: str = "data/MODEL1912090002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Kawka2014RevealingTheRoleOfSgk1InTheDynaModel1912090002Model = SbmlKawka2014RevealingTheRoleOfSgk1InTheDynamicsOf

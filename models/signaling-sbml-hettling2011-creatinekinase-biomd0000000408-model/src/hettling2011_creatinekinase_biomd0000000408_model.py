...
"""Auto-generated SBML BioModule wrapper for Hettling2011_CreatineKinase.

Source: biomodels_ebi:BIOMD0000000408
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000408
"""
...
class SbmlHettling2011Creatinekinase(biosim.BioModule):
    """BioModule wrapper for SBML model: Hettling2011_CreatineKinase."""

    def __init__(self, model_path: str = "data/BIOMD0000000408.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Hettling2011CreatinekinaseBiomd0000000408Model = SbmlHettling2011Creatinekinase

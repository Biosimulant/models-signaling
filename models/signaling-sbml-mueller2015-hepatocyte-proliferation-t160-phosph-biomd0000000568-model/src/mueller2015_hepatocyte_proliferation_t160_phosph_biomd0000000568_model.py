...
"""Auto-generated SBML BioModule wrapper for Mueller2015 - Hepatocyte proliferation, T160 phosphorylation of CDK2.

Source: biomodels_ebi:BIOMD0000000568
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000568
"""
...
class SbmlMueller2015HepatocyteProliferationT160Phosphorylation(biosim.BioModule):
    """BioModule wrapper for SBML model: Mueller2015 - Hepatocyte proliferation, T160 phosphorylation of CDK2."""

    def __init__(self, model_path: str = "data/BIOMD0000000568.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Mueller2015HepatocyteProliferationT160PhosphBiomd0000000568Model = SbmlMueller2015HepatocyteProliferationT160Phosphorylation

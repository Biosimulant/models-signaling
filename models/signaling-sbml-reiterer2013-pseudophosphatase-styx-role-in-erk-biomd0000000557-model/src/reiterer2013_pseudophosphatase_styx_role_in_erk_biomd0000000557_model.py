...
"""Auto-generated SBML BioModule wrapper for Reiterer2013 - pseudophosphatase STYX role in ERK signalling.

Source: biomodels_ebi:BIOMD0000000557
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000557
"""
...
class SbmlReiterer2013PseudophosphataseStyxRoleInErkSignalling(biosim.BioModule):
    """BioModule wrapper for SBML model: Reiterer2013 - pseudophosphatase STYX role in ERK signalling."""

    def __init__(self, model_path: str = "data/BIOMD0000000557.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Reiterer2013PseudophosphataseStyxRoleInErkBiomd0000000557Model = SbmlReiterer2013PseudophosphataseStyxRoleInErkSignalling

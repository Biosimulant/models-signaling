...
"""Auto-generated SBML BioModule wrapper for DallePezze2012 - TSC-independent mTORC2 regulation.

Source: biomodels_ebi:BIOMD0000000581
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000581
"""
...
class SbmlDallepezze2012TscIndependentMtorc2Regulation(biosim.BioModule):
    """BioModule wrapper for SBML model: DallePezze2012 - TSC-independent mTORC2 regulation."""

    def __init__(self, model_path: str = "data/BIOMD0000000581.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Dallepezze2012TscIndependentMtorc2RegulationBiomd0000000581Model = SbmlDallepezze2012TscIndependentMtorc2Regulation

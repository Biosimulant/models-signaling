...
"""Auto-generated SBML BioModule wrapper for Tiwari2019 - Mathematical model of NFKB regulatory module with TNF and ROS.

Source: biomodels_ebi:MODEL1911140002
Original: https://www.ebi.ac.uk/biomodels/MODEL1911140002
"""
...
class SbmlTiwari2019MathematicalModelOfNfkbRegulatoryModule(biosim.BioModule):
    """BioModule wrapper for SBML model: Tiwari2019 - Mathematical model of NFKB regulatory module with TNF and ROS."""

    def __init__(self, model_path: str = "data/MODEL1911140002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Tiwari2019MathematicalModelOfNfkbRegulatoryModel1911140002Model = SbmlTiwari2019MathematicalModelOfNfkbRegulatoryModule

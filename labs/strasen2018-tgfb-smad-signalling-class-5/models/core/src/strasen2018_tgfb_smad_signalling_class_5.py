...
"""Tellurium-backed SBML wrapper for Strasen2018 - TGFb SMAD Signalling Class 5."""
...
class Strasen2018TgfbSmadSignallingClass5Model(TelluriumSBMLBioModule):
    """Faithful Tellurium execution of the bundled SBML source model."""

    _SBML_ID = 'BIOMD0000001002'
    _TITLE = 'Strasen2018 - TGFb SMAD Signalling Class 5'
    ...
    def __init__(self, model_path: str = 'data/BIOMD0000001002.xml', integration_step: float = 0.01) -> None:
        super().__init__(model_path=model_path, integration_step=integration_step)


Strasen2018TgfbSmadSignallingClass5Biomd0000001002Model = Strasen2018TgfbSmadSignallingClass5Model

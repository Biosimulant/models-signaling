...
"""Auto-generated SBML BioModule wrapper for A model of yeast cell-cycle regulation based on multisite phosphorylation_1_1_1.

Source: biomodels_ebi:MODEL1812060001
Original: https://www.ebi.ac.uk/biomodels/MODEL1812060001
"""
...
class SbmlAModelOfYeastCellCycleRegulationBasedOnMultisite(biosim.BioModule):
    """BioModule wrapper for SBML model: A model of yeast cell-cycle regulation based on multisite phosphorylation_1_1_1."""

    def __init__(self, model_path: str = "data/MODEL1812060001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
AModelOfYeastCellCycleRegulationBasedOnModel1812060001Model = SbmlAModelOfYeastCellCycleRegulationBasedOnMultisite

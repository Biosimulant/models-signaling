...
"""Auto-generated SBML BioModule wrapper for Singh2023 - Human rheumatoid arthritis synovial fibroblast signaling model.

Source: biomodels_ebi:MODEL2307190001
Original: https://www.ebi.ac.uk/biomodels/MODEL2307190001
"""
...
class SbmlSingh2023HumanRheumatoidArthritisSynovialFibroblast(biosim.BioModule):
    """BioModule wrapper for SBML model: Singh2023 - Human rheumatoid arthritis synovial fibroblast signaling model."""

    def __init__(self, model_path: str = "data/MODEL2307190001.sbml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Singh2023HumanRheumatoidArthritisSynovialFiModel2307190001Model = SbmlSingh2023HumanRheumatoidArthritisSynovialFibroblast

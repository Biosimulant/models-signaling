...
"""Auto-generated SBML BioModule wrapper for Araujo2016 - Positive feedback in Cdk1 signalling keeps mitotic duration short and constant.

Source: biomodels_ebi:BIOMD0000000657
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000657
"""
...
class SbmlAraujo2016PositiveFeedbackInCdk1SignallingKeeps(biosim.BioModule):
    """BioModule wrapper for SBML model: Araujo2016 - Positive feedback in Cdk1 signalling keeps mitotic duration short and constant."""

    def __init__(self, model_path: str = "data/BIOMD0000000657.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Araujo2016PositiveFeedbackInCdk1SignallingBiomd0000000657Model = SbmlAraujo2016PositiveFeedbackInCdk1SignallingKeeps

...
"""Auto-generated SBML BioModule wrapper for Martinez-Guimera2017 - Generic redox signalling model with negative feedforward regulation (Model 3).

Source: biomodels_ebi:MODEL1710260002
Original: https://www.ebi.ac.uk/biomodels/MODEL1710260002
"""
...
class SbmlMartinezGuimera2017GenericRedoxSignallingModelWith2(biosim.BioModule):
    """BioModule wrapper for SBML model: Martinez-Guimera2017 - Generic redox signalling model with negative feedforward regulation (Model 3)."""

    def __init__(self, model_path: str = "data/MODEL1710260002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
MartinezGuimera2017GenericRedoxSignallingMoModel1710260002Model = SbmlMartinezGuimera2017GenericRedoxSignallingModelWith2

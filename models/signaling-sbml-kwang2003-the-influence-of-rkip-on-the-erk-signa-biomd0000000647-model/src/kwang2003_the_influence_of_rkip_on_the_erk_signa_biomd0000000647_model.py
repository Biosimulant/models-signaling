...
"""Auto-generated SBML BioModule wrapper for Kwang2003 - The influence of RKIP on the ERK signaling pathway.

Source: biomodels_ebi:BIOMD0000000647
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000647
"""
...
class SbmlKwang2003TheInfluenceOfRkipOnTheErkSignalingPathway(biosim.BioModule):
    """BioModule wrapper for SBML model: Kwang2003 - The influence of RKIP on the ERK signaling pathway."""

    def __init__(self, model_path: str = "data/BIOMD0000000647.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Kwang2003TheInfluenceOfRkipOnTheErkSignaBiomd0000000647Model = SbmlKwang2003TheInfluenceOfRkipOnTheErkSignalingPathway

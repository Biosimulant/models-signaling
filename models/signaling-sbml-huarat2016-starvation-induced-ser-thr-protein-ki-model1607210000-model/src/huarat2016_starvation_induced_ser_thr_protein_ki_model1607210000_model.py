...
"""Auto-generated SBML BioModule wrapper for Huarat2016 -Starvation-induced Ser/Thr protein kinase ArnS (Saci_1181) (Model 14).

Source: biomodels_ebi:MODEL1607210000
Original: https://www.ebi.ac.uk/biomodels/MODEL1607210000
"""
...
class SbmlHuarat2016StarvationInducedSerThrProteinKinaseArns(biosim.BioModule):
    """BioModule wrapper for SBML model: Huarat2016 -Starvation-induced Ser/Thr protein kinase ArnS (Saci_1181) (Model 14)."""

    def __init__(self, model_path: str = "data/MODEL1607210000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Huarat2016StarvationInducedSerThrProteinKiModel1607210000Model = SbmlHuarat2016StarvationInducedSerThrProteinKinaseArns

...
Source: biomodels_ebi:MODEL2003060002
Original: https://www.ebi.ac.uk/biomodels/MODEL2003060002
"""
...
class SbmlGrigolon2018ResponsesToAuxinSignals(biosim.BioModule):
    """BioModule wrapper for SBML model: Grigolon2018 - Responses to auxin signals."""

    def __init__(self, model_path: str = "data/MODEL2003060002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Grigolon2018ResponsesToAuxinSignalsModel2003060002Model = SbmlGrigolon2018ResponsesToAuxinSignals

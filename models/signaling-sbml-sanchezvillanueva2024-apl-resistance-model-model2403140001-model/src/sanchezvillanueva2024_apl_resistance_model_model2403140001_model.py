...
"""Auto-generated SBML BioModule wrapper for SanchezVillanueva2024 - APL resistance model.

Source: biomodels_ebi:MODEL2403140001
Original: https://www.ebi.ac.uk/biomodels/MODEL2403140001
"""
...
class SbmlSanchezvillanueva2024AplResistanceModel(biosim.BioModule):
    """BioModule wrapper for SBML model: SanchezVillanueva2024 - APL resistance model."""

    def __init__(self, model_path: str = "data/MODEL2403140001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Sanchezvillanueva2024AplResistanceModelModel2403140001Model = SbmlSanchezvillanueva2024AplResistanceModel

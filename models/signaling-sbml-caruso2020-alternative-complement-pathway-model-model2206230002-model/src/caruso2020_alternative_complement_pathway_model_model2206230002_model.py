...
"""Auto-generated SBML BioModule wrapper for Caruso2020 - Alternative Complement Pathway model.

Source: biomodels_ebi:MODEL2206230002
Original: https://www.ebi.ac.uk/biomodels/MODEL2206230002
"""
...
class SbmlCaruso2020AlternativeComplementPathwayModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Caruso2020 - Alternative Complement Pathway model."""

    def __init__(self, model_path: str = "data/MODEL2206230002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Caruso2020AlternativeComplementPathwayModelModel2206230002Model = SbmlCaruso2020AlternativeComplementPathwayModel

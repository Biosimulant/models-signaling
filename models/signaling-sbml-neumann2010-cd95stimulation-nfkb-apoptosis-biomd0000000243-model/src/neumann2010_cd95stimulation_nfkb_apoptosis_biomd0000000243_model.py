...
"""Auto-generated SBML BioModule wrapper for Neumann2010_CD95Stimulation_NFkB_Apoptosis.

Source: biomodels_ebi:BIOMD0000000243
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000243
"""
...
class SbmlNeumann2010Cd95stimulationNfkbApoptosis(biosim.BioModule):
    """BioModule wrapper for SBML model: Neumann2010_CD95Stimulation_NFkB_Apoptosis."""

    def __init__(self, model_path: str = "data/BIOMD0000000243.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Neumann2010Cd95stimulationNfkbApoptosisBiomd0000000243Model = SbmlNeumann2010Cd95stimulationNfkbApoptosis

...
"""Tellurium-backed SBML wrapper for Smallbone2015 - forced pathway."""
...
class Smallbone2015ForcedPathwayModel(TelluriumSBMLBioModule):
    """Faithful Tellurium execution of the bundled SBML source model."""

    _SBML_ID = 'MODEL1503180004'
    _TITLE = 'Smallbone2015 - forced pathway'
    ...
    def __init__(self, model_path: str = 'data/MODEL1503180004.xml', integration_step: float = 0.01) -> None:
        super().__init__(model_path=model_path, integration_step=integration_step)


Smallbone2015ForcedPathwayModel1503180004Model = Smallbone2015ForcedPathwayModel

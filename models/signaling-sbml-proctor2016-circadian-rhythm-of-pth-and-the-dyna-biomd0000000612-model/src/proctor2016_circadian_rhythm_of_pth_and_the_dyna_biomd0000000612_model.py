...
"""Auto-generated SBML BioModule wrapper for Proctor2016 - Circadian rhythm of PTH and the dynamics of signaling molecules on bone remodeling.

Source: biomodels_ebi:BIOMD0000000612
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000612
"""
...
class SbmlProctor2016CircadianRhythmOfPthAndTheDynamicsOf(biosim.BioModule):
    """BioModule wrapper for SBML model: Proctor2016 - Circadian rhythm of PTH and the dynamics of signaling molecules on bone remodeling."""

    def __init__(self, model_path: str = "data/BIOMD0000000612.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Proctor2016CircadianRhythmOfPthAndTheDynaBiomd0000000612Model = SbmlProctor2016CircadianRhythmOfPthAndTheDynamicsOf

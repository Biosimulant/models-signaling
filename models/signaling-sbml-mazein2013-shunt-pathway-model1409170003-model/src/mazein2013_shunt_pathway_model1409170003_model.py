...
"""Auto-generated SBML BioModule wrapper for Mazein2013 - Shunt pathway.

Source: biomodels_ebi:MODEL1409170003
Original: https://www.ebi.ac.uk/biomodels/MODEL1409170003
"""
...
class SbmlMazein2013ShuntPathway(biosim.BioModule):
    """BioModule wrapper for SBML model: Mazein2013 - Shunt pathway."""

    def __init__(self, model_path: str = "data/MODEL1409170003.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Mazein2013ShuntPathwayModel1409170003Model = SbmlMazein2013ShuntPathway

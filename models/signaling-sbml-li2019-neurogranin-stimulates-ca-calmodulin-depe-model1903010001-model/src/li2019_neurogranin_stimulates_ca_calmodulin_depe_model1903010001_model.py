...
"""Auto-generated SBML BioModule wrapper for Li2019 - Neurogranin stimulates Ca/calmodulin-dependent kinase II by inhibiting Calcineurin.

Source: biomodels_ebi:MODEL1903010001
Original: https://www.ebi.ac.uk/biomodels/MODEL1903010001
"""
...
class SbmlLi2019NeurograninStimulatesCaCalmodulinDependent(biosim.BioModule):
    """BioModule wrapper for SBML model: Li2019 - Neurogranin stimulates Ca/calmodulin-dependent kinase II by inhibiting Calcineurin."""

    def __init__(self, model_path: str = "data/MODEL1903010001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Li2019NeurograninStimulatesCaCalmodulinDepeModel1903010001Model = SbmlLi2019NeurograninStimulatesCaCalmodulinDependent

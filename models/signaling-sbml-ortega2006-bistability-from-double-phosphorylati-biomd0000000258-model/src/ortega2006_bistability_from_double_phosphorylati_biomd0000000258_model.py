...
"""Auto-generated SBML BioModule wrapper for Ortega2006 - bistability from double phosphorylation in signal transduction.

Source: biomodels_ebi:BIOMD0000000258
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000258
"""
...
class SbmlOrtega2006BistabilityFromDoublePhosphorylationIn(biosim.BioModule):
    """BioModule wrapper for SBML model: Ortega2006 - bistability from double phosphorylation in signal transduction."""

    def __init__(self, model_path: str = "data/BIOMD0000000258.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Ortega2006BistabilityFromDoublePhosphorylatiBiomd0000000258Model = SbmlOrtega2006BistabilityFromDoublePhosphorylationIn

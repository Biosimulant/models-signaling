...
"""Tellurium-backed SBML wrapper for Brännmark2013 - Insulin signalling in human adipocytes (normal condition)."""
...
class BrNnmark2013InsulinSignallingInHumanAdipocModel(TelluriumSBMLBioModule):
    """Faithful Tellurium execution of the bundled SBML source model."""

    _SBML_ID = 'BIOMD0000000448'
    _TITLE = 'Brännmark2013 - Insulin signalling in human adipocytes (normal condition)'
    ...
    def __init__(self, model_path: str = 'data/BIOMD0000000448.xml', integration_step: float = 0.01) -> None:
        super().__init__(model_path=model_path, integration_step=integration_step)


BrNnmark2013InsulinSignallingInHumanAdipocBiomd0000000448Model = BrNnmark2013InsulinSignallingInHumanAdipocModel

...
"""Tellurium-backed SBML wrapper for Sarma2012 - Oscillations in MAPK cascade (S2), inclusion of external signalling module."""
...
class Sarma2012OscillationsInMapkCascadeS2InclusModel(TelluriumSBMLBioModule):
    """Faithful Tellurium execution of the bundled SBML source model."""

    _SBML_ID = 'BIOMD0000000442'
    _TITLE = 'Sarma2012 - Oscillations in MAPK cascade (S2), inclusion of external signalling module'
    ...
    _SPECIES_LABELS = {'species_0': 'MAPK kinase kinase',
     ...
     'species_11': 'response node X',
     'species_12': 'phosphorylated response node X'}
    _STATE_OUTPUT_ALIASES = {'species_0': 'mapk_kinase_kinase',
     ...
     'species_11': 'response_node_x',
     'species_12': 'phosphorylated_response_node_x'}

    def __init__(self, model_path: str = 'data/BIOMD0000000442.xml', integration_step: float = 0.01) -> None:
        super().__init__(model_path=model_path, integration_step=integration_step)


Sarma2012OscillationsInMapkCascadeS2InclusBiomd0000000442Model = Sarma2012OscillationsInMapkCascadeS2InclusModel

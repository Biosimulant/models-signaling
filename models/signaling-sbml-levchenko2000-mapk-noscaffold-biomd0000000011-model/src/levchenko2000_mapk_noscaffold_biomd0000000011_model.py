...
"""Auto-generated SBML BioModule wrapper for Levchenko2000_MAPK_noScaffold.

Source: biomodels_ebi:BIOMD0000000011
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000011
"""
...
class SbmlLevchenko2000MapkNoscaffold(biosim.BioModule):
    """BioModule wrapper for SBML model: Levchenko2000_MAPK_noScaffold."""

    def __init__(self, model_path: str = "data/BIOMD0000000011.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Levchenko2000MapkNoscaffoldBiomd0000000011Model = SbmlLevchenko2000MapkNoscaffold

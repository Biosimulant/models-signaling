...
"""Auto-generated SBML BioModule wrapper for Regan2022 - Mechanosensitive EMT model.

Source: biomodels_ebi:MODEL2208050001
Original: https://www.ebi.ac.uk/biomodels/MODEL2208050001
"""
...
class SbmlRegan2022MechanosensitiveEmtModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Regan2022 - Mechanosensitive EMT model."""

    def __init__(self, model_path: str = "data/MODEL2208050001.sbml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Regan2022MechanosensitiveEmtModelModel2208050001Model = SbmlRegan2022MechanosensitiveEmtModel

...
"""Auto-generated SBML BioModule wrapper for Schaber2006_Pheromone_Starvation_Crosstalk.

Source: biomodels_ebi:BIOMD0000000237
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000237
"""
...
class SbmlSchaber2006PheromoneStarvationCrosstalk(biosim.BioModule):
    """BioModule wrapper for SBML model: Schaber2006_Pheromone_Starvation_Crosstalk."""

    def __init__(self, model_path: str = "data/BIOMD0000000237.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Schaber2006PheromoneStarvationCrosstalkBiomd0000000237Model = SbmlSchaber2006PheromoneStarvationCrosstalk

...
"""Auto-generated SBML BioModule wrapper for Mosbacher2022 - Yeast HOG pathway.

Source: biomodels_ebi:MODEL2206230001
Original: https://www.ebi.ac.uk/biomodels/MODEL2206230001
"""
...
class SbmlMosbacher2022YeastHogPathway(biosim.BioModule):
    """BioModule wrapper for SBML model: Mosbacher2022 - Yeast HOG pathway."""

    def __init__(self, model_path: str = "data/MODEL2206230001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Mosbacher2022YeastHogPathwayModel2206230001Model = SbmlMosbacher2022YeastHogPathway

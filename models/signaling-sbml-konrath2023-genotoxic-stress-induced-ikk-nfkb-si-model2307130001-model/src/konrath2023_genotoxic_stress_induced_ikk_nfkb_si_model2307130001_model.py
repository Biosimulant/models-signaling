...
"""Auto-generated SBML BioModule wrapper for Konrath2023_genotoxic_stress_induced_IKK_NFkB_signaling.

Source: biomodels_ebi:MODEL2307130001
Original: https://www.ebi.ac.uk/biomodels/MODEL2307130001
"""
...
class SbmlKonrath2023GenotoxicStressInducedIkkNfkbSignaling(biosim.BioModule):
    """BioModule wrapper for SBML model: Konrath2023_genotoxic_stress_induced_IKK_NFkB_signaling."""

    def __init__(self, model_path: str = "data/MODEL2307130001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Konrath2023GenotoxicStressInducedIkkNfkbSiModel2307130001Model = SbmlKonrath2023GenotoxicStressInducedIkkNfkbSignaling

...
"""Auto-generated SBML BioModule wrapper for Cacace2020 - Logical model of the regulatory network controlling T cell commitment.

Source: biomodels_ebi:MODEL2002170001
Original: https://www.ebi.ac.uk/biomodels/MODEL2002170001
"""
...
class SbmlCacace2020LogicalModelOfTheRegulatoryNetwork(biosim.BioModule):
    """BioModule wrapper for SBML model: Cacace2020 - Logical model of the regulatory network controlling T cell commitment."""

    def __init__(self, model_path: str = "data/MODEL2002170001.sbml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Cacace2020LogicalModelOfTheRegulatoryNetwoModel2002170001Model = SbmlCacace2020LogicalModelOfTheRegulatoryNetwork

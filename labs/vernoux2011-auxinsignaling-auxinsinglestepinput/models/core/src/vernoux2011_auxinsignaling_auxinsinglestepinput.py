...
"""Tellurium-backed SBML wrapper for Vernoux2011_AuxinSignaling_AuxinSingleStepInput."""
...
class Vernoux2011AuxinsignalingAuxinsinglestepinputModel(TelluriumSBMLBioModule):
    """Faithful Tellurium execution of the bundled SBML source model."""

    _SBML_ID = 'BIOMD0000000351'
    _TITLE = 'Vernoux2011_AuxinSignaling_AuxinSingleStepInput'
    ...
    def __init__(self, model_path: str = 'data/BIOMD0000000351.xml', integration_step: float = 0.01) -> None:
        super().__init__(model_path=model_path, integration_step=integration_step)


Vernoux2011AuxinsignalingAuxinsinglestepinputBiomd0000000351Model = Vernoux2011AuxinsignalingAuxinsinglestepinputModel

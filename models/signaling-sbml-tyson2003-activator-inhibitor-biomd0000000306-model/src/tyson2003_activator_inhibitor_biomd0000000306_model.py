...
"""Auto-generated SBML BioModule wrapper for Tyson2003_Activator_Inhibitor.

Source: biomodels_ebi:BIOMD0000000306
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000306
"""
...
class SbmlTyson2003ActivatorInhibitor(biosim.BioModule):
    """BioModule wrapper for SBML model: Tyson2003_Activator_Inhibitor."""

    def __init__(self, model_path: str = "data/BIOMD0000000306.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Tyson2003ActivatorInhibitorBiomd0000000306Model = SbmlTyson2003ActivatorInhibitor

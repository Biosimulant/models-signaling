...
"""Auto-generated SBML BioModule wrapper for Capuani2015 - Binding of Cbl and Gbr2 to EGFR (Multisite Phosphorylation Model - MPM).

Source: biomodels_ebi:BIOMD0000000594
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000594
"""
...
class SbmlCapuani2015BindingOfCblAndGbr2ToEgfrMultisite(biosim.BioModule):
    """BioModule wrapper for SBML model: Capuani2015 - Binding of Cbl and Gbr2 to EGFR (Multisite Phosphorylation Model - MPM)."""

    def __init__(self, model_path: str = "data/BIOMD0000000594.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Capuani2015BindingOfCblAndGbr2ToEgfrMultBiomd0000000594Model = SbmlCapuani2015BindingOfCblAndGbr2ToEgfrMultisite

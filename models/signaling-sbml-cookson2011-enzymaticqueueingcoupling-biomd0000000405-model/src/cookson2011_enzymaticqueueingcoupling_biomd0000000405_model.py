...
"""Auto-generated SBML BioModule wrapper for Cookson2011_EnzymaticQueueingCoupling.

Source: biomodels_ebi:BIOMD0000000405
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000405
"""
...
class SbmlCookson2011Enzymaticqueueingcoupling(biosim.BioModule):
    """BioModule wrapper for SBML model: Cookson2011_EnzymaticQueueingCoupling."""

    def __init__(self, model_path: str = "data/BIOMD0000000405.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Cookson2011EnzymaticqueueingcouplingBiomd0000000405Model = SbmlCookson2011Enzymaticqueueingcoupling

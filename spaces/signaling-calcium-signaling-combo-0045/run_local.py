#!/usr/bin/env python3
"""Run generated space: signaling-calcium-signaling-combo-0045."""
...
def _repo_root_map(current_repo_root: Path) -> dict[str, Path]:
    ...
    return {
        "Biosimulant/models-signaling": current_repo_root.resolve(),
...
def main() -> None:
    ...
    print(f"Completed {space.get('title', 'signaling-calcium-signaling-combo-0045')} duration={duration} tick_dt={tick_dt}")

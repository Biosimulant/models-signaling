...
"""Tellurium-backed SBML wrapper for Sarma2012 - Interaction topologies of MAPK cascade (M3_K1_PSEQ_short_duration_signal)."""
...
class Sarma2012InteractionTopologiesOfMapkCascadeModel1204280015Model(TelluriumSBMLBioModule):
    """Faithful Tellurium execution of the bundled SBML source model."""

    _SBML_ID = 'MODEL1204280015'
    _TITLE = 'Sarma2012 - Interaction topologies of MAPK cascade (M3_K1_PSEQ_short_duration_signal)'
    ...
    _SPECIES_LABELS = {'species_1': 'MAPK kinase kinase',
     ...
     'species_11': 'source-defined SIG state'}
    _STATE_OUTPUT_ALIASES = {'species_1': 'mapk_kinase_kinase',
     ...
     'species_11': 'source_defined_sig_state'}

    def __init__(self, model_path: str = 'data/MODEL1204280015.xml', integration_step: float = 0.01) -> None:
        super().__init__(model_path=model_path, integration_step=integration_step)


Sarma2012InteractionTopologiesOfMapkCascadeModel1204280015Model = Sarma2012InteractionTopologiesOfMapkCascadeModel1204280015Model

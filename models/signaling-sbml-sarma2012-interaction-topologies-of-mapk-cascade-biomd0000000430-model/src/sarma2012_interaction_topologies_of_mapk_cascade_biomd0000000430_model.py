...
"""Auto-generated SBML BioModule wrapper for Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_USEQ).

Source: biomodels_ebi:BIOMD0000000430
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000430
"""
...
class SbmlSarma2012InteractionTopologiesOfMapkCascadeM4K2Useq(biosim.BioModule):
    """BioModule wrapper for SBML model: Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_USEQ)."""

    def __init__(self, model_path: str = "data/BIOMD0000000430.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Sarma2012InteractionTopologiesOfMapkCascadeBiomd0000000430Model = SbmlSarma2012InteractionTopologiesOfMapkCascadeM4K2Useq

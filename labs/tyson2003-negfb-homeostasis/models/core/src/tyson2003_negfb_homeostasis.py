...
"""Tellurium-backed SBML wrapper for Tyson2003_NegFB_Homeostasis."""
...
class Tyson2003NegfbHomeostasisModel(TelluriumSBMLBioModule):
    """Faithful Tellurium execution of the bundled SBML source model."""

    _SBML_ID = 'BIOMD0000000309'
    _TITLE = 'Tyson2003_NegFB_Homeostasis'
    ...
    def __init__(self, model_path: str = 'data/BIOMD0000000309.xml', integration_step: float = 0.01) -> None:
        super().__init__(model_path=model_path, integration_step=integration_step)


Tyson2003NegfbHomeostasisBiomd0000000309Model = Tyson2003NegfbHomeostasisModel

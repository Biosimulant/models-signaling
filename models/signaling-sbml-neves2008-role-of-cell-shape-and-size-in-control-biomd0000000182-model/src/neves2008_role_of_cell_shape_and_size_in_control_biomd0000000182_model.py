...
"""Auto-generated SBML BioModule wrapper for Neves2008 - Role of cell shape and size in controlling intracellular signalling.

Source: biomodels_ebi:BIOMD0000000182
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000182
"""
...
class SbmlNeves2008RoleOfCellShapeAndSizeInControlling(biosim.BioModule):
    """BioModule wrapper for SBML model: Neves2008 - Role of cell shape and size in controlling intracellular signalling."""

    def __init__(self, model_path: str = "data/BIOMD0000000182.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Neves2008RoleOfCellShapeAndSizeInControlBiomd0000000182Model = SbmlNeves2008RoleOfCellShapeAndSizeInControlling

...
"""Auto-generated SBML BioModule wrapper for Hornberg2005 - MAPKsignalling.

Source: biomodels_ebi:BIOMD0000000667
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000667
"""
...
class SbmlHornberg2005Mapksignalling(biosim.BioModule):
    """BioModule wrapper for SBML model: Hornberg2005 - MAPKsignalling."""

    def __init__(self, model_path: str = "data/BIOMD0000000667.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Hornberg2005MapksignallingBiomd0000000667Model = SbmlHornberg2005Mapksignalling

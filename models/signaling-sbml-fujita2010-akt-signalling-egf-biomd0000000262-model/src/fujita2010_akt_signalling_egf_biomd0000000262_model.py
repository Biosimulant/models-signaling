...
"""Auto-generated SBML BioModule wrapper for Fujita2010_Akt_Signalling_EGF.

Source: biomodels_ebi:BIOMD0000000262
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000262
"""
...
class SbmlFujita2010AktSignallingEgf(biosim.BioModule):
    """BioModule wrapper for SBML model: Fujita2010_Akt_Signalling_EGF."""

    def __init__(self, model_path: str = "data/BIOMD0000000262.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Fujita2010AktSignallingEgfBiomd0000000262Model = SbmlFujita2010AktSignallingEgf

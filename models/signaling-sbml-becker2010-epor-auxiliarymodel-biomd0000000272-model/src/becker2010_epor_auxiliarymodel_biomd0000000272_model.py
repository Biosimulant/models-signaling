...
"""Auto-generated SBML BioModule wrapper for Becker2010_EpoR_AuxiliaryModel.

Source: biomodels_ebi:BIOMD0000000272
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000272
"""
...
class SbmlBecker2010EporAuxiliarymodel(biosim.BioModule):
    """BioModule wrapper for SBML model: Becker2010_EpoR_AuxiliaryModel."""

    def __init__(self, model_path: str = "data/BIOMD0000000272.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Becker2010EporAuxiliarymodelBiomd0000000272Model = SbmlBecker2010EporAuxiliarymodel

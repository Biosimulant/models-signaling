...
"""Tellurium-backed SBML wrapper for Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_PSEQ_short_duration_signal)."""
...
class Sarma2012InteractionTopologiesOfMapkCascadeModel1204280032Model(TelluriumSBMLBioModule):
    """Faithful Tellurium execution of the bundled SBML source model."""

    _SBML_ID = 'MODEL1204280032'
    _TITLE = 'Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_PSEQ_short_duration_signal)'
    ...
    _SPECIES_LABELS = {'species_1': 'MAP kinase',
     ...
     'species_14': 'MAPK kinase P P2',
     'species_15': 'source-defined MKK_P2 state',
     'species_16': 'MAPK kinase kinase',
     'species_17': 'MAPK kinase kinase Sig',
     'species_18': 'source-defined SIG state',
     'species_19': 'MAPK kinase kinase P P1',
     'species_20': 'source-defined P1 state',
     'species_21': 'MAP kinase PP P2',
     'species_22': 'source-defined MK-P_P2 state',
     'species_23': 'source-defined MK_P2 state',
     'species_24': 'MAPK kinase PP P1',
     'species_25': 'MAPK kinase P P1',
     'species_26': 'source-defined MKK_P1 state',
     'species_27': 'MAPK kinase kinase P1'}
    _STATE_OUTPUT_ALIASES = {'species_1': 'map_kinase',
     ...
     'species_14': 'mapk_kinase_p_p2',
     'species_15': 'source_defined_mkk_p2_state',
     'species_16': 'mapk_kinase_kinase',
     'species_17': 'mapk_kinase_kinase_sig',
     'species_18': 'source_defined_sig_state',
     'species_19': 'mapk_kinase_kinase_p_p1',
     'species_20': 'source_defined_p1_state',
     'species_21': 'map_kinase_pp_p2',
     'species_22': 'source_defined_mk_p_p2_state',
     'species_23': 'source_defined_mk_p2_state',
     'species_24': 'mapk_kinase_pp_p1',
     'species_25': 'mapk_kinase_p_p1',
     'species_26': 'source_defined_mkk_p1_state',
     'species_27': 'mapk_kinase_kinase_p1'}

    def __init__(self, model_path: str = 'data/MODEL1204280032.xml', integration_step: float = 0.01) -> None:
        super().__init__(model_path=model_path, integration_step=integration_step)


Sarma2012InteractionTopologiesOfMapkCascadeModel1204280032Model = Sarma2012InteractionTopologiesOfMapkCascadeModel1204280032Model

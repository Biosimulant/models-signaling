...
"""Auto-generated SBML BioModule wrapper for Amara2013 - PCNA ubiquitylation in the activation of PRR pathway.

Source: biomodels_ebi:BIOMD0000000475
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000475
"""
...
class SbmlAmara2013PcnaUbiquitylationInTheActivationOfPrr(biosim.BioModule):
    """BioModule wrapper for SBML model: Amara2013 - PCNA ubiquitylation in the activation of PRR pathway."""

    def __init__(self, model_path: str = "data/BIOMD0000000475.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Amara2013PcnaUbiquitylationInTheActivationBiomd0000000475Model = SbmlAmara2013PcnaUbiquitylationInTheActivationOfPrr

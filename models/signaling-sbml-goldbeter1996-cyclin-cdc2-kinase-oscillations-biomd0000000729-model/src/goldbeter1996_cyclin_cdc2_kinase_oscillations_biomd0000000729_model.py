...
"""Auto-generated SBML BioModule wrapper for Goldbeter1996 - Cyclin Cdc2 kinase Oscillations.

Source: biomodels_ebi:BIOMD0000000729
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000729
"""
...
class SbmlGoldbeter1996CyclinCdc2KinaseOscillations(biosim.BioModule):
    """BioModule wrapper for SBML model: Goldbeter1996 - Cyclin Cdc2 kinase Oscillations."""

    def __init__(self, model_path: str = "data/BIOMD0000000729.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Goldbeter1996CyclinCdc2KinaseOscillationsBiomd0000000729Model = SbmlGoldbeter1996CyclinCdc2KinaseOscillations

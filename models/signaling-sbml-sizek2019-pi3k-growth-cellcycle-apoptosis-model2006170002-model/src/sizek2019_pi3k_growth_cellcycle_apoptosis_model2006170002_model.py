...
"""Auto-generated SBML BioModule wrapper for Sizek2019 - PI3K_growth_CellCycle_Apoptosis.

Source: biomodels_ebi:MODEL2006170002
Original: https://www.ebi.ac.uk/biomodels/MODEL2006170002
"""
...
class SbmlSizek2019Pi3kGrowthCellcycleApoptosis(biosim.BioModule):
    """BioModule wrapper for SBML model: Sizek2019 - PI3K_growth_CellCycle_Apoptosis."""

    def __init__(self, model_path: str = "data/MODEL2006170002.sbml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Sizek2019Pi3kGrowthCellcycleApoptosisModel2006170002Model = SbmlSizek2019Pi3kGrowthCellcycleApoptosis

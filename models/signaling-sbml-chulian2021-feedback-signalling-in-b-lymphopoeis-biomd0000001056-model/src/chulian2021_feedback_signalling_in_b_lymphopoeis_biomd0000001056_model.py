...
"""Auto-generated SBML BioModule wrapper for Chulian2021 - feedback signalling in B lymphopoeisis.

Source: biomodels_ebi:BIOMD0000001056
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000001056
"""
...
class SbmlChulian2021FeedbackSignallingInBLymphopoeisis(biosim.BioModule):
    """BioModule wrapper for SBML model: Chulian2021 - feedback signalling in B lymphopoeisis."""

    def __init__(self, model_path: str = "data/BIOMD0000001056.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Chulian2021FeedbackSignallingInBLymphopoeisBiomd0000001056Model = SbmlChulian2021FeedbackSignallingInBLymphopoeisis

...
**Source**: [biomodels_ebi](https://www.ebi.ac.uk/biomodels/BIOMD0000000893)
**Standard**: sbml
...
models:
  - path: ../../models/signaling-sbml-gonzalezmiranda2013-the-effect-of-circadian-osci-biomd0000000893-model
    alias: model
```

...
"""Auto-generated SBML BioModule wrapper for Ouyang2014 - photomorphogenic UV-B signalling network.

Source: biomodels_ebi:BIOMD0000000545
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000545
"""
...
class SbmlOuyang2014PhotomorphogenicUvBSignallingNetwork(biosim.BioModule):
    """BioModule wrapper for SBML model: Ouyang2014 - photomorphogenic UV-B signalling network."""

    def __init__(self, model_path: str = "data/BIOMD0000000545.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Ouyang2014PhotomorphogenicUvBSignallingNetwBiomd0000000545Model = SbmlOuyang2014PhotomorphogenicUvBSignallingNetwork

...
"""Auto-generated SBML BioModule wrapper for PetelenzKuehn_osmoadaptation_HOG1att.

Source: biomodels_ebi:BIOMD0000000605
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000605
"""
...
class SbmlPetelenzkuehnOsmoadaptationHog1att(biosim.BioModule):
    """BioModule wrapper for SBML model: PetelenzKuehn_osmoadaptation_HOG1att."""

    def __init__(self, model_path: str = "data/BIOMD0000000605.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
PetelenzkuehnOsmoadaptationHog1attBiomd0000000605Model = SbmlPetelenzkuehnOsmoadaptationHog1att

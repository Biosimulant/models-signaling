...
"""Auto-generated SBML BioModule wrapper for Smith2013 - Regulation of Insulin Signalling by Oxidative Stress.

Source: biomodels_ebi:BIOMD0000000474
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000474
"""
...
class SbmlSmith2013RegulationOfInsulinSignallingByOxidative(biosim.BioModule):
    """BioModule wrapper for SBML model: Smith2013 - Regulation of Insulin Signalling by Oxidative Stress."""

    def __init__(self, model_path: str = "data/BIOMD0000000474.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Smith2013RegulationOfInsulinSignallingByOxBiomd0000000474Model = SbmlSmith2013RegulationOfInsulinSignallingByOxidative

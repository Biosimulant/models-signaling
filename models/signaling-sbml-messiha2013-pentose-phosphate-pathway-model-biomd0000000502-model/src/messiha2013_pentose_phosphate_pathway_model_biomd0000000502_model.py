...
"""Auto-generated SBML BioModule wrapper for Messiha2013 - Pentose phosphate pathway model.

Source: biomodels_ebi:BIOMD0000000502
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000502
"""
...
class SbmlMessiha2013PentosePhosphatePathwayModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Messiha2013 - Pentose phosphate pathway model."""

    def __init__(self, model_path: str = "data/BIOMD0000000502.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Messiha2013PentosePhosphatePathwayModelBiomd0000000502Model = SbmlMessiha2013PentosePhosphatePathwayModel

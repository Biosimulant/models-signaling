...
"""Auto-generated SBML BioModule wrapper for Pathak2013 - MAPK activation in response to various biotic stresses.

Source: biomodels_ebi:BIOMD0000000492
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000492
"""
...
class SbmlPathak2013MapkActivationInResponseToVariousBiotic(biosim.BioModule):
    """BioModule wrapper for SBML model: Pathak2013 - MAPK activation in response to various biotic stresses."""

    def __init__(self, model_path: str = "data/BIOMD0000000492.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Pathak2013MapkActivationInResponseToVariouBiomd0000000492Model = SbmlPathak2013MapkActivationInResponseToVariousBiotic

...
"""Tellurium-backed SBML wrapper for Strasen2018 - TGFb SMAD Signalling - Restimulation with 100pM TGFb at 6hr."""
...
class Strasen2018TgfbSmadSignallingRestimulationWBiomd0000000996Model(TelluriumSBMLBioModule):
    """Faithful Tellurium execution of the bundled SBML source model."""

    _SBML_ID = 'BIOMD0000000996'
    _TITLE = 'Strasen2018 - TGFb SMAD Signalling - Restimulation with 100pM TGFb at 6hr'
    ...
    _PARAMETER_INPUTS = {'initial_index_induced_ligand_deg_level': ('index_induced_ligand_deg',
     ...
     'initial_wash_ligand_level': ('WASH_LIGAND',
                                   0.0,
                                   'native SBML value',
                                   'WASH LIGAND source parameter. Maps to SBML symbol `WASH_LIGAND` '
    ...
    def __init__(self, model_path: str = 'data/BIOMD0000000996.xml', integration_step: float = 0.01) -> None:
        super().__init__(model_path=model_path, integration_step=integration_step)


Strasen2018TgfbSmadSignallingRestimulationWBiomd0000000996Model = Strasen2018TgfbSmadSignallingRestimulationWBiomd0000000996Model

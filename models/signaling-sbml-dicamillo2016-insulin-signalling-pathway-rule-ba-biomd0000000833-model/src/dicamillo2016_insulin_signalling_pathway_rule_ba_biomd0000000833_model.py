...
"""Auto-generated SBML BioModule wrapper for DiCamillo2016 - Insulin signalling pathway - Rule-based model.

Source: biomodels_ebi:BIOMD0000000833
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000833
"""
...
class SbmlDicamillo2016InsulinSignallingPathwayRuleBasedModel(biosim.BioModule):
    """BioModule wrapper for SBML model: DiCamillo2016 - Insulin signalling pathway - Rule-based model."""

    def __init__(self, model_path: str = "data/BIOMD0000000833.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Dicamillo2016InsulinSignallingPathwayRuleBaBiomd0000000833Model = SbmlDicamillo2016InsulinSignallingPathwayRuleBasedModel

...
"""Auto-generated SBML BioModule wrapper for Strasen2018 - TGFb SMAD Signalling Class 4.

Source: biomodels_ebi:BIOMD0000001001
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000001001
"""
...
class SbmlStrasen2018TgfbSmadSignallingClass4(biosim.BioModule):
    """BioModule wrapper for SBML model: Strasen2018 - TGFb SMAD Signalling Class 4."""

    def __init__(self, model_path: str = "data/BIOMD0000001001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Strasen2018TgfbSmadSignallingClass4Biomd0000001001Model = SbmlStrasen2018TgfbSmadSignallingClass4

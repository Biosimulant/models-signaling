...
"""Auto-generated SBML BioModule wrapper for Hui2016 - Age-related changes in articular cartilage.

Source: biomodels_ebi:BIOMD0000000560
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000560
"""
...
class SbmlHui2016AgeRelatedChangesInArticularCartilage(biosim.BioModule):
    """BioModule wrapper for SBML model: Hui2016 - Age-related changes in articular cartilage."""

    def __init__(self, model_path: str = "data/BIOMD0000000560.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Hui2016AgeRelatedChangesInArticularCartilaBiomd0000000560Model = SbmlHui2016AgeRelatedChangesInArticularCartilage

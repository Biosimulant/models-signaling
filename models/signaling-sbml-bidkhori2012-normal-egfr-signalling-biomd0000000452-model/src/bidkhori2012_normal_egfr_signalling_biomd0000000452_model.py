...
"""Auto-generated SBML BioModule wrapper for Bidkhori2012 - normal EGFR signalling.

Source: biomodels_ebi:BIOMD0000000452
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000452
"""
...
class SbmlBidkhori2012NormalEgfrSignalling(biosim.BioModule):
    """BioModule wrapper for SBML model: Bidkhori2012 - normal EGFR signalling."""

    def __init__(self, model_path: str = "data/BIOMD0000000452.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Bidkhori2012NormalEgfrSignallingBiomd0000000452Model = SbmlBidkhori2012NormalEgfrSignalling

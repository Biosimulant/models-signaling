...
"""Auto-generated SBML BioModule wrapper for Wanant2000_InsulinReceptorModel_A.

Source: biomodels_ebi:MODEL1201140005
Original: https://www.ebi.ac.uk/biomodels/MODEL1201140005
"""
...
class SbmlWanant2000InsulinreceptormodelA(biosim.BioModule):
    """BioModule wrapper for SBML model: Wanant2000_InsulinReceptorModel_A."""

    def __init__(self, model_path: str = "data/MODEL1201140005.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Wanant2000InsulinreceptormodelAModel1201140005Model = SbmlWanant2000InsulinreceptormodelA

...
"""Auto-generated SBML BioModule wrapper for Blackwell2019 - mechanistic model of signaling pathways activated by dopamine D1 receptors, acetylcholine receptors, and glutamate.

Source: biomodels_ebi:MODEL2006170003
Original: https://www.ebi.ac.uk/biomodels/MODEL2006170003
"""
...
class SbmlBlackwell2019MechanisticModelOfSignalingPathways(biosim.BioModule):
    """BioModule wrapper for SBML model: Blackwell2019 - mechanistic model of signaling pathways activated by dopamine D1 receptors, acetylcholine receptors, and glutamate."""

    def __init__(self, model_path: str = "data/MODEL2006170003.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Blackwell2019MechanisticModelOfSignalingPatModel2006170003Model = SbmlBlackwell2019MechanisticModelOfSignalingPathways

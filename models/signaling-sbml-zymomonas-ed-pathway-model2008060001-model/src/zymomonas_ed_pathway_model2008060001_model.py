...
"""Auto-generated SBML BioModule wrapper for Zymomonas ED Pathway.

Source: biomodels_ebi:MODEL2008060001
Original: https://www.ebi.ac.uk/biomodels/MODEL2008060001
"""
...
class SbmlZymomonasEdPathway(biosim.BioModule):
    """BioModule wrapper for SBML model: Zymomonas ED Pathway."""

    def __init__(self, model_path: str = "data/MODEL2008060001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
ZymomonasEdPathwayModel2008060001Model = SbmlZymomonasEdPathway

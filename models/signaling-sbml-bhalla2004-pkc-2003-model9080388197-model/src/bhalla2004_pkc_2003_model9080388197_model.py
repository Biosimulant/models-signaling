...
"""Auto-generated SBML BioModule wrapper for Bhalla2004_PKC_2003.

Source: biomodels_ebi:MODEL9080388197
Original: https://www.ebi.ac.uk/biomodels/MODEL9080388197
"""
...
class SbmlBhalla2004Pkc2003(biosim.BioModule):
    """BioModule wrapper for SBML model: Bhalla2004_PKC_2003."""

    def __init__(self, model_path: str = "data/MODEL9080388197.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Bhalla2004Pkc2003Model9080388197Model = SbmlBhalla2004Pkc2003

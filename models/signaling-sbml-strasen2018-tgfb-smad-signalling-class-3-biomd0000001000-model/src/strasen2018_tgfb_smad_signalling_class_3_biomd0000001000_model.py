...
"""Auto-generated SBML BioModule wrapper for Strasen2018 - TGFb SMAD Signalling Class 3.

Source: biomodels_ebi:BIOMD0000001000
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000001000
"""
...
class SbmlStrasen2018TgfbSmadSignallingClass3(biosim.BioModule):
    """BioModule wrapper for SBML model: Strasen2018 - TGFb SMAD Signalling Class 3."""

    def __init__(self, model_path: str = "data/BIOMD0000001000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Strasen2018TgfbSmadSignallingClass3Biomd0000001000Model = SbmlStrasen2018TgfbSmadSignallingClass3

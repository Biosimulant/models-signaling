...
"""Auto-generated SBML BioModule wrapper for Bachmann2011_JAK2-STAT5_FeedbackControl.

Source: biomodels_ebi:BIOMD0000000347
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000347
"""
...
class SbmlBachmann2011Jak2Stat5Feedbackcontrol(biosim.BioModule):
    """BioModule wrapper for SBML model: Bachmann2011_JAK2-STAT5_FeedbackControl."""

    def __init__(self, model_path: str = "data/BIOMD0000000347.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Bachmann2011Jak2Stat5FeedbackcontrolBiomd0000000347Model = SbmlBachmann2011Jak2Stat5Feedbackcontrol

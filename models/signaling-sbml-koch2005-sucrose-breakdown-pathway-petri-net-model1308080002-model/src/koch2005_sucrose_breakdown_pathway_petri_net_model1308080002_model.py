...
"""Auto-generated SBML BioModule wrapper for Koch2005 - Sucrose breakdown pathway - Petri net.

Source: biomodels_ebi:MODEL1308080002
Original: https://www.ebi.ac.uk/biomodels/MODEL1308080002
"""
...
class SbmlKoch2005SucroseBreakdownPathwayPetriNet(biosim.BioModule):
    """BioModule wrapper for SBML model: Koch2005 - Sucrose breakdown pathway - Petri net."""

    def __init__(self, model_path: str = "data/MODEL1308080002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Koch2005SucroseBreakdownPathwayPetriNetModel1308080002Model = SbmlKoch2005SucroseBreakdownPathwayPetriNet

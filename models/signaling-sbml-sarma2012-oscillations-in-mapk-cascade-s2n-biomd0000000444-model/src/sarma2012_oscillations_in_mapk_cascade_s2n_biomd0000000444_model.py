...
"""Auto-generated SBML BioModule wrapper for Sarma2012 - Oscillations in MAPK cascade (S2n).

Source: biomodels_ebi:BIOMD0000000444
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000444
"""
...
class SbmlSarma2012OscillationsInMapkCascadeS2n(biosim.BioModule):
    """BioModule wrapper for SBML model: Sarma2012 - Oscillations in MAPK cascade (S2n)."""

    def __init__(self, model_path: str = "data/BIOMD0000000444.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Sarma2012OscillationsInMapkCascadeS2nBiomd0000000444Model = SbmlSarma2012OscillationsInMapkCascadeS2n

...
"""Auto-generated SBML BioModule wrapper for Regan2020 - Adhesion_CIP_Migration_CellCycle_Apoptosis_v2.

Source: biomodels_ebi:MODEL2006170001
Original: https://www.ebi.ac.uk/biomodels/MODEL2006170001
"""
...
class SbmlRegan2020AdhesionCipMigrationCellcycleApoptosisV2(biosim.BioModule):
    """BioModule wrapper for SBML model: Regan2020 - Adhesion_CIP_Migration_CellCycle_Apoptosis_v2."""

    def __init__(self, model_path: str = "data/MODEL2006170001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Regan2020AdhesionCipMigrationCellcycleApoptModel2006170001Model = SbmlRegan2020AdhesionCipMigrationCellcycleApoptosisV2

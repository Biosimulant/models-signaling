...
"""Auto-generated SBML BioModule wrapper for Sackmann2006 - mating pheromone response pathway of S.cerevisiae.

Source: biomodels_ebi:MODEL1403040000
Original: https://www.ebi.ac.uk/biomodels/MODEL1403040000
"""
...
class SbmlSackmann2006MatingPheromoneResponsePathwayOfS(biosim.BioModule):
    """BioModule wrapper for SBML model: Sackmann2006 - mating pheromone response pathway of S.cerevisiae."""

    def __init__(self, model_path: str = "data/MODEL1403040000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Sackmann2006MatingPheromoneResponsePathwayOModel1403040000Model = SbmlSackmann2006MatingPheromoneResponsePathwayOfS

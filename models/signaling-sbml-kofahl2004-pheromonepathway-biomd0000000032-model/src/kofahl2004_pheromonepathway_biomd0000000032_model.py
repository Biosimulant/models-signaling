...
"""Auto-generated SBML BioModule wrapper for Kofahl2004_PheromonePathway.

Source: biomodels_ebi:BIOMD0000000032
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000032
"""
...
class SbmlKofahl2004Pheromonepathway(biosim.BioModule):
    """BioModule wrapper for SBML model: Kofahl2004_PheromonePathway."""

    def __init__(self, model_path: str = "data/BIOMD0000000032.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Kofahl2004PheromonepathwayBiomd0000000032Model = SbmlKofahl2004Pheromonepathway

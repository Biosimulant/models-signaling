...
"""Auto-generated SBML BioModule wrapper for Starbuck1990 - EGF binding and trafficking dynamics in Fibroblast.

Source: biomodels_ebi:MODEL2003190005
Original: https://www.ebi.ac.uk/biomodels/MODEL2003190005
"""
...
class SbmlStarbuck1990EgfBindingAndTraffickingDynamicsIn(biosim.BioModule):
    """BioModule wrapper for SBML model: Starbuck1990 - EGF binding and trafficking dynamics in Fibroblast."""

    def __init__(self, model_path: str = "data/MODEL2003190005.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Starbuck1990EgfBindingAndTraffickingDynamicModel2003190005Model = SbmlStarbuck1990EgfBindingAndTraffickingDynamicsIn

...
"""Auto-generated SBML BioModule wrapper for Novak2022 - Mitotic kinase oscillation.

Source: biomodels_ebi:BIOMD0000001058
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000001058
"""
...
class SbmlNovak2022MitoticKinaseOscillation(biosim.BioModule):
    """BioModule wrapper for SBML model: Novak2022 - Mitotic kinase oscillation."""

    def __init__(self, model_path: str = "data/BIOMD0000001058.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Novak2022MitoticKinaseOscillationBiomd0000001058Model = SbmlNovak2022MitoticKinaseOscillation

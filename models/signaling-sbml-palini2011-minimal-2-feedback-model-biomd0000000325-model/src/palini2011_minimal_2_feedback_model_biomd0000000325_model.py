...
"""Auto-generated SBML BioModule wrapper for Palini2011_Minimal_2_Feedback_Model.

Source: biomodels_ebi:BIOMD0000000325
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000325
"""
...
class SbmlPalini2011Minimal2FeedbackModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Palini2011_Minimal_2_Feedback_Model."""

    def __init__(self, model_path: str = "data/BIOMD0000000325.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Palini2011Minimal2FeedbackModelBiomd0000000325Model = SbmlPalini2011Minimal2FeedbackModel

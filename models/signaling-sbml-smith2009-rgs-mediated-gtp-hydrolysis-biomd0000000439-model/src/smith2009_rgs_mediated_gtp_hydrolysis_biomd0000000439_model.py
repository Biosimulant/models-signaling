...
"""Auto-generated SBML BioModule wrapper for Smith2009 - RGS mediated GTP hydrolysis.

Source: biomodels_ebi:BIOMD0000000439
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000439
"""
...
class SbmlSmith2009RgsMediatedGtpHydrolysis(biosim.BioModule):
    """BioModule wrapper for SBML model: Smith2009 - RGS mediated GTP hydrolysis."""

    def __init__(self, model_path: str = "data/BIOMD0000000439.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Smith2009RgsMediatedGtpHydrolysisBiomd0000000439Model = SbmlSmith2009RgsMediatedGtpHydrolysis

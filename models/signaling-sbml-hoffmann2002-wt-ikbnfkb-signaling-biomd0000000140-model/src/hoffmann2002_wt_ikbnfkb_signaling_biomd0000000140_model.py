...
"""Auto-generated SBML BioModule wrapper for Hoffmann2002_WT_IkBNFkB_Signaling.

Source: biomodels_ebi:BIOMD0000000140
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000140
"""
...
class SbmlHoffmann2002WtIkbnfkbSignaling(biosim.BioModule):
    """BioModule wrapper for SBML model: Hoffmann2002_WT_IkBNFkB_Signaling."""

    def __init__(self, model_path: str = "data/BIOMD0000000140.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Hoffmann2002WtIkbnfkbSignalingBiomd0000000140Model = SbmlHoffmann2002WtIkbnfkbSignaling

...
"""Auto-generated SBML BioModule wrapper for Trares2022 - Canonical NF-kB pathway, Petri net.

Source: biomodels_ebi:MODEL2207210001
Original: https://www.ebi.ac.uk/biomodels/MODEL2207210001
"""
...
class SbmlTrares2022CanonicalNfKbPathwayPetriNet(biosim.BioModule):
    """BioModule wrapper for SBML model: Trares2022 - Canonical NF-kB pathway, Petri net."""

    def __init__(self, model_path: str = "data/MODEL2207210001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Trares2022CanonicalNfKbPathwayPetriNetModel2207210001Model = SbmlTrares2022CanonicalNfKbPathwayPetriNet

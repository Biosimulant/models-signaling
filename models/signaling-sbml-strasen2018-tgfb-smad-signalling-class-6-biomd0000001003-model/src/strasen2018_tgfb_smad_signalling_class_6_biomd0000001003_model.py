...
"""Auto-generated SBML BioModule wrapper for Strasen2018 - TGFb SMAD Signalling Class 6.

Source: biomodels_ebi:BIOMD0000001003
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000001003
"""
...
class SbmlStrasen2018TgfbSmadSignallingClass6(biosim.BioModule):
    """BioModule wrapper for SBML model: Strasen2018 - TGFb SMAD Signalling Class 6."""

    def __init__(self, model_path: str = "data/BIOMD0000001003.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Strasen2018TgfbSmadSignallingClass6Biomd0000001003Model = SbmlStrasen2018TgfbSmadSignallingClass6

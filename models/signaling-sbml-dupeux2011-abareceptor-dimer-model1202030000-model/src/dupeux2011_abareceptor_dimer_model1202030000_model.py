...
"""Auto-generated SBML BioModule wrapper for Dupeux2011_ABAreceptor_Dimer.

Source: biomodels_ebi:MODEL1202030000
Original: https://www.ebi.ac.uk/biomodels/MODEL1202030000
"""
...
class SbmlDupeux2011AbareceptorDimer(biosim.BioModule):
    """BioModule wrapper for SBML model: Dupeux2011_ABAreceptor_Dimer."""

    def __init__(self, model_path: str = "data/MODEL1202030000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Dupeux2011AbareceptorDimerModel1202030000Model = SbmlDupeux2011AbareceptorDimer

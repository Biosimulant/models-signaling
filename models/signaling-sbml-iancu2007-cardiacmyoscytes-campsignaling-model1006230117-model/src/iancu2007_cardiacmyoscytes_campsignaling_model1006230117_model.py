...
"""Auto-generated SBML BioModule wrapper for Iancu2007_CardiacMyoscytes_cAMPsignaling.

Source: biomodels_ebi:MODEL1006230117
Original: https://www.ebi.ac.uk/biomodels/MODEL1006230117
"""
...
class SbmlIancu2007CardiacmyoscytesCampsignaling(biosim.BioModule):
    """BioModule wrapper for SBML model: Iancu2007_CardiacMyoscytes_cAMPsignaling."""

    def __init__(self, model_path: str = "data/MODEL1006230117.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Iancu2007CardiacmyoscytesCampsignalingModel1006230117Model = SbmlIancu2007CardiacmyoscytesCampsignaling

...
"""Auto-generated SBML BioModule wrapper for Rutkis2013 - Entner-Doudoroff pathway in Z.mobilis.

Source: biomodels_ebi:MODEL1409050000
Original: https://www.ebi.ac.uk/biomodels/MODEL1409050000
"""
...
class SbmlRutkis2013EntnerDoudoroffPathwayInZMobilis(biosim.BioModule):
    """BioModule wrapper for SBML model: Rutkis2013 - Entner-Doudoroff pathway in Z.mobilis."""

    def __init__(self, model_path: str = "data/MODEL1409050000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Rutkis2013EntnerDoudoroffPathwayInZMobilisModel1409050000Model = SbmlRutkis2013EntnerDoudoroffPathwayInZMobilis

...
"""Auto-generated SBML BioModule wrapper for PetelenzKuehn_osmoadaptation_WT.

Source: biomodels_ebi:BIOMD0000000603
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000603
"""
...
class SbmlPetelenzkuehnOsmoadaptationWt(biosim.BioModule):
    """BioModule wrapper for SBML model: PetelenzKuehn_osmoadaptation_WT."""

    def __init__(self, model_path: str = "data/BIOMD0000000603.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
PetelenzkuehnOsmoadaptationWtBiomd0000000603Model = SbmlPetelenzkuehnOsmoadaptationWt

...
"""Auto-generated SBML BioModule wrapper for Sobaleva2005_ProlactinRegulation.

Source: biomodels_ebi:MODEL7896869925
Original: https://www.ebi.ac.uk/biomodels/MODEL7896869925
"""
...
class SbmlSobaleva2005Prolactinregulation(biosim.BioModule):
    """BioModule wrapper for SBML model: Sobaleva2005_ProlactinRegulation."""

    def __init__(self, model_path: str = "data/MODEL7896869925.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Sobaleva2005ProlactinregulationModel7896869925Model = SbmlSobaleva2005Prolactinregulation

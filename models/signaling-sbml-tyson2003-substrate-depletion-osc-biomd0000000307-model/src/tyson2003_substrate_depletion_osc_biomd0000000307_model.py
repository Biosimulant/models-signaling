...
"""Auto-generated SBML BioModule wrapper for Tyson2003_Substrate_Depletion_Osc.

Source: biomodels_ebi:BIOMD0000000307
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000307
"""
...
class SbmlTyson2003SubstrateDepletionOsc(biosim.BioModule):
    """BioModule wrapper for SBML model: Tyson2003_Substrate_Depletion_Osc."""

    def __init__(self, model_path: str = "data/BIOMD0000000307.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Tyson2003SubstrateDepletionOscBiomd0000000307Model = SbmlTyson2003SubstrateDepletionOsc

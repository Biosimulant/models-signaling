...
"""Auto-generated SBML BioModule wrapper for Cui2008_CardiacMyocytes.

Source: biomodels_ebi:MODEL1172425728
Original: https://www.ebi.ac.uk/biomodels/MODEL1172425728
"""
...
class SbmlCui2008Cardiacmyocytes(biosim.BioModule):
    """BioModule wrapper for SBML model: Cui2008_CardiacMyocytes."""

    def __init__(self, model_path: str = "data/MODEL1172425728.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Cui2008CardiacmyocytesModel1172425728Model = SbmlCui2008Cardiacmyocytes

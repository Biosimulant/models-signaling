...
"""Auto-generated SBML BioModule wrapper for Pathak2013 - MAPK activation in response to various abiotic stresses.

Source: biomodels_ebi:BIOMD0000000491
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000491
"""
...
class SbmlPathak2013MapkActivationInResponseToVariousAbiotic(biosim.BioModule):
    """BioModule wrapper for SBML model: Pathak2013 - MAPK activation in response to various abiotic stresses."""

    def __init__(self, model_path: str = "data/BIOMD0000000491.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Pathak2013MapkActivationInResponseToVariouBiomd0000000491Model = SbmlPathak2013MapkActivationInResponseToVariousAbiotic

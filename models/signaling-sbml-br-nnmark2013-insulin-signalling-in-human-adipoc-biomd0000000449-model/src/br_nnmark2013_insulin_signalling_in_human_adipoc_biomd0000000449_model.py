...
"""Auto-generated SBML BioModule wrapper for Brännmark2013 - Insulin signalling in human adipocytes (diabetic condition).

Source: biomodels_ebi:BIOMD0000000449
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000449
"""
...
class SbmlBrannmark2013InsulinSignallingInHumanAdipocytes(biosim.BioModule):
    """BioModule wrapper for SBML model: Brännmark2013 - Insulin signalling in human adipocytes (diabetic condition)."""

    def __init__(self, model_path: str = "data/BIOMD0000000449.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
BrNnmark2013InsulinSignallingInHumanAdipocBiomd0000000449Model = SbmlBrannmark2013InsulinSignallingInHumanAdipocytes

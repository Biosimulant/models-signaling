...
"""Auto-generated SBML BioModule wrapper for Vizan2013 - TGF pathway long term signaling.

Source: biomodels_ebi:BIOMD0000000499
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000499
"""
...
class SbmlVizan2013TgfPathwayLongTermSignaling(biosim.BioModule):
    """BioModule wrapper for SBML model: Vizan2013 - TGF pathway long term signaling."""

    def __init__(self, model_path: str = "data/BIOMD0000000499.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Vizan2013TgfPathwayLongTermSignalingBiomd0000000499Model = SbmlVizan2013TgfPathwayLongTermSignaling

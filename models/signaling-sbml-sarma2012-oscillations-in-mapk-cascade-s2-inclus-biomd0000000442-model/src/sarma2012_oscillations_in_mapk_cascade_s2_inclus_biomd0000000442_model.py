...
"""Auto-generated SBML BioModule wrapper for Sarma2012 - Oscillations in MAPK cascade (S2), inclusion of external signalling module.

Source: biomodels_ebi:BIOMD0000000442
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000442
"""
...
class SbmlSarma2012OscillationsInMapkCascadeS2InclusionOf(biosim.BioModule):
    """BioModule wrapper for SBML model: Sarma2012 - Oscillations in MAPK cascade (S2), inclusion of external signalling module."""

    def __init__(self, model_path: str = "data/BIOMD0000000442.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Sarma2012OscillationsInMapkCascadeS2InclusBiomd0000000442Model = SbmlSarma2012OscillationsInMapkCascadeS2InclusionOf

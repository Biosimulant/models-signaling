...
"""Auto-generated SBML BioModule wrapper for Bakshi2020 - Properdin model of alternative pathway of complement system.

Source: biomodels_ebi:BIOMD0000001018
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000001018
"""
...
class SbmlBakshi2020ProperdinModelOfAlternativePathwayOf(biosim.BioModule):
    """BioModule wrapper for SBML model: Bakshi2020 - Properdin model of alternative pathway of complement system."""

    def __init__(self, model_path: str = "data/BIOMD0000001018.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Bakshi2020ProperdinModelOfAlternativePathwaBiomd0000001018Model = SbmlBakshi2020ProperdinModelOfAlternativePathwayOf

...
"""Auto-generated SBML BioModule wrapper for Dual G protein Model.

Source: biomodels_ebi:MODEL2306210001
Original: https://www.ebi.ac.uk/biomodels/MODEL2306210001
"""
...
class SbmlDualGProteinModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Dual G protein Model."""

    def __init__(self, model_path: str = "data/MODEL2306210001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
DualGProteinModelModel2306210001Model = SbmlDualGProteinModel

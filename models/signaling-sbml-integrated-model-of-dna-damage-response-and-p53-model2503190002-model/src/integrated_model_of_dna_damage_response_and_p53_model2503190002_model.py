...
"""Auto-generated SBML BioModule wrapper for Integrated Model of DNA Damage Response and p53 Signaling in ATM/ATR-Deficient Ataxia Telangiectasia: Exploring the Therapeutic Roles of Possible repurposed drugs.

Source: biomodels_ebi:MODEL2503190002
Original: https://www.ebi.ac.uk/biomodels/MODEL2503190002
"""
...
class SbmlIntegratedModelOfDnaDamageResponseAndP53Signaling(biosim.BioModule):
    """BioModule wrapper for SBML model: Integrated Model of DNA Damage Response and p53 Signaling in ATM/ATR-Deficient Ataxia Telangiectasia: Exploring the Therapeutic Roles of Possible repurposed drugs."""

    def __init__(self, model_path: str = "data/MODEL2503190002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
IntegratedModelOfDnaDamageResponseAndP53Model2503190002Model = SbmlIntegratedModelOfDnaDamageResponseAndP53Signaling

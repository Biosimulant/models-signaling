...
"""Auto-generated SBML BioModule wrapper for Pinto2022 - Hybrid SBML/ANN model.

Source: biomodels_ebi:MODEL2207280001
Original: https://www.ebi.ac.uk/biomodels/MODEL2207280001
"""
...
class SbmlPinto2022HybridSbmlAnnModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Pinto2022 - Hybrid SBML/ANN model."""

    def __init__(self, model_path: str = "data/MODEL2207280001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Pinto2022HybridSbmlAnnModelModel2207280001Model = SbmlPinto2022HybridSbmlAnnModel

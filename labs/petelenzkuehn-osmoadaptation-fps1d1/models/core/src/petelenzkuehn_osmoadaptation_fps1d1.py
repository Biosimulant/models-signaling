...
"""Tellurium-backed SBML wrapper for PetelenzKuehn_osmoadaptation_fps1D1."""
...
class PetelenzkuehnOsmoadaptationFps1d1Model(TelluriumSBMLBioModule):
    """Faithful Tellurium execution of the bundled SBML source model."""

    _SBML_ID = 'BIOMD0000000607'
    _TITLE = 'PetelenzKuehn_osmoadaptation_fps1D1'
    ...
    def __init__(self, model_path: str = 'data/BIOMD0000000607.xml', integration_step: float = 0.01) -> None:
        super().__init__(model_path=model_path, integration_step=integration_step)


PetelenzkuehnOsmoadaptationFps1d1Biomd0000000607Model = PetelenzkuehnOsmoadaptationFps1d1Model

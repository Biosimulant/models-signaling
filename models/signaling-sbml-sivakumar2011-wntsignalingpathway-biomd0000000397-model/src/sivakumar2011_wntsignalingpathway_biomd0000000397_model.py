...
"""Auto-generated SBML BioModule wrapper for Sivakumar2011_WntSignalingPathway.

Source: biomodels_ebi:BIOMD0000000397
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000397
"""
...
class SbmlSivakumar2011Wntsignalingpathway(biosim.BioModule):
    """BioModule wrapper for SBML model: Sivakumar2011_WntSignalingPathway."""

    def __init__(self, model_path: str = "data/BIOMD0000000397.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Sivakumar2011WntsignalingpathwayBiomd0000000397Model = SbmlSivakumar2011Wntsignalingpathway

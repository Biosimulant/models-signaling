...
"""Auto-generated SBML BioModule wrapper for Strasen2018 - TGFb SMAD Signalling - DRB treatment.

Source: biomodels_ebi:BIOMD0000000997
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000997
"""
...
class SbmlStrasen2018TgfbSmadSignallingDrbTreatment(biosim.BioModule):
    """BioModule wrapper for SBML model: Strasen2018 - TGFb SMAD Signalling - DRB treatment."""

    def __init__(self, model_path: str = "data/BIOMD0000000997.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Strasen2018TgfbSmadSignallingDrbTreatmentBiomd0000000997Model = SbmlStrasen2018TgfbSmadSignallingDrbTreatment

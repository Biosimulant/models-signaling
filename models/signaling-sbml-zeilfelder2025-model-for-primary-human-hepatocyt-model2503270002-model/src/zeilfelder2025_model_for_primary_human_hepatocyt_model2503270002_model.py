...
"""Auto-generated SBML BioModule wrapper for Zeilfelder2025 - Model for primary human hepatocytes (PHH).

Source: biomodels_ebi:MODEL2503270002
Original: https://www.ebi.ac.uk/biomodels/MODEL2503270002
"""
...
class SbmlZeilfelder2025ModelForPrimaryHumanHepatocytesPhh(biosim.BioModule):
    """BioModule wrapper for SBML model: Zeilfelder2025 - Model for primary human hepatocytes (PHH)."""

    def __init__(self, model_path: str = "data/MODEL2503270002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Zeilfelder2025ModelForPrimaryHumanHepatocytModel2503270002Model = SbmlZeilfelder2025ModelForPrimaryHumanHepatocytesPhh

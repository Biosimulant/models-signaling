...
"""Auto-generated SBML BioModule wrapper for Neiburga2022 - Arabidopsis thaliana MEP pathway with isoprene synthesis.

Source: biomodels_ebi:MODEL2206090003
Original: https://www.ebi.ac.uk/biomodels/MODEL2206090003
"""
...
class SbmlNeiburga2022ArabidopsisThalianaMepPathwayWithIsoprene(biosim.BioModule):
    """BioModule wrapper for SBML model: Neiburga2022 - Arabidopsis thaliana MEP pathway with isoprene synthesis."""

    def __init__(self, model_path: str = "data/MODEL2206090003.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Neiburga2022ArabidopsisThalianaMepPathwayWiModel2206090003Model = SbmlNeiburga2022ArabidopsisThalianaMepPathwayWithIsoprene

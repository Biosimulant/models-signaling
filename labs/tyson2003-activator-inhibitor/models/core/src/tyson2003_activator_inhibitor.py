...
"""Tellurium-backed SBML wrapper for Tyson2003_Activator_Inhibitor."""
...
class Tyson2003ActivatorInhibitorModel(TelluriumSBMLBioModule):
    """Faithful Tellurium execution of the bundled SBML source model."""

    _SBML_ID = 'BIOMD0000000306'
    _TITLE = 'Tyson2003_Activator_Inhibitor'
    ...
    def __init__(self, model_path: str = 'data/BIOMD0000000306.xml', integration_step: float = 0.01) -> None:
        super().__init__(model_path=model_path, integration_step=integration_step)


Tyson2003ActivatorInhibitorBiomd0000000306Model = Tyson2003ActivatorInhibitorModel

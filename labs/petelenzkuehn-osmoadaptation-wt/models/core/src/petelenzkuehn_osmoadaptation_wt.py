...
"""Tellurium-backed SBML wrapper for PetelenzKuehn_osmoadaptation_WT."""
...
class PetelenzkuehnOsmoadaptationWtModel(TelluriumSBMLBioModule):
    """Faithful Tellurium execution of the bundled SBML source model."""

    _SBML_ID = 'BIOMD0000000603'
    _TITLE = 'PetelenzKuehn_osmoadaptation_WT'
    ...
    def __init__(self, model_path: str = 'data/BIOMD0000000603.xml', integration_step: float = 0.01) -> None:
        super().__init__(model_path=model_path, integration_step=integration_step)


PetelenzkuehnOsmoadaptationWtBiomd0000000603Model = PetelenzkuehnOsmoadaptationWtModel

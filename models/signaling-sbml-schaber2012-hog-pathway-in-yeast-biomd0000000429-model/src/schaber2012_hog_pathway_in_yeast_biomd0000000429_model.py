...
"""Auto-generated SBML BioModule wrapper for Schaber2012 - Hog pathway in yeast.

Source: biomodels_ebi:BIOMD0000000429
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000429
"""
...
class SbmlSchaber2012HogPathwayInYeast(biosim.BioModule):
    """BioModule wrapper for SBML model: Schaber2012 - Hog pathway in yeast."""

    def __init__(self, model_path: str = "data/BIOMD0000000429.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Schaber2012HogPathwayInYeastBiomd0000000429Model = SbmlSchaber2012HogPathwayInYeast

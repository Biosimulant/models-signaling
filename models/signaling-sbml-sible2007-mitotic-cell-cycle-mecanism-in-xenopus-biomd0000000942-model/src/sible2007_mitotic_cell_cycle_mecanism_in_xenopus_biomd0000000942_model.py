...
"""Auto-generated SBML BioModule wrapper for Sible2007 - Mitotic cell cycle mecanism in Xenopus Laevis.

Source: biomodels_ebi:BIOMD0000000942
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000942
"""
...
class SbmlSible2007MitoticCellCycleMecanismInXenopusLaevis(biosim.BioModule):
    """BioModule wrapper for SBML model: Sible2007 - Mitotic cell cycle mecanism in Xenopus Laevis."""

    def __init__(self, model_path: str = "data/BIOMD0000000942.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Sible2007MitoticCellCycleMecanismInXenopusBiomd0000000942Model = SbmlSible2007MitoticCellCycleMecanismInXenopusLaevis

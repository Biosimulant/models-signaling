...
Source: biomodels_ebi:MODEL1710260001
Original: https://www.ebi.ac.uk/biomodels/MODEL1710260001
"""
...
class SbmlMartinezGuimera2017GenericRedoxSignallingModelWith(biosim.BioModule):
    ...
    def __init__(self, model_path: str = "data/MODEL1710260001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
MartinezGuimera2017GenericRedoxSignallingMoModel1710260001Model = SbmlMartinezGuimera2017GenericRedoxSignallingModelWith

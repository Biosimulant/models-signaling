...
"""Auto-generated SBML BioModule wrapper for Modeling of the U1 snRNP assembly pathway in alternative splicing in human cells using Petri nets.

Source: biomodels_ebi:MODEL2410300001
Original: https://www.ebi.ac.uk/biomodels/MODEL2410300001
"""
...
class SbmlModelingOfTheU1SnrnpAssemblyPathwayInAlternative(biosim.BioModule):
    """BioModule wrapper for SBML model: Modeling of the U1 snRNP assembly pathway in alternative splicing in human cells using Petri nets."""

    def __init__(self, model_path: str = "data/MODEL2410300001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
ModelingOfTheU1SnrnpAssemblyPathwayInAltModel2410300001Model = SbmlModelingOfTheU1SnrnpAssemblyPathwayInAlternative

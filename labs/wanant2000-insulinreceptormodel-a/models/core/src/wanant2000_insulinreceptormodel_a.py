...
"""Tellurium-backed SBML wrapper for Wanant2000_InsulinReceptorModel_A."""
...
class Wanant2000InsulinreceptormodelAModel(TelluriumSBMLBioModule):
    """Faithful Tellurium execution of the bundled SBML source model."""

    _SBML_ID = 'MODEL1201140005'
    _TITLE = 'Wanant2000_InsulinReceptorModel_A'
    ...
    def __init__(self, model_path: str = 'data/MODEL1201140005.xml', integration_step: float = 0.01) -> None:
        super().__init__(model_path=model_path, integration_step=integration_step)


Wanant2000InsulinreceptormodelAModel1201140005Model = Wanant2000InsulinreceptormodelAModel

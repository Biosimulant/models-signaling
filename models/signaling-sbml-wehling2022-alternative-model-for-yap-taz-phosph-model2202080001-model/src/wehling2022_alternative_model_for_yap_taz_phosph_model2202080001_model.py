...
"""Auto-generated SBML BioModule wrapper for Wehling2022 - Alternative model for YAP/TAZ phosphorylation and transition between nuclear and cytoplasmic localization.

Source: biomodels_ebi:MODEL2202080001
Original: https://www.ebi.ac.uk/biomodels/MODEL2202080001
"""
...
class SbmlWehling2022AlternativeModelForYapTazPhosphorylation(biosim.BioModule):
    """BioModule wrapper for SBML model: Wehling2022 - Alternative model for YAP/TAZ phosphorylation and transition between nuclear and cytoplasmic localization."""

    def __init__(self, model_path: str = "data/MODEL2202080001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Wehling2022AlternativeModelForYapTazPhosphModel2202080001Model = SbmlWehling2022AlternativeModelForYapTazPhosphorylation

...
"""Auto-generated SBML BioModule wrapper for TLR4-NFkB-phospho-NF-kB signaling in BMDM.

Source: biomodels_ebi:MODEL1809230001
Original: https://www.ebi.ac.uk/biomodels/MODEL1809230001
"""
...
class SbmlTlr4NfkbPhosphoNfKbSignalingInBmdm(biosim.BioModule):
    """BioModule wrapper for SBML model: TLR4-NFkB-phospho-NF-kB signaling in BMDM."""

    def __init__(self, model_path: str = "data/MODEL1809230001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Tlr4NfkbPhosphoNfKbSignalingInBmdmModel1809230001Model = SbmlTlr4NfkbPhosphoNfKbSignalingInBmdm

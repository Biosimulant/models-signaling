...
"""Auto-generated SBML BioModule wrapper for Nyman2012_InsulinSignalling.

Source: biomodels_ebi:BIOMD0000000423
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000423
"""
...
class SbmlNyman2012Insulinsignalling(biosim.BioModule):
    """BioModule wrapper for SBML model: Nyman2012_InsulinSignalling."""

    def __init__(self, model_path: str = "data/BIOMD0000000423.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Nyman2012InsulinsignallingBiomd0000000423Model = SbmlNyman2012Insulinsignalling

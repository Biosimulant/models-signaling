...
"""Auto-generated SBML BioModule wrapper for Zi2011_TGF-beta_Pathway.

Source: biomodels_ebi:BIOMD0000000342
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000342
"""
...
class SbmlZi2011TgfBetaPathway(biosim.BioModule):
    """BioModule wrapper for SBML model: Zi2011_TGF-beta_Pathway."""

    def __init__(self, model_path: str = "data/BIOMD0000000342.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Zi2011TgfBetaPathwayBiomd0000000342Model = SbmlZi2011TgfBetaPathway

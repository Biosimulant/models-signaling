...
"""Auto-generated SBML BioModule wrapper for Heitzler2012 - GPCR signalling.

Source: biomodels_ebi:BIOMD0000000842
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000842
"""
...
class SbmlHeitzler2012GpcrSignalling(biosim.BioModule):
    """BioModule wrapper for SBML model: Heitzler2012 - GPCR signalling."""

    def __init__(self, model_path: str = "data/BIOMD0000000842.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Heitzler2012GpcrSignallingBiomd0000000842Model = SbmlHeitzler2012GpcrSignalling

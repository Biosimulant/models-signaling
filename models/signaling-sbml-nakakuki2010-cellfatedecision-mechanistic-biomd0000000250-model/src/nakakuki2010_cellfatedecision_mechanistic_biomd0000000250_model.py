...
"""Auto-generated SBML BioModule wrapper for Nakakuki2010_CellFateDecision_Mechanistic.

Source: biomodels_ebi:BIOMD0000000250
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000250
"""
...
class SbmlNakakuki2010CellfatedecisionMechanistic(biosim.BioModule):
    """BioModule wrapper for SBML model: Nakakuki2010_CellFateDecision_Mechanistic."""

    def __init__(self, model_path: str = "data/BIOMD0000000250.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Nakakuki2010CellfatedecisionMechanisticBiomd0000000250Model = SbmlNakakuki2010CellfatedecisionMechanistic

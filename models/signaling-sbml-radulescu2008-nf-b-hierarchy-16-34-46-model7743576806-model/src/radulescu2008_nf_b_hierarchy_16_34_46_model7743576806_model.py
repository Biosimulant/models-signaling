...
"""Auto-generated SBML BioModule wrapper for Radulescu2008 - NF-κB hierarchy ℳ(16,34,46).

Source: biomodels_ebi:MODEL7743576806
Original: https://www.ebi.ac.uk/biomodels/MODEL7743576806
"""
...
class SbmlRadulescu2008NfBHierarchyM163446(biosim.BioModule):
    """BioModule wrapper for SBML model: Radulescu2008 - NF-κB hierarchy ℳ(16,34,46)."""

    def __init__(self, model_path: str = "data/MODEL7743576806.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Radulescu2008NfBHierarchy163446Model7743576806Model = SbmlRadulescu2008NfBHierarchyM163446

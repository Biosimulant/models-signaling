...
"""Auto-generated SBML BioModule wrapper for AhmedMobeen2021 - NF-kB Activation Model.

Source: biomodels_ebi:MODEL2001290001
Original: https://www.ebi.ac.uk/biomodels/MODEL2001290001
"""
...
class SbmlAhmedmobeen2021NfKbActivationModel(biosim.BioModule):
    """BioModule wrapper for SBML model: AhmedMobeen2021 - NF-kB Activation Model."""

    def __init__(self, model_path: str = "data/MODEL2001290001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Ahmedmobeen2021NfKbActivationModelModel2001290001Model = SbmlAhmedmobeen2021NfKbActivationModel

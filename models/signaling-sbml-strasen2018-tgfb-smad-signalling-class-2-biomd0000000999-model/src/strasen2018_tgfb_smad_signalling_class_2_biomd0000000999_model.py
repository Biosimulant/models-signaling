...
"""Auto-generated SBML BioModule wrapper for Strasen2018 - TGFb SMAD Signalling Class 2.

Source: biomodels_ebi:BIOMD0000000999
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000999
"""
...
class SbmlStrasen2018TgfbSmadSignallingClass2(biosim.BioModule):
    """BioModule wrapper for SBML model: Strasen2018 - TGFb SMAD Signalling Class 2."""

    def __init__(self, model_path: str = "data/BIOMD0000000999.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Strasen2018TgfbSmadSignallingClass2Biomd0000000999Model = SbmlStrasen2018TgfbSmadSignallingClass2

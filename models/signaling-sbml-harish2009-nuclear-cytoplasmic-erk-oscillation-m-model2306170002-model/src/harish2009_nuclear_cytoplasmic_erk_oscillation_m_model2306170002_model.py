...
"""Auto-generated SBML BioModule wrapper for Harish2009 - nuclear–cytoplasmic ERK oscillation model.

Source: biomodels_ebi:MODEL2306170002
Original: https://www.ebi.ac.uk/biomodels/MODEL2306170002
"""
...
class SbmlHarish2009NuclearcytoplasmicErkOscillationModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Harish2009 - nuclear–cytoplasmic ERK oscillation model."""

    def __init__(self, model_path: str = "data/MODEL2306170002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Harish2009NuclearCytoplasmicErkOscillationMModel2306170002Model = SbmlHarish2009NuclearcytoplasmicErkOscillationModel

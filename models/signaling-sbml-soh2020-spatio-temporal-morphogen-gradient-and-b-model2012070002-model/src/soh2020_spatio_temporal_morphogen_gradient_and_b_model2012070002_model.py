...
"""Auto-generated SBML BioModule wrapper for Soh2020 - Spatio-temporal morphogen gradient and BMP signaling.

Source: biomodels_ebi:MODEL2012070002
Original: https://www.ebi.ac.uk/biomodels/MODEL2012070002
"""
...
class SbmlSoh2020SpatioTemporalMorphogenGradientAndBmpSignaling(biosim.BioModule):
    """BioModule wrapper for SBML model: Soh2020 - Spatio-temporal morphogen gradient and BMP signaling."""

    def __init__(self, model_path: str = "data/MODEL2012070002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Soh2020SpatioTemporalMorphogenGradientAndBModel2012070002Model = SbmlSoh2020SpatioTemporalMorphogenGradientAndBmpSignaling

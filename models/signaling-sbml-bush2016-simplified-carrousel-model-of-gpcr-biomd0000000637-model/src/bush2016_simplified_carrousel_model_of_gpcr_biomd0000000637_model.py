...
"""Auto-generated SBML BioModule wrapper for Bush2016 - Simplified Carrousel model of GPCR.

Source: biomodels_ebi:BIOMD0000000637
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000637
"""
...
class SbmlBush2016SimplifiedCarrouselModelOfGpcr(biosim.BioModule):
    """BioModule wrapper for SBML model: Bush2016 - Simplified Carrousel model of GPCR."""

    def __init__(self, model_path: str = "data/BIOMD0000000637.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Bush2016SimplifiedCarrouselModelOfGpcrBiomd0000000637Model = SbmlBush2016SimplifiedCarrouselModelOfGpcr

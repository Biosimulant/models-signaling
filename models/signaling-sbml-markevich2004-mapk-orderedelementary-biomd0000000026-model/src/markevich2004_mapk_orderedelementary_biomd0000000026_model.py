...
"""Auto-generated SBML BioModule wrapper for Markevich2004_MAPK_orderedElementary.

Source: biomodels_ebi:BIOMD0000000026
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000026
"""
...
class SbmlMarkevich2004MapkOrderedelementary(biosim.BioModule):
    """BioModule wrapper for SBML model: Markevich2004_MAPK_orderedElementary."""

    def __init__(self, model_path: str = "data/BIOMD0000000026.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Markevich2004MapkOrderedelementaryBiomd0000000026Model = SbmlMarkevich2004MapkOrderedelementary

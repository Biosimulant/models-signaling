...
"""Tellurium-backed SBML wrapper for Sarma2012 - Interaction topologies of MAPK cascade (M1_K2_QSS_USEQ)."""
...
class Sarma2012InteractionTopologiesOfMapkCascadeModel1204280033Model(TelluriumSBMLBioModule):
    """Faithful Tellurium execution of the bundled SBML source model."""

    _SBML_ID = 'MODEL1204280033'
    _TITLE = 'Sarma2012 - Interaction topologies of MAPK cascade (M1_K2_QSS_USEQ)'
    ...
    def __init__(self, model_path: str = 'data/MODEL1204280033.xml', integration_step: float = 0.01) -> None:
        super().__init__(model_path=model_path, integration_step=integration_step)


Sarma2012InteractionTopologiesOfMapkCascadeModel1204280033Model = Sarma2012InteractionTopologiesOfMapkCascadeModel1204280033Model

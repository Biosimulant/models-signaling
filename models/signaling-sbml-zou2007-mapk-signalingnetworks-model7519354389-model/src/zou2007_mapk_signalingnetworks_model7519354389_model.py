...
"""Auto-generated SBML BioModule wrapper for Zou2007_MAPK_SignalingNetworks.

Source: biomodels_ebi:MODEL7519354389
Original: https://www.ebi.ac.uk/biomodels/MODEL7519354389
"""
...
class SbmlZou2007MapkSignalingnetworks(biosim.BioModule):
    """BioModule wrapper for SBML model: Zou2007_MAPK_SignalingNetworks."""

    def __init__(self, model_path: str = "data/MODEL7519354389.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Zou2007MapkSignalingnetworksModel7519354389Model = SbmlZou2007MapkSignalingnetworks

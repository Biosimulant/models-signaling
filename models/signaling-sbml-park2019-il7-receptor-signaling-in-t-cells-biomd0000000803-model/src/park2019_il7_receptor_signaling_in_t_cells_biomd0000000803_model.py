...
"""Auto-generated SBML BioModule wrapper for Park2019 - IL7 receptor signaling in T cells.

Source: biomodels_ebi:BIOMD0000000803
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000803
"""
...
class SbmlPark2019Il7ReceptorSignalingInTCells(biosim.BioModule):
    """BioModule wrapper for SBML model: Park2019 - IL7 receptor signaling in T cells."""

    def __init__(self, model_path: str = "data/BIOMD0000000803.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Park2019Il7ReceptorSignalingInTCellsBiomd0000000803Model = SbmlPark2019Il7ReceptorSignalingInTCells

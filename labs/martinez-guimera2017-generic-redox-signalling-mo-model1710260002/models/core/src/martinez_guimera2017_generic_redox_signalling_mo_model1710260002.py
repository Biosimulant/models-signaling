...
"""Tellurium-backed SBML wrapper for Martinez-Guimera2017 - Generic redox signalling model with negative feedforward regulation (Model 3)."""
...
class MartinezGuimera2017GenericRedoxSignallingMoModel1710260002Model(TelluriumSBMLBioModule):
    """Faithful Tellurium execution of the bundled SBML source model."""

    _SBML_ID = 'MODEL1710260002'
    _TITLE = 'Martinez-Guimera2017 - Generic redox signalling model with negative feedforward regulation (Model 3)'
    ...
    def __init__(self, model_path: str = 'data/MODEL1710260002.xml', integration_step: float = 0.01) -> None:
        super().__init__(model_path=model_path, integration_step=integration_step)


MartinezGuimera2017GenericRedoxSignallingMoModel1710260002Model = MartinezGuimera2017GenericRedoxSignallingMoModel1710260002Model

...
"""Tellurium-backed SBML wrapper for Smallbone2015 - forced pathway feedback."""
...
class Smallbone2015ForcedPathwayFeedbackModel(TelluriumSBMLBioModule):
    """Faithful Tellurium execution of the bundled SBML source model."""

    _SBML_ID = 'MODEL1503180006'
    _TITLE = 'Smallbone2015 - forced pathway feedback'
    ...
    def __init__(self, model_path: str = 'data/MODEL1503180006.xml', integration_step: float = 0.01) -> None:
        super().__init__(model_path=model_path, integration_step=integration_step)


Smallbone2015ForcedPathwayFeedbackModel1503180006Model = Smallbone2015ForcedPathwayFeedbackModel

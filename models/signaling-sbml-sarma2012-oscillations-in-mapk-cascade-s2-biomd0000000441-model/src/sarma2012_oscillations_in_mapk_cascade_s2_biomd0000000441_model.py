...
"""Auto-generated SBML BioModule wrapper for Sarma2012 - Oscillations in MAPK cascade (S2).

Source: biomodels_ebi:BIOMD0000000441
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000441
"""
...
class SbmlSarma2012OscillationsInMapkCascadeS2(biosim.BioModule):
    """BioModule wrapper for SBML model: Sarma2012 - Oscillations in MAPK cascade (S2)."""

    def __init__(self, model_path: str = "data/BIOMD0000000441.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Sarma2012OscillationsInMapkCascadeS2Biomd0000000441Model = SbmlSarma2012OscillationsInMapkCascadeS2

...
"""Auto-generated SBML BioModule wrapper for Gosselin2025 - Ecoli_bioproduction_sensitive.

Source: biomodels_ebi:MODEL2506160002
Original: https://www.ebi.ac.uk/biomodels/MODEL2506160002
"""
...
class SbmlGosselin2025EcoliBioproductionSensitive(biosim.BioModule):
    """BioModule wrapper for SBML model: Gosselin2025 - Ecoli_bioproduction_sensitive."""

    def __init__(self, model_path: str = "data/MODEL2506160002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Gosselin2025EcoliBioproductionSensitiveModel2506160002Model = SbmlGosselin2025EcoliBioproductionSensitive

...
"""Auto-generated SBML BioModule wrapper for Goldbeter1991 - Min Mit Oscil.

Source: biomodels_ebi:BIOMD0000000003
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000003
"""
...
class SbmlGoldbeter1991MinMitOscil(biosim.BioModule):
    """BioModule wrapper for SBML model: Goldbeter1991 - Min Mit Oscil."""

    def __init__(self, model_path: str = "data/BIOMD0000000003.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Goldbeter1991MinMitOscilBiomd0000000003Model = SbmlGoldbeter1991MinMitOscil

...
"""Auto-generated SBML BioModule wrapper for PetelenzKuehn_osmoadaptation_fps1D1.

Source: biomodels_ebi:BIOMD0000000607
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000607
"""
...
class SbmlPetelenzkuehnOsmoadaptationFps1d1(biosim.BioModule):
    """BioModule wrapper for SBML model: PetelenzKuehn_osmoadaptation_fps1D1."""

    def __init__(self, model_path: str = "data/BIOMD0000000607.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
PetelenzkuehnOsmoadaptationFps1d1Biomd0000000607Model = SbmlPetelenzkuehnOsmoadaptationFps1d1

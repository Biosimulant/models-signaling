...
"""Auto-generated SBML BioModule wrapper for Borisov2009_EGF_Insulin_Crosstalk.

Source: biomodels_ebi:BIOMD0000000223
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000223
"""
...
class SbmlBorisov2009EgfInsulinCrosstalk(biosim.BioModule):
    """BioModule wrapper for SBML model: Borisov2009_EGF_Insulin_Crosstalk."""

    def __init__(self, model_path: str = "data/BIOMD0000000223.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Borisov2009EgfInsulinCrosstalkBiomd0000000223Model = SbmlBorisov2009EgfInsulinCrosstalk

...
"""Auto-generated SBML BioModule wrapper for Dasgupta2020 - Reduced model of receptor clusturing and aggregation.

Source: biomodels_ebi:BIOMD0000000973
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000973
"""
...
class SbmlDasgupta2020ReducedModelOfReceptorClusturingAnd(biosim.BioModule):
    """BioModule wrapper for SBML model: Dasgupta2020 - Reduced model of receptor clusturing and aggregation."""

    def __init__(self, model_path: str = "data/BIOMD0000000973.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Dasgupta2020ReducedModelOfReceptorClusturinBiomd0000000973Model = SbmlDasgupta2020ReducedModelOfReceptorClusturingAnd

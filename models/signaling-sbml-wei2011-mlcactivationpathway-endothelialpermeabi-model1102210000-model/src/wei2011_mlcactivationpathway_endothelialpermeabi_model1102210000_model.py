...
"""Auto-generated SBML BioModule wrapper for Wei2011_MLCactivationPathway_EndothelialPermeability.

Source: biomodels_ebi:MODEL1102210000
Original: https://www.ebi.ac.uk/biomodels/MODEL1102210000
"""
...
class SbmlWei2011MlcactivationpathwayEndothelialpermeability(biosim.BioModule):
    """BioModule wrapper for SBML model: Wei2011_MLCactivationPathway_EndothelialPermeability."""

    def __init__(self, model_path: str = "data/MODEL1102210000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Wei2011MlcactivationpathwayEndothelialpermeabiModel1102210000Model = SbmlWei2011MlcactivationpathwayEndothelialpermeability

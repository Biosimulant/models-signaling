...
"""Auto-generated SBML BioModule wrapper for Sarma2012 - Interaction topologies of MAPK cascade (M1_K1_PSEQ).

Source: biomodels_ebi:MODEL1204280005
Original: https://www.ebi.ac.uk/biomodels/MODEL1204280005
"""
...
class SbmlSarma2012InteractionTopologiesOfMapkCascadeM1K1Pseq(biosim.BioModule):
    """BioModule wrapper for SBML model: Sarma2012 - Interaction topologies of MAPK cascade (M1_K1_PSEQ)."""

    def __init__(self, model_path: str = "data/MODEL1204280005.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Sarma2012InteractionTopologiesOfMapkCascadeModel1204280005Model = SbmlSarma2012InteractionTopologiesOfMapkCascadeM1K1Pseq

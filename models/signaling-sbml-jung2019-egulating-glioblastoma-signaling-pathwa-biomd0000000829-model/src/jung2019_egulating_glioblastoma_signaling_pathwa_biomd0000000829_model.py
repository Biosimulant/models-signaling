...
"""Auto-generated SBML BioModule wrapper for Jung2019 - egulating glioblastoma signaling pathways and anti-invasion therapy cell cycle dynamics model.

Source: biomodels_ebi:BIOMD0000000829
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000829
"""
...
class SbmlJung2019EgulatingGlioblastomaSignalingPathwaysAndAnti(biosim.BioModule):
    """BioModule wrapper for SBML model: Jung2019 - egulating glioblastoma signaling pathways and anti-invasion therapy cell cycle dynamics model."""

    def __init__(self, model_path: str = "data/BIOMD0000000829.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Jung2019EgulatingGlioblastomaSignalingPathwaBiomd0000000829Model = SbmlJung2019EgulatingGlioblastomaSignalingPathwaysAndAnti

...
"""Auto-generated SBML BioModule wrapper for Martinez-Guimera2017 - Generic redox signalling model with negative feedback regulation (Model 2).

Source: biomodels_ebi:MODEL2001080001
Original: https://www.ebi.ac.uk/biomodels/MODEL2001080001
"""
...
class SbmlMartinezGuimera2017GenericRedoxSignallingModelWith3(biosim.BioModule):
    """BioModule wrapper for SBML model: Martinez-Guimera2017 - Generic redox signalling model with negative feedback regulation (Model 2)."""

    def __init__(self, model_path: str = "data/MODEL2001080001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
MartinezGuimera2017GenericRedoxSignallingMoModel2001080001Model = SbmlMartinezGuimera2017GenericRedoxSignallingModelWith3

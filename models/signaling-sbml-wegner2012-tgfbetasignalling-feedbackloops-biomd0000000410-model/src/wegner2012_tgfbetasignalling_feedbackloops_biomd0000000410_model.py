...
"""Auto-generated SBML BioModule wrapper for Wegner2012_TGFbetaSignalling_FeedbackLoops.

Source: biomodels_ebi:BIOMD0000000410
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000410
"""
...
class SbmlWegner2012TgfbetasignallingFeedbackloops(biosim.BioModule):
    """BioModule wrapper for SBML model: Wegner2012_TGFbetaSignalling_FeedbackLoops."""

    def __init__(self, model_path: str = "data/BIOMD0000000410.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Wegner2012TgfbetasignallingFeedbackloopsBiomd0000000410Model = SbmlWegner2012TgfbetasignallingFeedbackloops

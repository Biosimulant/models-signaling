...
"""Auto-generated SBML BioModule wrapper for Chen2009 - ErbB Signaling.

Source: biomodels_ebi:BIOMD0000000255
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000255
"""
...
class SbmlChen2009ErbbSignaling(biosim.BioModule):
    """BioModule wrapper for SBML model: Chen2009 - ErbB Signaling."""

    def __init__(self, model_path: str = "data/BIOMD0000000255.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Chen2009ErbbSignalingBiomd0000000255Model = SbmlChen2009ErbbSignaling

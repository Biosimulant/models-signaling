...
"""Auto-generated SBML BioModule wrapper for Fujita2010_Akt_Signalling_NGF.

Source: biomodels_ebi:BIOMD0000000263
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000263
"""
...
class SbmlFujita2010AktSignallingNgf(biosim.BioModule):
    """BioModule wrapper for SBML model: Fujita2010_Akt_Signalling_NGF."""

    def __init__(self, model_path: str = "data/BIOMD0000000263.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Fujita2010AktSignallingNgfBiomd0000000263Model = SbmlFujita2010AktSignallingNgf

...
"""Auto-generated SBML BioModule wrapper for Yugi2014 - Insulin induced signalling (PFKL phosphorylation) - model 2.

Source: biomodels_ebi:BIOMD0000000541
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000541
"""
...
class SbmlYugi2014InsulinInducedSignallingPfklPhosphorylation2(biosim.BioModule):
    """BioModule wrapper for SBML model: Yugi2014 - Insulin induced signalling (PFKL phosphorylation) - model 2."""

    def __init__(self, model_path: str = "data/BIOMD0000000541.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Yugi2014InsulinInducedSignallingPfklPhosphoBiomd0000000541Model = SbmlYugi2014InsulinInducedSignallingPfklPhosphorylation2

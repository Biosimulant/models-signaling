...
"""Auto-generated SBML BioModule wrapper for Perrett2014 - GnRH pulse, ERK activity.

Source: biomodels_ebi:MODEL1509050002
Original: https://www.ebi.ac.uk/biomodels/MODEL1509050002
"""
...
class SbmlPerrett2014GnrhPulseErkActivity(biosim.BioModule):
    """BioModule wrapper for SBML model: Perrett2014 - GnRH pulse, ERK activity."""

    def __init__(self, model_path: str = "data/MODEL1509050002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Perrett2014GnrhPulseErkActivityModel1509050002Model = SbmlPerrett2014GnrhPulseErkActivity

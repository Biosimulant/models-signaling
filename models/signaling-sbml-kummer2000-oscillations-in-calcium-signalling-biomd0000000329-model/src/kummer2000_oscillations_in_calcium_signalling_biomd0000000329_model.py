...
"""Auto-generated SBML BioModule wrapper for Kummer2000 - Oscillations in Calcium Signalling.

Source: biomodels_ebi:BIOMD0000000329
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000329
"""
...
class SbmlKummer2000OscillationsInCalciumSignalling(biosim.BioModule):
    """BioModule wrapper for SBML model: Kummer2000 - Oscillations in Calcium Signalling."""

    def __init__(self, model_path: str = "data/BIOMD0000000329.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Kummer2000OscillationsInCalciumSignallingBiomd0000000329Model = SbmlKummer2000OscillationsInCalciumSignalling

...
"""Tellurium-backed SBML wrapper for Sarma2012 - Oscillations in MAPK cascade (S2)."""
...
class Sarma2012OscillationsInMapkCascadeS2Model(TelluriumSBMLBioModule):
    """Faithful Tellurium execution of the bundled SBML source model."""

    _SBML_ID = 'BIOMD0000000441'
    _TITLE = 'Sarma2012 - Oscillations in MAPK cascade (S2)'
    ...
    def __init__(self, model_path: str = 'data/BIOMD0000000441.xml', integration_step: float = 0.01) -> None:
        super().__init__(model_path=model_path, integration_step=integration_step)


Sarma2012OscillationsInMapkCascadeS2Biomd0000000441Model = Sarma2012OscillationsInMapkCascadeS2Model

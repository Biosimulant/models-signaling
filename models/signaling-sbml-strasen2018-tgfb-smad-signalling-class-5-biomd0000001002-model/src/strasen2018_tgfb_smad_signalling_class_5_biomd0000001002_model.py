...
"""Auto-generated SBML BioModule wrapper for Strasen2018 - TGFb SMAD Signalling Class 5.

Source: biomodels_ebi:BIOMD0000001002
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000001002
"""
...
class SbmlStrasen2018TgfbSmadSignallingClass5(biosim.BioModule):
    """BioModule wrapper for SBML model: Strasen2018 - TGFb SMAD Signalling Class 5."""

    def __init__(self, model_path: str = "data/BIOMD0000001002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Strasen2018TgfbSmadSignallingClass5Biomd0000001002Model = SbmlStrasen2018TgfbSmadSignallingClass5

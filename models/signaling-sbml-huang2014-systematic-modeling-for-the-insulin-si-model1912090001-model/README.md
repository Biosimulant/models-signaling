...
**Source**: [biomodels_ebi](https://www.ebi.ac.uk/biomodels/MODEL1912090001)
**Standard**: sbml
**Authors**: Can Huang; Ming Wu; Jun Du; Di Liu; Christina Chan
...
models:
  - path: ../../models/signaling-sbml-huang2014-systematic-modeling-for-the-insulin-si-model1912090001-model
    alias: model
```

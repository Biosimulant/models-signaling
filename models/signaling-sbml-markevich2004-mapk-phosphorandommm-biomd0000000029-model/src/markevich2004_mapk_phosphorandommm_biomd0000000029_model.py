...
"""Auto-generated SBML BioModule wrapper for Markevich2004_MAPK_phosphoRandomMM.

Source: biomodels_ebi:BIOMD0000000029
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000029
"""
...
class SbmlMarkevich2004MapkPhosphorandommm(biosim.BioModule):
    """BioModule wrapper for SBML model: Markevich2004_MAPK_phosphoRandomMM."""

    def __init__(self, model_path: str = "data/BIOMD0000000029.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Markevich2004MapkPhosphorandommmBiomd0000000029Model = SbmlMarkevich2004MapkPhosphorandommm

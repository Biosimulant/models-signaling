...
"""Auto-generated SBML BioModule wrapper for Chang2008 - ERK activation, hallucinogenic drugs mediated signalling through serotonin receptors.

Source: biomodels_ebi:MODEL0975191032
Original: https://www.ebi.ac.uk/biomodels/MODEL0975191032
"""
...
class SbmlChang2008ErkActivationHallucinogenicDrugsMediated(biosim.BioModule):
    """BioModule wrapper for SBML model: Chang2008 - ERK activation, hallucinogenic drugs mediated signalling through serotonin receptors."""

    def __init__(self, model_path: str = "data/MODEL0975191032.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Chang2008ErkActivationHallucinogenicDrugsMeModel0975191032Model = SbmlChang2008ErkActivationHallucinogenicDrugsMediated

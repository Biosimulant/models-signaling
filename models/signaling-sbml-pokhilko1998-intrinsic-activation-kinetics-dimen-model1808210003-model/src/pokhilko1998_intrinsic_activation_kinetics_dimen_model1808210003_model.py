...
"""Auto-generated SBML BioModule wrapper for Pokhilko1998 - Intrinsic Activation Kinetics (Dimensional Model).

Source: biomodels_ebi:MODEL1808210003
Original: https://www.ebi.ac.uk/biomodels/MODEL1808210003
"""
...
class SbmlPokhilko1998IntrinsicActivationKineticsDimensionalModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Pokhilko1998 - Intrinsic Activation Kinetics (Dimensional Model)."""

    def __init__(self, model_path: str = "data/MODEL1808210003.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Pokhilko1998IntrinsicActivationKineticsDimenModel1808210003Model = SbmlPokhilko1998IntrinsicActivationKineticsDimensionalModel

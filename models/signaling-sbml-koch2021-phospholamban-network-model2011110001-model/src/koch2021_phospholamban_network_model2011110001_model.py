...
"""Auto-generated SBML BioModule wrapper for Koch2021 - Phospholamban_network.

Source: biomodels_ebi:MODEL2011110001
Original: https://www.ebi.ac.uk/biomodels/MODEL2011110001
"""
...
class SbmlKoch2021PhospholambanNetwork(biosim.BioModule):
    """BioModule wrapper for SBML model: Koch2021 - Phospholamban_network."""

    def __init__(self, model_path: str = "data/MODEL2011110001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Koch2021PhospholambanNetworkModel2011110001Model = SbmlKoch2021PhospholambanNetwork

...
"""Auto-generated SBML BioModule wrapper for Sarma2012 - Interaction topologies of MAPK cascade (M4_K1_USEQ).

Source: biomodels_ebi:MODEL1204280004
Original: https://www.ebi.ac.uk/biomodels/MODEL1204280004
"""
...
class SbmlSarma2012InteractionTopologiesOfMapkCascadeM4K1Useq(biosim.BioModule):
    """BioModule wrapper for SBML model: Sarma2012 - Interaction topologies of MAPK cascade (M4_K1_USEQ)."""

    def __init__(self, model_path: str = "data/MODEL1204280004.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Sarma2012InteractionTopologiesOfMapkCascadeModel1204280004Model = SbmlSarma2012InteractionTopologiesOfMapkCascadeM4K1Useq

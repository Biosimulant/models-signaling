...
"""Auto-generated SBML BioModule wrapper for Bertram2006_Endothelin.

Source: biomodels_ebi:BIOMD0000000128
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000128
"""
...
class SbmlBertram2006Endothelin(biosim.BioModule):
    """BioModule wrapper for SBML model: Bertram2006_Endothelin."""

    def __init__(self, model_path: str = "data/BIOMD0000000128.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Bertram2006EndothelinBiomd0000000128Model = SbmlBertram2006Endothelin

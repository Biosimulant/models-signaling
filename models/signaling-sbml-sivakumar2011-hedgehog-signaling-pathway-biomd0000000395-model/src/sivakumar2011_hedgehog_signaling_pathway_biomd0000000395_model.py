...
"""Auto-generated SBML BioModule wrapper for Sivakumar2011 - Hedgehog Signaling Pathway.

Source: biomodels_ebi:BIOMD0000000395
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000395
"""
...
class SbmlSivakumar2011HedgehogSignalingPathway(biosim.BioModule):
    """BioModule wrapper for SBML model: Sivakumar2011 - Hedgehog Signaling Pathway."""

    def __init__(self, model_path: str = "data/BIOMD0000000395.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Sivakumar2011HedgehogSignalingPathwayBiomd0000000395Model = SbmlSivakumar2011HedgehogSignalingPathway

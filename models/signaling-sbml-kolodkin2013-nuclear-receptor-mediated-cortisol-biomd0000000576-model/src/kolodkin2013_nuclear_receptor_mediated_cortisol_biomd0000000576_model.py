...
"""Auto-generated SBML BioModule wrapper for Kolodkin2013 - Nuclear receptor-mediated cortisol signalling network.

Source: biomodels_ebi:BIOMD0000000576
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000576
"""
...
class SbmlKolodkin2013NuclearReceptorMediatedCortisolSignalling(biosim.BioModule):
    """BioModule wrapper for SBML model: Kolodkin2013 - Nuclear receptor-mediated cortisol signalling network."""

    def __init__(self, model_path: str = "data/BIOMD0000000576.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Kolodkin2013NuclearReceptorMediatedCortisolBiomd0000000576Model = SbmlKolodkin2013NuclearReceptorMediatedCortisolSignalling

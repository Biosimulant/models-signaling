...
"""Auto-generated SBML BioModule wrapper for Thiaville2016 - Wild type folate pathway model with proposed PanB reaction.

Source: biomodels_ebi:BIOMD0000000639
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000639
"""
...
class SbmlThiaville2016WildTypeFolatePathwayModelWithProposed(biosim.BioModule):
    """BioModule wrapper for SBML model: Thiaville2016 - Wild type folate pathway model with proposed PanB reaction."""

    def __init__(self, model_path: str = "data/BIOMD0000000639.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Thiaville2016WildTypeFolatePathwayModelWitBiomd0000000639Model = SbmlThiaville2016WildTypeFolatePathwayModelWithProposed

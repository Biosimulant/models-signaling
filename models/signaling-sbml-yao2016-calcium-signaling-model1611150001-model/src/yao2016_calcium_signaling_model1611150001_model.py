...
"""Auto-generated SBML BioModule wrapper for Yao2016_Calcium_Signaling.

Source: biomodels_ebi:MODEL1611150001
Original: https://www.ebi.ac.uk/biomodels/MODEL1611150001
"""
...
class SbmlYao2016CalciumSignaling(biosim.BioModule):
    """BioModule wrapper for SBML model: Yao2016_Calcium_Signaling."""

    def __init__(self, model_path: str = "data/MODEL1611150001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Yao2016CalciumSignalingModel1611150001Model = SbmlYao2016CalciumSignaling

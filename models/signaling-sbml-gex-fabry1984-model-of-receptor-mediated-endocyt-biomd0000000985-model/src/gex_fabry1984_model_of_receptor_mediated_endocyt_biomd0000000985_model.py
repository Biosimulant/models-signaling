...
"""Auto-generated SBML BioModule wrapper for Gex-Fabry1984 - model of receptor-mediated endocytosis of EGF in BALB/c 3T3 cells.

Source: biomodels_ebi:BIOMD0000000985
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000985
"""
...
class SbmlGexFabry1984ModelOfReceptorMediatedEndocytosisOfEgf(biosim.BioModule):
    """BioModule wrapper for SBML model: Gex-Fabry1984 - model of receptor-mediated endocytosis of EGF in BALB/c 3T3 cells."""

    def __init__(self, model_path: str = "data/BIOMD0000000985.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
GexFabry1984ModelOfReceptorMediatedEndocytBiomd0000000985Model = SbmlGexFabry1984ModelOfReceptorMediatedEndocytosisOfEgf

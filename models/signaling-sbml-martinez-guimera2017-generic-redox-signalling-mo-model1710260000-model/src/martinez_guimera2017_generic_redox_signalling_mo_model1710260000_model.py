...
"""Auto-generated SBML BioModule wrapper for Martinez-Guimera2017 - Generic redox signalling model without negative regulation (Model 1).

Source: biomodels_ebi:MODEL1710260000
Original: https://www.ebi.ac.uk/biomodels/MODEL1710260000
"""
...
class SbmlMartinezGuimera2017GenericRedoxSignallingModelWithout(biosim.BioModule):
    """BioModule wrapper for SBML model: Martinez-Guimera2017 - Generic redox signalling model without negative regulation (Model 1)."""

    def __init__(self, model_path: str = "data/MODEL1710260000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
MartinezGuimera2017GenericRedoxSignallingMoModel1710260000Model = SbmlMartinezGuimera2017GenericRedoxSignallingModelWithout

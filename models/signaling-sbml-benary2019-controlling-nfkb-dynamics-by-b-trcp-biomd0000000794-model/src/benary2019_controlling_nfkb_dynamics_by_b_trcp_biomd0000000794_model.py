...
"""Auto-generated SBML BioModule wrapper for Benary2019 - Controlling NFKB dynamics by B-TrCP.

Source: biomodels_ebi:BIOMD0000000794
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000794
"""
...
class SbmlBenary2019ControllingNfkbDynamicsByBTrcp(biosim.BioModule):
    """BioModule wrapper for SBML model: Benary2019 - Controlling NFKB dynamics by B-TrCP."""

    def __init__(self, model_path: str = "data/BIOMD0000000794.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Benary2019ControllingNfkbDynamicsByBTrcpBiomd0000000794Model = SbmlBenary2019ControllingNfkbDynamicsByBTrcp

...
"""Auto-generated SBML BioModule wrapper for Yan2012 - Rb-E2F pathway dynamics with miR449.

Source: biomodels_ebi:BIOMD0000000720
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000720
"""
...
class SbmlYan2012RbE2fPathwayDynamicsWithMir449(biosim.BioModule):
    """BioModule wrapper for SBML model: Yan2012 - Rb-E2F pathway dynamics with miR449."""

    def __init__(self, model_path: str = "data/BIOMD0000000720.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Yan2012RbE2fPathwayDynamicsWithMir449Biomd0000000720Model = SbmlYan2012RbE2fPathwayDynamicsWithMir449

...
"""Auto-generated SBML BioModule wrapper for Schoeberl2002 - EGF MAPK.

Source: biomodels_ebi:BIOMD0000000019
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000019
"""
...
class SbmlSchoeberl2002EgfMapk(biosim.BioModule):
    """BioModule wrapper for SBML model: Schoeberl2002 - EGF MAPK."""

    def __init__(self, model_path: str = "data/BIOMD0000000019.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Schoeberl2002EgfMapkBiomd0000000019Model = SbmlSchoeberl2002EgfMapk

...
"""Auto-generated SBML BioModule wrapper for Hingant2014 - Micellar On-Pathway Intermediate in Prion Amyloid Formation.

Source: biomodels_ebi:MODEL1409230001
Original: https://www.ebi.ac.uk/biomodels/MODEL1409230001
"""
...
class SbmlHingant2014MicellarOnPathwayIntermediateInPrion(biosim.BioModule):
    """BioModule wrapper for SBML model: Hingant2014 - Micellar On-Pathway Intermediate in Prion Amyloid Formation."""

    def __init__(self, model_path: str = "data/MODEL1409230001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Hingant2014MicellarOnPathwayIntermediateInModel1409230001Model = SbmlHingant2014MicellarOnPathwayIntermediateInPrion

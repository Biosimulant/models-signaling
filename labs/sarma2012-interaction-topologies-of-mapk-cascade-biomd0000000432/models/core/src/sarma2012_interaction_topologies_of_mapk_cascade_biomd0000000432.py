...
"""Tellurium-backed SBML wrapper for Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_USEQ)."""
...
class Sarma2012InteractionTopologiesOfMapkCascadeBiomd0000000432Model(TelluriumSBMLBioModule):
    """Faithful Tellurium execution of the bundled SBML source model."""

    _SBML_ID = 'BIOMD0000000432'
    _TITLE = 'Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_USEQ)'
    ...
    def __init__(self, model_path: str = 'data/BIOMD0000000432.xml', integration_step: float = 0.01) -> None:
        super().__init__(model_path=model_path, integration_step=integration_step)


Sarma2012InteractionTopologiesOfMapkCascadeBiomd0000000432Model = Sarma2012InteractionTopologiesOfMapkCascadeBiomd0000000432Model

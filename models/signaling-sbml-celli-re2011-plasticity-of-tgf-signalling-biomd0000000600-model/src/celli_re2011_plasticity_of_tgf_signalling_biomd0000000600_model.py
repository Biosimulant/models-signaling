...
"""Auto-generated SBML BioModule wrapper for Cellière2011 - Plasticity of TGF-β Signalling.

Source: biomodels_ebi:BIOMD0000000600
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000600
"""
...
class SbmlCelliere2011PlasticityOfTgfSignalling(biosim.BioModule):
    """BioModule wrapper for SBML model: Cellière2011 - Plasticity of TGF-β Signalling."""

    def __init__(self, model_path: str = "data/BIOMD0000000600.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
CelliRe2011PlasticityOfTgfSignallingBiomd0000000600Model = SbmlCelliere2011PlasticityOfTgfSignalling

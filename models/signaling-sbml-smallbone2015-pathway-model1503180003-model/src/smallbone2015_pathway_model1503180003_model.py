...
"""Auto-generated SBML BioModule wrapper for Smallbone2015 - pathway.

Source: biomodels_ebi:MODEL1503180003
Original: https://www.ebi.ac.uk/biomodels/MODEL1503180003
"""
...
class SbmlSmallbone2015Pathway(biosim.BioModule):
    """BioModule wrapper for SBML model: Smallbone2015 - pathway."""

    def __init__(self, model_path: str = "data/MODEL1503180003.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Smallbone2015PathwayModel1503180003Model = SbmlSmallbone2015Pathway

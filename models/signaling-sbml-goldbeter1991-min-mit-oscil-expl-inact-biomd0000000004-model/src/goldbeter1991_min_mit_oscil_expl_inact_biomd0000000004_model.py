...
"""Auto-generated SBML BioModule wrapper for Goldbeter1991 - Min Mit Oscil, Expl Inact.

Source: biomodels_ebi:BIOMD0000000004
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000004
"""
...
class SbmlGoldbeter1991MinMitOscilExplInact(biosim.BioModule):
    """BioModule wrapper for SBML model: Goldbeter1991 - Min Mit Oscil, Expl Inact."""

    def __init__(self, model_path: str = "data/BIOMD0000000004.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Goldbeter1991MinMitOscilExplInactBiomd0000000004Model = SbmlGoldbeter1991MinMitOscilExplInact

...
"""Tellurium-backed SBML wrapper for Heberle-Razquin Navas-2019 - PI3K-MAPK/p38-mTOR Model V."""
...
class HeberleRazquinNavas2019Pi3kMapkP38MtorMoModel(TelluriumSBMLBioModule):
    """Faithful Tellurium execution of the bundled SBML source model."""

    _SBML_ID = 'MODEL1902140002'
    _TITLE = 'Heberle-Razquin Navas-2019 - PI3K-MAPK/p38-mTOR Model V'
    ...
    def __init__(self, model_path: str = 'data/MODEL1902140002.xml', integration_step: float = 0.01) -> None:
        super().__init__(model_path=model_path, integration_step=integration_step)


HeberleRazquinNavas2019Pi3kMapkP38MtorMoModel1902140002Model = HeberleRazquinNavas2019Pi3kMapkP38MtorMoModel

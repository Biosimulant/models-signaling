...
"""Auto-generated SBML BioModule wrapper for Wanant2000_InsulinReceptorModel_B.

Source: biomodels_ebi:MODEL1201140006
Original: https://www.ebi.ac.uk/biomodels/MODEL1201140006
"""
...
class SbmlWanant2000InsulinreceptormodelB(biosim.BioModule):
    """BioModule wrapper for SBML model: Wanant2000_InsulinReceptorModel_B."""

    def __init__(self, model_path: str = "data/MODEL1201140006.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Wanant2000InsulinreceptormodelBModel1201140006Model = SbmlWanant2000InsulinreceptormodelB

...
"""Auto-generated SBML BioModule wrapper for Sarma2012 - Interaction topologies of MAPK cascade (M1_K2_QSS_USEQ).

Source: biomodels_ebi:MODEL1204280033
Original: https://www.ebi.ac.uk/biomodels/MODEL1204280033
"""
...
class SbmlSarma2012InteractionTopologiesOfMapkCascadeM1K2Qss2(biosim.BioModule):
    """BioModule wrapper for SBML model: Sarma2012 - Interaction topologies of MAPK cascade (M1_K2_QSS_USEQ)."""

    def __init__(self, model_path: str = "data/MODEL1204280033.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Sarma2012InteractionTopologiesOfMapkCascadeModel1204280033Model = SbmlSarma2012InteractionTopologiesOfMapkCascadeM1K2Qss2

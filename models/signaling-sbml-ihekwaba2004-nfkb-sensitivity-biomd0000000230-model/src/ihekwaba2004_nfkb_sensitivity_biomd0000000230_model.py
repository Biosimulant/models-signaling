...
"""Auto-generated SBML BioModule wrapper for Ihekwaba2004_NFkB_Sensitivity.

Source: biomodels_ebi:BIOMD0000000230
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000230
"""
...
class SbmlIhekwaba2004NfkbSensitivity(biosim.BioModule):
    """BioModule wrapper for SBML model: Ihekwaba2004_NFkB_Sensitivity."""

    def __init__(self, model_path: str = "data/BIOMD0000000230.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Ihekwaba2004NfkbSensitivityBiomd0000000230Model = SbmlIhekwaba2004NfkbSensitivity

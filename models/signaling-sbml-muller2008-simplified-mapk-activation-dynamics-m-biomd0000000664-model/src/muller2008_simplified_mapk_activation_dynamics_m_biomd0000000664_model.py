...
"""Auto-generated SBML BioModule wrapper for Muller2008 - Simplified MAPK activation Dynamics (Model B).

Source: biomodels_ebi:BIOMD0000000664
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000664
"""
...
class SbmlMuller2008SimplifiedMapkActivationDynamicsModelB(biosim.BioModule):
    """BioModule wrapper for SBML model: Muller2008 - Simplified MAPK activation Dynamics (Model B)."""

    def __init__(self, model_path: str = "data/BIOMD0000000664.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Muller2008SimplifiedMapkActivationDynamicsMBiomd0000000664Model = SbmlMuller2008SimplifiedMapkActivationDynamicsModelB

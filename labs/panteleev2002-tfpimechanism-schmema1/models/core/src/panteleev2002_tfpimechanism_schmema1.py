...
"""Tellurium-backed SBML wrapper for Panteleev2002_TFPImechanism_schmema1."""
...
class Panteleev2002TfpimechanismSchmema1Model(TelluriumSBMLBioModule):
    """Faithful Tellurium execution of the bundled SBML source model."""

    _SBML_ID = 'BIOMD0000000361'
    _TITLE = 'Panteleev2002_TFPImechanism_schmema1'
    ...
    def __init__(self, model_path: str = 'data/BIOMD0000000361.xml', integration_step: float = 0.01) -> None:
        super().__init__(model_path=model_path, integration_step=integration_step)


Panteleev2002TfpimechanismSchmema1Biomd0000000361Model = Panteleev2002TfpimechanismSchmema1Model

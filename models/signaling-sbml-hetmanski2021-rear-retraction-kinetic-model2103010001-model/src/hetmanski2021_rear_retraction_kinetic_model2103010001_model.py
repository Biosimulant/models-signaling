...
"""Auto-generated SBML BioModule wrapper for Hetmanski2021 rear retraction kinetic.

Source: biomodels_ebi:MODEL2103010001
Original: https://www.ebi.ac.uk/biomodels/MODEL2103010001
"""
...
class SbmlHetmanski2021RearRetractionKinetic(biosim.BioModule):
    """BioModule wrapper for SBML model: Hetmanski2021 rear retraction kinetic."""

    def __init__(self, model_path: str = "data/MODEL2103010001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Hetmanski2021RearRetractionKineticModel2103010001Model = SbmlHetmanski2021RearRetractionKinetic

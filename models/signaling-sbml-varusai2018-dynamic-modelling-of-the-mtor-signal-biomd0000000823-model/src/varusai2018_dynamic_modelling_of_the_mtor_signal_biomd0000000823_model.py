...
"""Auto-generated SBML BioModule wrapper for Varusai2018 - Dynamic modelling of the mTOR signalling network reveals complex emergent behaviours conferred by DEPTOR.

Source: biomodels_ebi:BIOMD0000000823
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000823
"""
...
class SbmlVarusai2018DynamicModellingOfTheMtorSignalling(biosim.BioModule):
    """BioModule wrapper for SBML model: Varusai2018 - Dynamic modelling of the mTOR signalling network reveals complex emergent behaviours conferred by DEPTOR."""

    def __init__(self, model_path: str = "data/BIOMD0000000823.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Varusai2018DynamicModellingOfTheMtorSignalBiomd0000000823Model = SbmlVarusai2018DynamicModellingOfTheMtorSignalling

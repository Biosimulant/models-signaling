...
"""Auto-generated SBML BioModule wrapper for Brannmark2010_InsulinSignalling_Mifamodel.

Source: biomodels_ebi:BIOMD0000000343
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000343
"""
...
class SbmlBrannmark2010InsulinsignallingMifamodel(biosim.BioModule):
    """BioModule wrapper for SBML model: Brannmark2010_InsulinSignalling_Mifamodel."""

    def __init__(self, model_path: str = "data/BIOMD0000000343.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Brannmark2010InsulinsignallingMifamodelBiomd0000000343Model = SbmlBrannmark2010InsulinsignallingMifamodel

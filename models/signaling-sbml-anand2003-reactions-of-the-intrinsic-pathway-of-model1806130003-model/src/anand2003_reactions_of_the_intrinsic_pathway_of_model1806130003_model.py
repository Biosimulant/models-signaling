...
"""Auto-generated SBML BioModule wrapper for Anand2003 - Reactions of the Intrinsic Pathway of Blood Coagulation with Platelet Activation.

Source: biomodels_ebi:MODEL1806130003
Original: https://www.ebi.ac.uk/biomodels/MODEL1806130003
"""
...
class SbmlAnand2003ReactionsOfTheIntrinsicPathwayOfBlood(biosim.BioModule):
    """BioModule wrapper for SBML model: Anand2003 - Reactions of the Intrinsic Pathway of Blood Coagulation with Platelet Activation."""

    def __init__(self, model_path: str = "data/MODEL1806130003.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Anand2003ReactionsOfTheIntrinsicPathwayOfModel1806130003Model = SbmlAnand2003ReactionsOfTheIntrinsicPathwayOfBlood

...
"""Tellurium-backed SBML wrapper for Padala2017- ERK, PI3K/Akt and Wnt signalling network (normal)."""
...
class Padala2017ErkPi3kAktAndWntSignallingNetwoModel(TelluriumSBMLBioModule):
    """Faithful Tellurium execution of the bundled SBML source model."""

    _SBML_ID = 'BIOMD0000000648'
    _TITLE = 'Padala2017- ERK, PI3K/Akt and Wnt signalling network (normal)'
    ...
    def __init__(self, model_path: str = 'data/BIOMD0000000648.xml', integration_step: float = 0.01) -> None:
        super().__init__(model_path=model_path, integration_step=integration_step)


Padala2017ErkPi3kAktAndWntSignallingNetwoBiomd0000000648Model = Padala2017ErkPi3kAktAndWntSignallingNetwoModel

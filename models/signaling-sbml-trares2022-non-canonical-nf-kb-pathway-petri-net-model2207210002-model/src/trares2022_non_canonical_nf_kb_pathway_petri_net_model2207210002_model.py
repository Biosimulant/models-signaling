...
"""Auto-generated SBML BioModule wrapper for Trares2022 - Non-canonical NF-kB pathway, Petri net.

Source: biomodels_ebi:MODEL2207210002
Original: https://www.ebi.ac.uk/biomodels/MODEL2207210002
"""
...
class SbmlTrares2022NonCanonicalNfKbPathwayPetriNet(biosim.BioModule):
    """BioModule wrapper for SBML model: Trares2022 - Non-canonical NF-kB pathway, Petri net."""

    def __init__(self, model_path: str = "data/MODEL2207210002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Trares2022NonCanonicalNfKbPathwayPetriNetModel2207210002Model = SbmlTrares2022NonCanonicalNfKbPathwayPetriNet

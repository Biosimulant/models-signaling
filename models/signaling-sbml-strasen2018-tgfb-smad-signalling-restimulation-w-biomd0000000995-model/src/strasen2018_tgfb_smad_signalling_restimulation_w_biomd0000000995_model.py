...
"""Auto-generated SBML BioModule wrapper for Strasen2018 - TGFb SMAD Signalling - Restimulation with 5pM TGFb at 8hr.

Source: biomodels_ebi:BIOMD0000000995
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000995
"""
...
class SbmlStrasen2018TgfbSmadSignallingRestimulationWith5pm2(biosim.BioModule):
    """BioModule wrapper for SBML model: Strasen2018 - TGFb SMAD Signalling - Restimulation with 5pM TGFb at 8hr."""

    def __init__(self, model_path: str = "data/BIOMD0000000995.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Strasen2018TgfbSmadSignallingRestimulationWBiomd0000000995Model = SbmlStrasen2018TgfbSmadSignallingRestimulationWith5pm2

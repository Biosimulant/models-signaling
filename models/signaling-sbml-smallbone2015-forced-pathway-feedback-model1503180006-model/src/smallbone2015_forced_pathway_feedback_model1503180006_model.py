...
"""Auto-generated SBML BioModule wrapper for Smallbone2015 - forced pathway feedback.

Source: biomodels_ebi:MODEL1503180006
Original: https://www.ebi.ac.uk/biomodels/MODEL1503180006
"""
...
class SbmlSmallbone2015ForcedPathwayFeedback(biosim.BioModule):
    """BioModule wrapper for SBML model: Smallbone2015 - forced pathway feedback."""

    def __init__(self, model_path: str = "data/MODEL1503180006.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Smallbone2015ForcedPathwayFeedbackModel1503180006Model = SbmlSmallbone2015ForcedPathwayFeedback

...
"""Tellurium-backed SBML wrapper for Benary2019 - Controlling NFKB dynamics by B-TrCP."""
...
class Benary2019ControllingNfkbDynamicsByBTrcpModel(TelluriumSBMLBioModule):
    """Faithful Tellurium execution of the bundled SBML source model."""

    _SBML_ID = 'BIOMD0000000794'
    _TITLE = 'Benary2019 - Controlling NFKB dynamics by B-TrCP'
    ...
    def __init__(self, model_path: str = 'data/BIOMD0000000794.xml', integration_step: float = 0.01) -> None:
        super().__init__(model_path=model_path, integration_step=integration_step)


Benary2019ControllingNfkbDynamicsByBTrcpBiomd0000000794Model = Benary2019ControllingNfkbDynamicsByBTrcpModel

...
"""Auto-generated SBML BioModule wrapper for Brännmark2013 - Insulin signalling in human adipocytes (normal condition).

Source: biomodels_ebi:BIOMD0000000448
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000448
"""
...
class SbmlBrannmark2013InsulinSignallingInHumanAdipocytesNormal(biosim.BioModule):
    """BioModule wrapper for SBML model: Brännmark2013 - Insulin signalling in human adipocytes (normal condition)."""

    def __init__(self, model_path: str = "data/BIOMD0000000448.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
BrNnmark2013InsulinSignallingInHumanAdipocBiomd0000000448Model = SbmlBrannmark2013InsulinSignallingInHumanAdipocytesNormal

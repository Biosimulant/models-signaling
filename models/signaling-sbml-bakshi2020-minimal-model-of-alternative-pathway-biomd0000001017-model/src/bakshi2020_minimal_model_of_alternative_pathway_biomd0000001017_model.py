...
"""Auto-generated SBML BioModule wrapper for Bakshi2020 - Minimal model of alternative pathway of complement system.

Source: biomodels_ebi:BIOMD0000001017
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000001017
"""
...
class SbmlBakshi2020MinimalModelOfAlternativePathwayOf(biosim.BioModule):
    """BioModule wrapper for SBML model: Bakshi2020 - Minimal model of alternative pathway of complement system."""

    def __init__(self, model_path: str = "data/BIOMD0000001017.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Bakshi2020MinimalModelOfAlternativePathwayBiomd0000001017Model = SbmlBakshi2020MinimalModelOfAlternativePathwayOf

...
"""Auto-generated SBML BioModule wrapper for Yapo2017- cAMP/PKA signalling in D1 dopamine receptor expressing medium-spiny neurons.

Source: biomodels_ebi:MODEL1701170000
Original: https://www.ebi.ac.uk/biomodels/MODEL1701170000
"""
...
class SbmlYapo2017CampPkaSignallingInD1DopamineReceptor(biosim.BioModule):
    """BioModule wrapper for SBML model: Yapo2017- cAMP/PKA signalling in D1 dopamine receptor expressing medium-spiny neurons."""

    def __init__(self, model_path: str = "data/MODEL1701170000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Yapo2017CampPkaSignallingInD1DopamineReceModel1701170000Model = SbmlYapo2017CampPkaSignallingInD1DopamineReceptor

...
"""Auto-generated SBML BioModule wrapper for Bhattacharya2014 - A mathematical model of the sterol regulatory element binding protein 2 cholesterol biosynthesis pathway.

Source: biomodels_ebi:BIOMD0000000890
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000890
"""
...
class SbmlBhattacharya2014AMathematicalModelOfTheSterol(biosim.BioModule):
    """BioModule wrapper for SBML model: Bhattacharya2014 - A mathematical model of the sterol regulatory element binding protein 2 cholesterol biosynthesis pathway."""

    def __init__(self, model_path: str = "data/BIOMD0000000890.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Bhattacharya2014AMathematicalModelOfTheSteBiomd0000000890Model = SbmlBhattacharya2014AMathematicalModelOfTheSterol

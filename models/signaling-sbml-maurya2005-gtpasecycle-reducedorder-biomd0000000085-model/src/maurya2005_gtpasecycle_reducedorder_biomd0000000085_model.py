...
"""Auto-generated SBML BioModule wrapper for Maurya2005_GTPaseCycle_reducedOrder.

Source: biomodels_ebi:BIOMD0000000085
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000085
"""
...
class SbmlMaurya2005GtpasecycleReducedorder(biosim.BioModule):
    """BioModule wrapper for SBML model: Maurya2005_GTPaseCycle_reducedOrder."""

    def __init__(self, model_path: str = "data/BIOMD0000000085.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Maurya2005GtpasecycleReducedorderBiomd0000000085Model = SbmlMaurya2005GtpasecycleReducedorder

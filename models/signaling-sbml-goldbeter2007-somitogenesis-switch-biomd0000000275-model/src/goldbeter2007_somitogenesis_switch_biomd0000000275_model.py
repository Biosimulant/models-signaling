...
"""Auto-generated SBML BioModule wrapper for Goldbeter2007_Somitogenesis_Switch.

Source: biomodels_ebi:BIOMD0000000275
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000275
"""
...
class SbmlGoldbeter2007SomitogenesisSwitch(biosim.BioModule):
    """BioModule wrapper for SBML model: Goldbeter2007_Somitogenesis_Switch."""

    def __init__(self, model_path: str = "data/BIOMD0000000275.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Goldbeter2007SomitogenesisSwitchBiomd0000000275Model = SbmlGoldbeter2007SomitogenesisSwitch

...
"""Auto-generated SBML BioModule wrapper for Brown2004 - NGF and EGF signaling.

Source: biomodels_ebi:BIOMD0000000033
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000033
"""
...
class SbmlBrown2004NgfAndEgfSignaling(biosim.BioModule):
    """BioModule wrapper for SBML model: Brown2004 - NGF and EGF signaling."""

    def __init__(self, model_path: str = "data/BIOMD0000000033.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Brown2004NgfAndEgfSignalingBiomd0000000033Model = SbmlBrown2004NgfAndEgfSignaling

...
"""Auto-generated SBML BioModule wrapper for Vaseghi1999_Pentose_PP_yeast.

Source: biomodels_ebi:MODEL1004070001
Original: https://www.ebi.ac.uk/biomodels/MODEL1004070001
"""
...
class SbmlVaseghi1999PentosePpYeast(biosim.BioModule):
    """BioModule wrapper for SBML model: Vaseghi1999_Pentose_PP_yeast."""

    def __init__(self, model_path: str = "data/MODEL1004070001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Vaseghi1999PentosePpYeastModel1004070001Model = SbmlVaseghi1999PentosePpYeast

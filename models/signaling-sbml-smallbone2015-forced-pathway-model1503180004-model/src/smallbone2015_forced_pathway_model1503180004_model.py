...
"""Auto-generated SBML BioModule wrapper for Smallbone2015 - forced pathway.

Source: biomodels_ebi:MODEL1503180004
Original: https://www.ebi.ac.uk/biomodels/MODEL1503180004
"""
...
class SbmlSmallbone2015ForcedPathway(biosim.BioModule):
    """BioModule wrapper for SBML model: Smallbone2015 - forced pathway."""

    def __init__(self, model_path: str = "data/MODEL1503180004.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Smallbone2015ForcedPathwayModel1503180004Model = SbmlSmallbone2015ForcedPathway

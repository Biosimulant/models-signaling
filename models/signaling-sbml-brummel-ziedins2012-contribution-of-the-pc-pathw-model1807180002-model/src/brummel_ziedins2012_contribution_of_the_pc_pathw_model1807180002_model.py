...
"""Auto-generated SBML BioModule wrapper for Brummel-Ziedins2012 - Contribution of the PC pathway to thrombin generation.

Source: biomodels_ebi:MODEL1807180002
Original: https://www.ebi.ac.uk/biomodels/MODEL1807180002
"""
...
class SbmlBrummelZiedins2012ContributionOfThePcPathwayTo(biosim.BioModule):
    """BioModule wrapper for SBML model: Brummel-Ziedins2012 - Contribution of the PC pathway to thrombin generation."""

    def __init__(self, model_path: str = "data/MODEL1807180002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
BrummelZiedins2012ContributionOfThePcPathwModel1807180002Model = SbmlBrummelZiedins2012ContributionOfThePcPathwayTo

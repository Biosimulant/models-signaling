...
"""Auto-generated SBML BioModule wrapper for Becker2010_EpoR_CoreModel.

Source: biomodels_ebi:BIOMD0000000271
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000271
"""
...
class SbmlBecker2010EporCoremodel(biosim.BioModule):
    """BioModule wrapper for SBML model: Becker2010_EpoR_CoreModel."""

    def __init__(self, model_path: str = "data/BIOMD0000000271.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Becker2010EporCoremodelBiomd0000000271Model = SbmlBecker2010EporCoremodel

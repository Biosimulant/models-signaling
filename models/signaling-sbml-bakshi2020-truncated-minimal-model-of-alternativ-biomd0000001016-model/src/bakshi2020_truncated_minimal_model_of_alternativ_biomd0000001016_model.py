...
"""Auto-generated SBML BioModule wrapper for Bakshi2020 - Truncated minimal model of alternative pathway of complement system.

Source: biomodels_ebi:BIOMD0000001016
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000001016
"""
...
class SbmlBakshi2020TruncatedMinimalModelOfAlternativePathway(biosim.BioModule):
    """BioModule wrapper for SBML model: Bakshi2020 - Truncated minimal model of alternative pathway of complement system."""

    def __init__(self, model_path: str = "data/BIOMD0000001016.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Bakshi2020TruncatedMinimalModelOfAlternativBiomd0000001016Model = SbmlBakshi2020TruncatedMinimalModelOfAlternativePathway

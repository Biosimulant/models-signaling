...
"""Auto-generated SBML BioModule wrapper for GonzalezMiranda2013 - The effect of circadian oscillations on biochemical cell signaling by NF-κB.

Source: biomodels_ebi:BIOMD0000000893
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000893
"""
...
class SbmlGonzalezmiranda2013TheEffectOfCircadianOscillationsOn(biosim.BioModule):
    """BioModule wrapper for SBML model: GonzalezMiranda2013 - The effect of circadian oscillations on biochemical cell signaling by NF-κB."""

    def __init__(self, model_path: str = "data/BIOMD0000000893.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Gonzalezmiranda2013TheEffectOfCircadianOsciBiomd0000000893Model = SbmlGonzalezmiranda2013TheEffectOfCircadianOscillationsOn

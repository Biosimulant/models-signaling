...
"""Auto-generated SBML BioModule wrapper for Beard2005_Mitochondrial_Respiration.

Source: biomodels_ebi:MODEL4151491057
Original: https://www.ebi.ac.uk/biomodels/MODEL4151491057
"""
...
class SbmlBeard2005MitochondrialRespiration(biosim.BioModule):
    """BioModule wrapper for SBML model: Beard2005_Mitochondrial_Respiration."""

    def __init__(self, model_path: str = "data/MODEL4151491057.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Beard2005MitochondrialRespirationModel4151491057Model = SbmlBeard2005MitochondrialRespiration

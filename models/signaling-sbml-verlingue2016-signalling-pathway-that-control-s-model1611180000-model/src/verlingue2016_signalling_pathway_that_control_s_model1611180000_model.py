...
"""Auto-generated SBML BioModule wrapper for Verlingue2016 - Signalling pathway that control S-phase entry and geroconversion - Boolean Model.

Source: biomodels_ebi:MODEL1611180000
Original: https://www.ebi.ac.uk/biomodels/MODEL1611180000
"""
...
class SbmlVerlingue2016SignallingPathwayThatControlSPhaseEntry(biosim.BioModule):
    """BioModule wrapper for SBML model: Verlingue2016 - Signalling pathway that control S-phase entry and geroconversion - Boolean Model."""

    def __init__(self, model_path: str = "data/MODEL1611180000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Verlingue2016SignallingPathwayThatControlSModel1611180000Model = SbmlVerlingue2016SignallingPathwayThatControlSPhaseEntry

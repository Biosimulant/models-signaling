...
"""Auto-generated SBML BioModule wrapper for Collier1996 - Delta Notch intercellular signalling and lateral inhibition.

Source: biomodels_ebi:BIOMD0000001047
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000001047
"""
...
class SbmlCollier1996DeltaNotchIntercellularSignallingAnd(biosim.BioModule):
    """BioModule wrapper for SBML model: Collier1996 - Delta Notch intercellular signalling and lateral inhibition."""

    def __init__(self, model_path: str = "data/BIOMD0000001047.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Collier1996DeltaNotchIntercellularSignallingBiomd0000001047Model = SbmlCollier1996DeltaNotchIntercellularSignallingAnd

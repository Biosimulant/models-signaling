...
"""Tellurium-backed SBML wrapper for Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_USEQ)."""
...
class Sarma2012InteractionTopologiesOfMapkCascadeModel(TelluriumSBMLBioModule):
    """Faithful Tellurium execution of the bundled SBML source model."""

    _SBML_ID = 'BIOMD0000000430'
    _TITLE = 'Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_USEQ)'
    ...
    def __init__(self, model_path: str = 'data/BIOMD0000000430.xml', integration_step: float = 0.01) -> None:
        super().__init__(model_path=model_path, integration_step=integration_step)


Sarma2012InteractionTopologiesOfMapkCascadeBiomd0000000430Model = Sarma2012InteractionTopologiesOfMapkCascadeModel

...
"""Auto-generated SBML BioModule wrapper for Pepke2010_Full_Ca2/CaM_mCaMKII.

Source: biomodels_ebi:MODEL1001150000
Original: https://www.ebi.ac.uk/biomodels/MODEL1001150000
"""
...
class SbmlPepke2010FullCa2CamMcamkii(biosim.BioModule):
    """BioModule wrapper for SBML model: Pepke2010_Full_Ca2/CaM_mCaMKII."""

    def __init__(self, model_path: str = "data/MODEL1001150000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Pepke2010FullCa2CamMcamkiiModel1001150000Model = SbmlPepke2010FullCa2CamMcamkii

...
"""Auto-generated SBML BioModule wrapper for Thomsen1988_AdenylateCyclase_Inhibition.

Source: biomodels_ebi:BIOMD0000000082
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000082
"""
...
class SbmlThomsen1988AdenylatecyclaseInhibition(biosim.BioModule):
    """BioModule wrapper for SBML model: Thomsen1988_AdenylateCyclase_Inhibition."""

    def __init__(self, model_path: str = "data/BIOMD0000000082.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Thomsen1988AdenylatecyclaseInhibitionBiomd0000000082Model = SbmlThomsen1988AdenylatecyclaseInhibition

...
"""Auto-generated SBML BioModule wrapper for Strasen2018 - TGFb SMAD Signalling - Degradation of 25pM ligand (TGFb).

Source: biomodels_ebi:BIOMD0000000990
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000990
"""
...
class SbmlStrasen2018TgfbSmadSignallingDegradationOf25pmLigand(biosim.BioModule):
    """BioModule wrapper for SBML model: Strasen2018 - TGFb SMAD Signalling - Degradation of 25pM ligand (TGFb)."""

    def __init__(self, model_path: str = "data/BIOMD0000000990.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Strasen2018TgfbSmadSignallingDegradationOfBiomd0000000990Model = SbmlStrasen2018TgfbSmadSignallingDegradationOf25pmLigand

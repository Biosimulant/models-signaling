...
"""Auto-generated SBML BioModule wrapper for Cao2013 - Application of ABSIS in the the enzymatic futile cycle.

Source: biomodels_ebi:BIOMD0000000487
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000487
"""
...
class SbmlCao2013ApplicationOfAbsisInTheTheEnzymaticFutile(biosim.BioModule):
    """BioModule wrapper for SBML model: Cao2013 - Application of ABSIS in the the enzymatic futile cycle."""

    def __init__(self, model_path: str = "data/BIOMD0000000487.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Cao2013ApplicationOfAbsisInTheTheEnzymatiBiomd0000000487Model = SbmlCao2013ApplicationOfAbsisInTheTheEnzymaticFutile

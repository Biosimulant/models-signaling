...
"""Auto-generated SBML BioModule wrapper for Markevich2004_MAPK_phosphoRandomElementary.

Source: biomodels_ebi:BIOMD0000000028
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000028
"""
...
class SbmlMarkevich2004MapkPhosphorandomelementary(biosim.BioModule):
    """BioModule wrapper for SBML model: Markevich2004_MAPK_phosphoRandomElementary."""

    def __init__(self, model_path: str = "data/BIOMD0000000028.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Markevich2004MapkPhosphorandomelementaryBiomd0000000028Model = SbmlMarkevich2004MapkPhosphorandomelementary

...
"""Tellurium-backed SBML wrapper for Sarma2012 - Interaction topologies of MAPK cascade (M2_K2_PSEQ)."""
...
class Sarma2012InteractionTopologiesOfMapkCascadeModel1204280022Model(TelluriumSBMLBioModule):
    """Faithful Tellurium execution of the bundled SBML source model."""

    _SBML_ID = 'MODEL1204280022'
    _TITLE = 'Sarma2012 - Interaction topologies of MAPK cascade (M2_K2_PSEQ)'
    ...
    def __init__(self, model_path: str = 'data/MODEL1204280022.xml', integration_step: float = 0.01) -> None:
        super().__init__(model_path=model_path, integration_step=integration_step)


Sarma2012InteractionTopologiesOfMapkCascadeModel1204280022Model = Sarma2012InteractionTopologiesOfMapkCascadeModel1204280022Model

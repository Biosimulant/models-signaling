...
Tellurium-backed Biosimulant core wrapper for `BIOMD0000000997`.

Scientific source of truth:
- Bundled SBML file: `data/BIOMD0000000997.xml`
- Equations, parameters, units, and initial values are not manually reimplemented.

Public headline outputs:
- `active_tgfr2` maps to SBML `Active_R2`.
- `active_tgfb_tgfr1_tgfr2` maps to SBML `Active_Rec`.
- `active_tgfb_tgfr1_tgfr2_endo` maps to SBML `Active_Rec_endo`.

...
"""Auto-generated SBML BioModule wrapper for Keizer1996_Ryanodine_receptor_adaptation.

Source: biomodels_ebi:BIOMD0000000060
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000060
"""
...
class SbmlKeizer1996RyanodineReceptorAdaptation(biosim.BioModule):
    """BioModule wrapper for SBML model: Keizer1996_Ryanodine_receptor_adaptation."""

    def __init__(self, model_path: str = "data/BIOMD0000000060.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Keizer1996RyanodineReceptorAdaptationBiomd0000000060Model = SbmlKeizer1996RyanodineReceptorAdaptation

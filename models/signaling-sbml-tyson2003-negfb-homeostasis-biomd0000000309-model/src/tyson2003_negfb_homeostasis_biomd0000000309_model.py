...
"""Auto-generated SBML BioModule wrapper for Tyson2003_NegFB_Homeostasis.

Source: biomodels_ebi:BIOMD0000000309
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000309
"""
...
class SbmlTyson2003NegfbHomeostasis(biosim.BioModule):
    """BioModule wrapper for SBML model: Tyson2003_NegFB_Homeostasis."""

    def __init__(self, model_path: str = "data/BIOMD0000000309.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Tyson2003NegfbHomeostasisBiomd0000000309Model = SbmlTyson2003NegfbHomeostasis

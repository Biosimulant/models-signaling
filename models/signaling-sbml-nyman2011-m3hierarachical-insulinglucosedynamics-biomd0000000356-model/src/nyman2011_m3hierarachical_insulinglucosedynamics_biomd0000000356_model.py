...
"""Auto-generated SBML BioModule wrapper for Nyman2011_M3Hierarachical_InsulinGlucosedynamics.

Source: biomodels_ebi:BIOMD0000000356
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000356
"""
...
class SbmlNyman2011M3hierarachicalInsulinglucosedynamics(biosim.BioModule):
    """BioModule wrapper for SBML model: Nyman2011_M3Hierarachical_InsulinGlucosedynamics."""

    def __init__(self, model_path: str = "data/BIOMD0000000356.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Nyman2011M3hierarachicalInsulinglucosedynamicsBiomd0000000356Model = SbmlNyman2011M3hierarachicalInsulinglucosedynamics

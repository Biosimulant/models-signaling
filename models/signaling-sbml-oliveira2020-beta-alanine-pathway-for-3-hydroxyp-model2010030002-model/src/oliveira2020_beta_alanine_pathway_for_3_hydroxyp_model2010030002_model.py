...
"""Auto-generated SBML BioModule wrapper for Oliveira2020 - Beta-Alanine pathway for 3-hydroxypropionate production from glucose.

Source: biomodels_ebi:MODEL2010030002
Original: https://www.ebi.ac.uk/biomodels/MODEL2010030002
"""
...
class SbmlOliveira2020BetaAlaninePathwayFor3Hydroxypropionate2(biosim.BioModule):
    """BioModule wrapper for SBML model: Oliveira2020 - Beta-Alanine pathway for 3-hydroxypropionate production from glucose."""

    def __init__(self, model_path: str = "data/MODEL2010030002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Oliveira2020BetaAlaninePathwayFor3HydroxypModel2010030002Model = SbmlOliveira2020BetaAlaninePathwayFor3Hydroxypropionate2

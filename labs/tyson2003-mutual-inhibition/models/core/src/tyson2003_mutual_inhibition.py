...
"""Tellurium-backed SBML wrapper for Tyson2003_Mutual_Inhibition."""
...
class Tyson2003MutualInhibitionModel(TelluriumSBMLBioModule):
    """Faithful Tellurium execution of the bundled SBML source model."""

    _SBML_ID = 'BIOMD0000000310'
    _TITLE = 'Tyson2003_Mutual_Inhibition'
    ...
    def __init__(self, model_path: str = 'data/BIOMD0000000310.xml', integration_step: float = 0.01) -> None:
        super().__init__(model_path=model_path, integration_step=integration_step)


Tyson2003MutualInhibitionBiomd0000000310Model = Tyson2003MutualInhibitionModel

...
"""Auto-generated SBML BioModule wrapper for Goldbeter2013-Oscillatory activity of cyclin-dependent kinases in the cell cycle.

Source: biomodels_ebi:BIOMD0000000944
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000944
"""
...
class SbmlGoldbeter2013OscillatoryActivityOfCyclinDependent(biosim.BioModule):
    """BioModule wrapper for SBML model: Goldbeter2013-Oscillatory activity of cyclin-dependent kinases in the cell cycle."""

    def __init__(self, model_path: str = "data/BIOMD0000000944.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Goldbeter2013OscillatoryActivityOfCyclinDepBiomd0000000944Model = SbmlGoldbeter2013OscillatoryActivityOfCyclinDependent

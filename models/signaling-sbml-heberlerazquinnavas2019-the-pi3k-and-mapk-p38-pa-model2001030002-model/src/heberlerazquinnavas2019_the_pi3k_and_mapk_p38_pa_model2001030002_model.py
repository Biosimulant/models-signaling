...
"""Auto-generated SBML BioModule wrapper for HeberleRazquinNavas2019 - The PI3K and MAPK/p38 pathways control stress granuleassembly in a hierarchical manner model 2.

Source: biomodels_ebi:MODEL2001030002
Original: https://www.ebi.ac.uk/biomodels/MODEL2001030002
"""
...
class SbmlHeberlerazquinnavas2019ThePi3kAndMapkP38Pathways2(biosim.BioModule):
    """BioModule wrapper for SBML model: HeberleRazquinNavas2019 - The PI3K and MAPK/p38 pathways control stress granuleassembly in a hierarchical manner model 2."""

    def __init__(self, model_path: str = "data/MODEL2001030002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Heberlerazquinnavas2019ThePi3kAndMapkP38PaModel2001030002Model = SbmlHeberlerazquinnavas2019ThePi3kAndMapkP38Pathways2

...
"""Auto-generated SBML BioModule wrapper for Benary2015 - feedback regulation of beta-catenin pathway by HOS and FWD1.

Source: biomodels_ebi:MODEL1908050003
Original: https://www.ebi.ac.uk/biomodels/MODEL1908050003
"""
...
class SbmlBenary2015FeedbackRegulationOfBetaCateninPathwayBy(biosim.BioModule):
    """BioModule wrapper for SBML model: Benary2015 - feedback regulation of beta-catenin pathway by HOS and FWD1."""

    def __init__(self, model_path: str = "data/MODEL1908050003.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Benary2015FeedbackRegulationOfBetaCateninPModel1908050003Model = SbmlBenary2015FeedbackRegulationOfBetaCateninPathwayBy

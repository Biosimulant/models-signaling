...
**Source**: [biomodels_ebi](https://www.ebi.ac.uk/biomodels/BIOMD0000000823)
**Standard**: sbml
**Authors**: Thawfeek M Varusai; Lan K Nguyen
...
models:
  - path: ../../models/signaling-sbml-varusai2018-dynamic-modelling-of-the-mtor-signal-biomd0000000823-model
    alias: model
```

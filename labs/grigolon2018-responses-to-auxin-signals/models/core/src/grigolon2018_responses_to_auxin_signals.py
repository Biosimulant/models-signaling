...
class Grigolon2018ResponsesToAuxinSignalsModel(TelluriumSBMLBioModule):
    """Faithful Tellurium execution of the bundled SBML source model."""

    _SBML_ID = 'BIOMD0000000927'
    ...
    def __init__(self, model_path: str = 'data/BIOMD0000000927.xml', integration_step: float = 0.01) -> None:
        super().__init__(model_path=model_path, integration_step=integration_step)


Grigolon2018ResponsesToAuxinSignalsBiomd0000000927Model = Grigolon2018ResponsesToAuxinSignalsModel

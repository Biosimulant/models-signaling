...
"""Auto-generated SBML BioModule wrapper for Heiland2019 - NAD pathway model analysing the impact of NNMT on pathway dynamics and evolution.

Source: biomodels_ebi:MODEL1905220001
Original: https://www.ebi.ac.uk/biomodels/MODEL1905220001
"""
...
class SbmlHeiland2019NadPathwayModelAnalysingTheImpactOfNnmt(biosim.BioModule):
    """BioModule wrapper for SBML model: Heiland2019 - NAD pathway model analysing the impact of NNMT on pathway dynamics and evolution."""

    def __init__(self, model_path: str = "data/MODEL1905220001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Heiland2019NadPathwayModelAnalysingTheImpaModel1905220001Model = SbmlHeiland2019NadPathwayModelAnalysingTheImpactOfNnmt

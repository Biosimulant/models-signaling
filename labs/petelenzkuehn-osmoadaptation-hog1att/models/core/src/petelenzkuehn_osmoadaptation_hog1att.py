...
"""Tellurium-backed SBML wrapper for PetelenzKuehn_osmoadaptation_HOG1att."""
...
class PetelenzkuehnOsmoadaptationHog1attModel(TelluriumSBMLBioModule):
    """Faithful Tellurium execution of the bundled SBML source model."""

    _SBML_ID = 'BIOMD0000000605'
    _TITLE = 'PetelenzKuehn_osmoadaptation_HOG1att'
    ...
    def __init__(self, model_path: str = 'data/BIOMD0000000605.xml', integration_step: float = 0.01) -> None:
        super().__init__(model_path=model_path, integration_step=integration_step)


PetelenzkuehnOsmoadaptationHog1attBiomd0000000605Model = PetelenzkuehnOsmoadaptationHog1attModel

...
"""Auto-generated SBML BioModule wrapper for Caruso2020 - Activation of the alternative complement pathway and effects on hemolysis.

Source: biomodels_ebi:MODEL2109110001
Original: https://www.ebi.ac.uk/biomodels/MODEL2109110001
"""
...
class SbmlCaruso2020ActivationOfTheAlternativeComplementPathway(biosim.BioModule):
    """BioModule wrapper for SBML model: Caruso2020 - Activation of the alternative complement pathway and effects on hemolysis."""

    def __init__(self, model_path: str = "data/MODEL2109110001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Caruso2020ActivationOfTheAlternativeComplemModel2109110001Model = SbmlCaruso2020ActivationOfTheAlternativeComplementPathway

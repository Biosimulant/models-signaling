...
"""Auto-generated SBML BioModule wrapper for Huang1996 - Ultrasensitivity in MAPK cascade.

Source: biomodels_ebi:BIOMD0000000009
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000009
"""
...
class SbmlHuang1996UltrasensitivityInMapkCascade(biosim.BioModule):
    """BioModule wrapper for SBML model: Huang1996 - Ultrasensitivity in MAPK cascade."""

    def __init__(self, model_path: str = "data/BIOMD0000000009.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Huang1996UltrasensitivityInMapkCascadeBiomd0000000009Model = SbmlHuang1996UltrasensitivityInMapkCascade

...
"""Auto-generated SBML BioModule wrapper for Besozzi2012 - Oscillatory regimes in the Ras/cAMP/PKA pathway in S.cerevisiae.

Source: biomodels_ebi:BIOMD0000000478
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000478
"""
...
class SbmlBesozzi2012OscillatoryRegimesInTheRasCampPkaPathway(biosim.BioModule):
    """BioModule wrapper for SBML model: Besozzi2012 - Oscillatory regimes in the Ras/cAMP/PKA pathway in S.cerevisiae."""

    def __init__(self, model_path: str = "data/BIOMD0000000478.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Besozzi2012OscillatoryRegimesInTheRasCampBiomd0000000478Model = SbmlBesozzi2012OscillatoryRegimesInTheRasCampPkaPathway

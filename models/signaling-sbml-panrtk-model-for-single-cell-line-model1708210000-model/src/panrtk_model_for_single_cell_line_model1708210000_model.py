...
"""Auto-generated SBML BioModule wrapper for PanRTK model for single cell line.

Source: biomodels_ebi:MODEL1708210000
Original: https://www.ebi.ac.uk/biomodels/MODEL1708210000
"""
...
class SbmlPanrtkModelForSingleCellLine(biosim.BioModule):
    """BioModule wrapper for SBML model: PanRTK model for single cell line."""

    def __init__(self, model_path: str = "data/MODEL1708210000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
PanrtkModelForSingleCellLineModel1708210000Model = SbmlPanrtkModelForSingleCellLine

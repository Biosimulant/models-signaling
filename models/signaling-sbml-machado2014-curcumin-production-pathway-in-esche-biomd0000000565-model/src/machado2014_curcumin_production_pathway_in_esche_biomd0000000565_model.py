...
"""Auto-generated SBML BioModule wrapper for Machado2014 - Curcumin production pathway in Escherichia coli.

Source: biomodels_ebi:BIOMD0000000565
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000565
"""
...
class SbmlMachado2014CurcuminProductionPathwayInEscherichiaColi(biosim.BioModule):
    """BioModule wrapper for SBML model: Machado2014 - Curcumin production pathway in Escherichia coli."""

    def __init__(self, model_path: str = "data/BIOMD0000000565.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Machado2014CurcuminProductionPathwayInEscheBiomd0000000565Model = SbmlMachado2014CurcuminProductionPathwayInEscherichiaColi

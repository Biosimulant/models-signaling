...
"""Auto-generated SBML BioModule wrapper for Oliveira2020 - Glycerol pathway for Acrylic Acid production from glycerol.

Source: biomodels_ebi:MODEL2010040005
Original: https://www.ebi.ac.uk/biomodels/MODEL2010040005
"""
...
class SbmlOliveira2020GlycerolPathwayForAcrylicAcidProduction2(biosim.BioModule):
    """BioModule wrapper for SBML model: Oliveira2020 - Glycerol pathway for Acrylic Acid production from glycerol."""

    def __init__(self, model_path: str = "data/MODEL2010040005.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Oliveira2020GlycerolPathwayForAcrylicAcidPModel2010040005Model = SbmlOliveira2020GlycerolPathwayForAcrylicAcidProduction2

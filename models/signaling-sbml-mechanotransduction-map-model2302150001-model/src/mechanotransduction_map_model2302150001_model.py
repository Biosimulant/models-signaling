...
"""Auto-generated SBML BioModule wrapper for Mechanotransduction Map.

Source: biomodels_ebi:MODEL2302150001
Original: https://www.ebi.ac.uk/biomodels/MODEL2302150001
"""
...
class SbmlMechanotransductionMap(biosim.BioModule):
    """BioModule wrapper for SBML model: Mechanotransduction Map."""

    def __init__(self, model_path: str = "data/MODEL2302150001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
MechanotransductionMapModel2302150001Model = SbmlMechanotransductionMap

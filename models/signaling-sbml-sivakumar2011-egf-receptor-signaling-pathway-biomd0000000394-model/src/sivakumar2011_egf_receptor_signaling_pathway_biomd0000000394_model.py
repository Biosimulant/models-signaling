...
"""Auto-generated SBML BioModule wrapper for Sivakumar2011 - EGF Receptor Signaling Pathway.

Source: biomodels_ebi:BIOMD0000000394
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000394
"""
...
class SbmlSivakumar2011EgfReceptorSignalingPathway(biosim.BioModule):
    """BioModule wrapper for SBML model: Sivakumar2011 - EGF Receptor Signaling Pathway."""

    def __init__(self, model_path: str = "data/BIOMD0000000394.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Sivakumar2011EgfReceptorSignalingPathwayBiomd0000000394Model = SbmlSivakumar2011EgfReceptorSignalingPathway

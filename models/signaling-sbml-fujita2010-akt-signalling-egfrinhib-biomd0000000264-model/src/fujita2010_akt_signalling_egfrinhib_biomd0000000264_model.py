...
"""Auto-generated SBML BioModule wrapper for Fujita2010_Akt_Signalling_EGFRinhib.

Source: biomodels_ebi:BIOMD0000000264
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000264
"""
...
class SbmlFujita2010AktSignallingEgfrinhib(biosim.BioModule):
    """BioModule wrapper for SBML model: Fujita2010_Akt_Signalling_EGFRinhib."""

    def __init__(self, model_path: str = "data/BIOMD0000000264.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Fujita2010AktSignallingEgfrinhibBiomd0000000264Model = SbmlFujita2010AktSignallingEgfrinhib
